...
def analyze_next2_batch1():
    """次の100件分析（第2弾）のバッチ1を分析"""

    # バッチ情報を読み込み
    with open('next2_100_batch1_info.yaml', 'r', encoding='utf-8') as f:
    ...
    with open('next2_100_batch1_results.yaml', 'w', encoding='utf-8') as f:
        yaml.dump(output_data, f, default_flow_style=False, allow_unicode=True)

    print(f"\n=== 分析完了 ===")
    print(f"分析済みPR数: {len(results)}件")
    print(f"結果を next2_100_batch1_results.yaml に保存しました")
