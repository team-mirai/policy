...
def get_final_100_batch1():
    """最後の100件分析のバッチ1（50件）を取得する"""
    ...
    with open('final_100_batch1_info.yaml', 'w', encoding='utf-8') as f:
        yaml.dump(batch_info, f, default_flow_style=False, allow_unicode=True)

    print(f"\nバッチ情報を final_100_batch1_info.yaml に保存しました")
    print(f"次のステップ: analyze_final_100_batch1.py を実行してください")

    return batch_prs


if __name__ == "__main__":
    get_final_100_batch1()
