...
def analyze_final_batch1():
    """最後の100件分析のバッチ1を分析"""

    # バッチ情報を読み込み
    with open('final_100_batch1_info.yaml', 'r', encoding='utf-8') as f:
    ...
    with open('final_100_batch1_results.yaml', 'w', encoding='utf-8') as f:
        yaml.dump(output_data, f, default_flow_style=False, allow_unicode=True)

    print(f"\n=== 分析完了 ===")
    print(f"分析済みPR数: {len(results)}件")
    print(f"結果を final_100_batch1_results.yaml に保存しました")
