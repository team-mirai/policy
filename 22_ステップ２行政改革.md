...
*   Sosialinen luottamus on saatava nopeasti ja joustavan riskienhallinnan tarve kasvaa  
  * [Digitaaliviraston julkaisemien kojelautojen määrä kasvoi 1 660:een vuodessa](https://www.digital.go.jp/assets/contents/node/basic_page/field_ref_resources/76083c4c-44f7-4921-b71c-01a28b9a4338/c7be7b06/20250422_meeting_conception_outline_01.pdf?utm_source=chatgpt.com). On vakiintumassa kulttuuri, jossa tuloksia visualisoidaan usein ja kansalaisten valvonta ja palaute integroidaan.  
* Kansainvälinen sääntelykilpailu on välitöntä  
  * [OECD:n ketterän sääntelyn työkalupakki (2023)](https://www.oecd.org/content/dam/oecd/en/publications/reports/2024/04/regulatory-experimentation_fc84553c/f193910c-en.pdf?utm_source=chatgpt.com) suosittelee jäsenmaille kokeiluhiekkalaatikoiden ja epäonnistumisista oppimisen institutionalisointia. Jos emme toimi nyt, vaarana on jäädä jälkeen kansainvälisten standardien kehittämisestä.  
  * OECD:n [vuoden 2024 raportissa](https://www.oecd.org/content/dam/oecd/en/publications/reports/2024/03/facts-not-fakes-tackling-disinformation-strengthening-information-integrity_ff96d19f/d909ff7a-en.pdf?utm_source=chatgpt.com) tuodaan esiin disinformaation ja generatiivisen tekoälyn vaikutukset demokraattisiin prosesseihin ja kehotetaan maita "nopeisiin päivityksiin ja epäonnistumisista oppimiseen".

### 政策概要

* Epäonnistumisen sallivan ja dataan perustuvan nopean oppimisen politiikkasyklin käyttöönotto  
  * Hiekkalaatikko + virhebudjettiajattelun omaksuminen  
    * Luodaan puitteet dynaamisille ja joustaville tarkistuksille politiikan suunnittelussa jne.  
    * Lisäksi tarkastellaan etukäteen mahdollisia virheitä ja niiden todennäköisyyttä ja harkitaan toimenpiteitä sen perusteella, ovatko ongelmat odotettuja vai odottamattomia.  
    * Virhetapauksissa analysoidaan syy välittömästi → harkitaan parannuksia.  
  * "Tavoitteen asettaminen" → "Järjestelmän suunnittelu" → "Käyttöönotto" → "Arviointi" → "Ympäristön ja riskien uudelleenanalysointi ja tavoitteiden uudelleen asettaminen" -kaksoissyklin käyttöönotto  
    * Sisältää PDCA-syklin ja jatkuvan ympäristöanalyysin ja tavoitteiden asettamisen tarkistamisen sekä varmistaa ulkoisen avoimuuden ja tilivelvollisuuden.  
  * EBPM:n dynaaminen käytäntöönpano:  
    * Staattisen EBPM:n lisäksi, joka rajoittuu arviointiin ja analyysiin yhdessä ajankohdassa, toteutetaan dynaamista EBPM:ää, jossa politiikkaa tarkistetaan ja toteutetaan tilanteen muutosten mukaan.  
    *  Poistetaan EBPM:n, politiikan arviointijärjestelmän ja hallinnollisten hankkeiden tarkastelun päällekkäisyys ja rasittavuus ja kohdennetaan resursseja dynaamisempaan ja joustavampaan politiikanmuodostukseen.  
  * Osapuolten välinen palauterakenne  
    * Ennen tai arvioinnin yhteydessä muiden ministeriöiden ja kansalaisten palaute otetaan huomioon politiikassa.	  
* Ketterän hallinnan perustana olevan alustan kehittäminen  
  * Edistetään entisestään "yhteisen perustan" kehittämistä, kuten tunnuksia, perusrekistereitä, avointa dataa, pilvipalveluita ja maksuinfrastruktuuria  
    * Viite: Digitaaliviraston [julkisen luottamusperustan kehittäminen](https://www.digital.go.jp/policies/trust?utm_source=chatgpt.com)  
  * Lisäksi Intiassa käytössä olevan India Stackin kaltaisesti luodaan hierarkkinen rakenne, jossa alakohtaiset ja yksittäiset palvelut rakennetaan yhteisen perustan päälle, ja edistetään "sovellusten/integraation tyyppien standardointia".
