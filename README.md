...
　例えば、まいまいさんとの議論を踏まえ、皇位継承の問題について、以下のような提案が現在検討されています。「チームみらいは、皇位の継承を男子に限定している現在の制度は、男女平等の原則に反する差別であると考えます。女性天皇・女系天皇を認め、安定的で現代的な皇位継承を実現することを目指します。」このように、皆さんからの具体的なご意見をマニフェストに反映させていきます。
