...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。私たちは、テクノロジーはあくまで社会を良くするための強力な道具（ツール）であると考えており、最終的な意思決定は、多様な意見に耳を傾けた上で、人間が責任を持って行うべきだと考えています。
