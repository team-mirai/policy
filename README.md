...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。あわせて、AIの普及による雇用の変化を見据え、人手不足が深刻な公共分野（教育、医療、行政など）への人材移行を支援する、国主導の再教育・マッチングプログラムの創設も検討しています。
