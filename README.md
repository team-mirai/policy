...
現状の国会では、委員会の日程決定が直前になることが多く、丁寧な質疑応答の準備が困難になっています。これは、与野党間の駆け引きや、国会日程の硬直的な運用などが背景にあると考えられます。

そこで、国会運営の透明性と予測可能性を高めるため、**国会や委員会の年間スケジュールと、審議予定の法案リストを可能な限り早期に策定・公開する仕組みの導入**を提案します。これにより、議員や関係省庁の負担を軽減し、政策議論の質を高めることを目指します。
...
　なお今後も議論の結果、これらのマニфеストの内容がまだ変わる可能性がある点はご理解いただけますと幸いです。
