...
チームみらいは、ヘイト思想や陰謀論の拡散が、人々を分断し、建設的な議論を妨げる深刻な脅威であると認識しています。私たちは、いかなる差別や偏見にも断固として反対し、事実に基づかない情報によって人々が惑わされることのない社会を目指します。

この問題に対処するため、私たちはAIなどの先進技術を活用し、ヘイト情報や偽情報が拡散するメカニズムを分析・解明します。そして、その知見に基づき、教育の推進、プラットフォームの透明性向上、そして表現の自由を不当に侵害しない形での効果的な対策を、専門家や市民の皆様と共に議論し、構築していきます。
