...
チームみらいは、表現の自由を最大限尊重しつつ、効果的なサイバー犯罪対策を推進するため、以下の原則を掲げます。

1.  **新サイバー犯罪条約への慎重な検討**:
    新サイバー犯罪条約には、規制対象を限定できる選択肢（第14条3項）が設けられていますが、なお以下の懸念が残ります。
    *   **捜査リソースの分散**: 捜査対象が拡大し、現実の被害者を救うためのリソースが割かれる危険性。
    *   **表現の自由への萎縮効果**: 条約の運用次第で、創作活動が不当に萎縮する可能性。
    これらの懸念から、本条約の批准には慎重な立場を取ります。特に、表現の自由を保護する規定（第14条3項など）の留保なき適用が絶対条件です。

2.  **データに基づく合理的な規制の原則**: 犯罪抑止を理由とした規制導入には、客観的データに基づく厳格な検証を必須とします。ビッグデータを活用し、その行為が社会に与える害を他の既存リスク（酒、たばこ等）と比較検証し、規制の必要性が合理的に証明されない限り、個人の自由を制約する新たな規制は導入しません。

## 障害を持つ方々のための年金制度改革

チームみらいは、障害を持つ方々が直面する不合理な制度的障壁を取り除き、安心して生活できる社会を目指します。特に、年金制度に関して以下の改革を推進します。

1.  **永続的な障害における年金更新手続きの見直し**:
    発達障害のように、その性質上、症状の永続性が認められる障害については、年金受給資格の更新手続きを原則として不要とし、当事者の精神的・経済的負担を抜本的に軽減します。

2.  **障害年金制度の格差是正**:
    障害のために厚生年金に加入する機会がなかった方々が、生活保護の水準を下回る障害基礎年金だけで生活せざるを得ない現状を重大な問題と捉えます。給付水準の引き上げや、他の社会保障制度との連携強化など、尊厳ある生活を保障するための具体的な制度設計を検討します。
