...
　また、匿名ユーザー様からのご提案を受け、生活保護制度の適正な運用と信頼性向上についても議論を進めています。「行政改革」の項目において、「不正受給対策を強化し、悪質なケースには厳正に対処する。同時に、申請者の状況を丁寧に審査し、必要な支援が迅速に行き渡るよう努める。不服申し立ての機会も保障する」といった内容の追加を検討しており、皆様からのご意見も参考に、マニフェストをより良いものにしていきたいと考えています。
