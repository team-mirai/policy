...
### 具体的な施策
#### 若年層へのピロリ菌検査と除菌の推進
- 中学生～18歳くらいを対象としたピロリ菌検査の全国展開と費用助成: 学齢期でのピロリ菌感染の有無を把握し、陽性者には除菌治療を推奨。除菌治療にかかる費用を公費で助成し、経済的負担を軽減。この年代での早期除菌は、ピロリ菌の長期感染による胃粘膜へのダメージが少ない段階で対応できるため、胃がん発症リスクを最大限に低減できる可能性が高く、特に効果的です。胃の萎縮が進む前に対策を講じることで、より健康な状態への回復が期待できるため、重点的に推進します。
...
- 除菌成功者への定期的な内視鏡検査の推奨と費用助成: 除菌後も胃がんのリスクがゼロになるわけではないため、定期的な内視鏡検査の重要性を啓発します。除菌成功者に対する内視鏡検査の費用助成（例：数年に一度の公費助成）を検討し、受診継続を支援します。
- 登録制度の検討: ピロリ菌の検査・除菌治療を受けた方を登録し、定期的な受診勧奨や情報提供を行うシステムを検討します。
