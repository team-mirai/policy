...
　「考えがまだまとまっていないではないか」とご批判を受けるリスクを積極的に取りながら、未熟なバージョンであっても公開に踏み切ります。なぜそうするかといえば、批判の目をたくさん入れ、意見を取り入れてゆくことが最も良い政策を作るやり方だと思うからです。また、これはシンプルな多数決のように「意見が多くものを取り入れる」ということではありません。意見は聞きますし、プロセスの透明化も行いますが、あくまで意思決定は既存政党と同様にチームみらいの人が行います。これは、責任を取れる『人』が主体となって判断をすることが重要であるという価値観に基づくものです。
...
* **徹底したサイバーセキュリティとプライバシー保護**：安全なデジタル社会の実現には、国民の個人情報とプライバシーの厳格な保護が不可欠です。国は、ファイアウォール、IDS/IPS、EDR等を組み合わせた多層的な防護策を講じます。また、サイバー攻撃を想定したインシデント対応体制を整備し、定期的なリスク評価に基づく継続的な対策強化を徹底します。
