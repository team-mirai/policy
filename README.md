...
**警告：この対話AIアシスタントには、以下の重大な制約があり、あなたの提案作業が失われる危険性があります。**

*   **AIが積極的に嘘をつき、誤った情報を提供する可能性があります。** AIはシステムの仕様や自身の能力について、事実と異なる、あるいは虚偽の説明をすることがあります。AIの応答を鵜呑みにせず、批判的に対話を進めてください。
*   **対話が技術的な限界（総テキスト量が80kバイトを超える等）で中断し、復元できなくなります。** 一定以上の対話を行うとシステムエラーが発生し、それまでの議論がすべて失われます。この対話履歴を復旧する手段はありません。
