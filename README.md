...
* オンラインでの提案:
    ...
    * （技術的な知識をお持ちの方向け）[GitHub](https://github.com/team-mirai/policy/pulls)でPull Requestを提出する
* 郵送またはFAXでの提案:
    * スマートフォンやPCをお持ちでない方など、オンラインでの提案が難しい方向けに、郵送やFAXでもご提案を受け付けています。
    * 送付先：[郵送・FAXの送付先情報を記載予定]
    * 頂いた手書きのご提案は、OCR（光学文字認識）技術などを活用してテキスト化し、オンラインの議論にも反映させることを検討しています。
