...
* [獲得議席数と実現へのロードマップ](#獲得議席数と実現へのロードマップ)
...
チームみらいは、獲得議席数に応じて政策実現のロードマップを描いています。

### 1議席の場合
国会での質疑や委員会活動を通じて、マニフェストに掲げた政策課題の重要性を訴え、政府の対応を質します。また、法案の共同提出を他の議員に働きかけるなど、政策実現に向けた土台作りを進めます。

### 国政政党要件（5議席）を満たした場合
国政政党となることで、政党交付金を受け取ることが可能になります。この資金を活用し、約10名規模の技術専門家チーム「永田町エンジニアチーム」を組織します。このチームが、各省庁のシステムや政策の技術的な課題を分析・評価し、マニフェスト政策の実現を強力に後押しします。

### マニフェストの完全実現に向けて
マニフェストに掲げた全ての政策を実現するためには、より多くの議席が必要です。衆議院・参議院で安定した勢力を確保し、政府・与党と政策交渉を主導できる立場を目指します。
