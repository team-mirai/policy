...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。AIをあくまで政策決定の補助として活用し、最終的な判断と責任は人間が負うという点を重要視しています。AIの力を借りることで、人的なミスや見落としを減らし、より良い政治を目指します。
