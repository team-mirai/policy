...
14様からのご提案に基づき、大規模災害や有事の際に迅速かつ的確に対応するため、強力な権限を持つ「国家危機管理庁」の創設を検討しています。

### 創設の背景と目的
【課題】 行政の縦割りや都道府県の境が、迅速な対応を阻んできた。
【解決策】 これらを全て打ち破る、強大な権限を持つ「国家危機管理庁」を創設する。

### 強大な権限に対する「安全装置」
【最大のリスク】 その強大な権限が暴走する危険性。
【最終的な安全装置】 トップの任命には、厳格な資格要件と、与野党の幅広い合意が必要な国会の承認を必須とする。

#### 具体的な仕組み
1.  **厳格な資格要件の法制化:** 長官に就任できるのは、自衛隊、警察、消防、海上保安庁のいずれかで極めて高い地位での実務経験を積んだ人物に限定します。これにより、実務能力に基づかない人事の可能性を排除します。
2.  **衆参両院での承認投票:** 政府が上記の資格を持つ候補者を指名した後、衆議院と参議院の両方で承認投票を行います。これにより、与党だけの都合でトップが決定されることを防ぎ、国会による民主的な統制を確保します。
