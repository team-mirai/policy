...
### **議論中の提案（匿名ユーザーより）**
複数の疾患や障害を持つ人が、制度の狭間で適切な支援を受けられていない現状があります。「一人一疾患」という暗黙の偏見により、本当に助けを必要とする人が社会から孤立し、命の危険に晒されています。
...
#### **【くらしと行政分野】**
*   **分野横断的な支援で、制度の狭間をなくす:** 複数の困難を同時に抱える方が、分野ごと・部署ごとに何度も同じ説明を繰り返す必要がないよう、行政が連携して一括で対応する仕組みを整えます。
*   **「申請主義」の限界を超えて:** 助けを求める声を出せない方にも支援が届くよう、行政が積極的に状況を把握し、必要な支援を提案する「プッシュ型支援」を、特に複雑な困難を抱える世帯に導入します。
