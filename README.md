...
## 国民との対話を通じた安全保障と行政透明化の実現

### 1. 透明性を確保したスパイ防止法の制定に向けた国民的議論の推進
国の安全を守るため、スパイ防止法の制定に向けた議論を前進させます。その際、チームみらいが重視する「見える化と対話」の精神に基づき、法案策定のプロセスを徹底的に公開します。プライバシーや表現の自由といった国民の権利を不当に侵害することのないよう、多角的な視点から議論を行い、国民の皆様との対話を通じて、真に信頼される実効的な法制度を目指します。

### 2. 徹底した行政の透明化と国民対話の仕組みづくり
国民の信頼に基づく行政を実現するため、省庁の運営を抜本的に透明化します。
*   **情報の原則公開:** 国防やプライバシーに関わる例外を除き、各省庁の予算執行の詳細、主要な会議の議事録、そして政策決定に至る背景や意図を、原則として全て公開します。
*   **双方向の対話プラットフォームの構築:** 国民がいつでも政策に対して意見を表明し、議論に参加できるオンラインプラットフォームを構築します。特に、教育行政を担う文部科学省など、国民生活に密接に関わる分野から導入を進めます。


## このマニフェスト自身も、みんなの知恵を集めて改善していきます

　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマనిఫెస్ట్を育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。
