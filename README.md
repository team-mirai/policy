...
私たちは、デジタル化を進めるにあたり、「誰一人取り残さない」ことを最も重要な原則とします。そのため、私たちが推進するシステムは、デジタルが苦手な方でも直感的に・簡単に使えるデザインであることを第一に考えます。

その上で、対面での相談窓口や電話サポートといった丁寧なサポート体制も整備し、「使いやすいデザイン」と「手厚いサポート」の両輪で、すべての人がテクノロジーの恩恵を受けられる社会を目指します。
