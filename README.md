...
個人のアイデンティティを尊重しつつ、家族としての一体感も育むことができる、新しい時代の姓名制度を導入します。

*   **目的**: 結婚などによる煩雑な手続きをなくし、多様な家族の形を認め、その絆を支える社会を目指します。
*   **具体的な提案**:
    1.  **選択的夫婦別姓の実現**: 結婚後も、夫婦それぞれが結婚前の姓を維持し、それに伴う各種証明書の変更手続きを不要にします。
    2.  **家族の一体感を育む「家族名」制度**: 希望する夫婦は、家族の絆の象徴として新たに「家族名」を設定できます。この「家族名」は、生まれてくる子の公的な「姓」として登録できるようにします。これにより、親はそれぞれの姓を保ちながら、子とは同じ「家族名（姓）」で結ばれます。
