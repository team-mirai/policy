...
　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。特に、現役世代の手取り収入を増やすための税制改革など、みなさんの生活に直結する問題についても、積極的に議論していきます。その際、高所得者の定義を子育て世帯などの生活実感も踏まえて慎重に検討し、誰もが納得できる公平な制度を目指します。
