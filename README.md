...
　「ITやネットで政治を変える」という言葉に、過去の経験から期待を裏切られたと感じる方も少なくないでしょう。これまでのデジタル・ガバメントやSNSを活用した政治は、単なる情報発信や人気取りに留まりがちで、国民一人ひとりの声が政策に反映される実感には繋がりにくいものでした。私たちが今回目指すのは、そうした過去の反省を踏まえた、AIを活用した『熟議』です。単に多くの意見を集めるだけでなく、AI技術を用いて多様な意見を整理・分析し、論点を明確にすることで、より建設的で深い議論を促します。これは、一方的な情報発信や単なる多数決ではなく、異なる意見を持つ人々が対話し、共に解決策を練り上げるための仕組みです。このプロセスを通じて、過去の試みとは根本的に異なる、真の国民参加型政策形成が実現できると、私たちは信じています。
