...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * （ふくさんのご提案より）LLM活用型AIヘルプチャットの導入による行政サービス向上
  * [４．産業](14_ステップ１産業.md)  
...
　このマニフェストは皆さんの声を拾いながら改善していくためのバージョン0.1（超初期版）であり、まだまだ議論中、作業中の箇所がたくさんあります。チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。そのために、デジタルに不慣れな方や、これまで政治参加の経験が少ない方でも、誰もが直感的に意見を表明し、議論に参加できるような、分かりやすく使いやすい仕組みづくりを常に追求し、改善を続けます。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。
