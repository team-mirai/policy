...
## 現在議論中の提案（さやかさんからのご提案）

### 保育士の適切な処遇実現に向けた公定価格の見直し

現状の公定価格は、多くの保育所が11時間開所などの長時間運営を行う中で、法律で定められた必要保育士数を満たすための人員配置の実態を正確に反映していません。

**提案内容：**
公定価格の算定基準を、具体的なモデルケースに基づいて見直します。「短時間認定の利用時間（9時～17時の8時間）において国の定める必要保育士数を満たした上で、11時間の開所時間に対応するシフトを組むために必要な保育士数」を算出し、それを基に人件費を公定価格に正確に反映させます。
