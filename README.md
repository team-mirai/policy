...
　例えば、以下のような具体的なご意見をいただいています。

*   **妊婦健診の負担軽減:** 現状、公費でカバーされる妊婦健診の検査項目は限定的です。超音波検査やノンストレステスト(NST)に加え、胎児の先天性疾患を調べる精密な超音波検査も保険適用外であり、自己負担が家計の大きな負担となっています。安心して子どもを産み、育てられる社会を実現するために、これらの検査も公費負担や保険適用の対象に加えるべきです。
