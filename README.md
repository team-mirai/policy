...
チームみらいの取り組みは、政府のデジタル化を推進するデジタル庁の役割とは異なります。デジタル庁が主に既存の行政サービスのデジタル化を進めるのに対し、チームみらいはテクノロジーを前提として、社会システムや行政サービスそのものをゼロから再設計（リデザイン）することを目指しています。

既存の省庁や業界との利害関係に縛られない政治団体だからこそ、縦割り行政の壁を越えた大胆な提案が可能です。例えば、本マニフェストで掲げる「教育、福祉、医療の情報を連携させ、こども一人ひとりに合わせた最適なサポートを提供する仕組み」などは、省庁の壁を越える必要があるため、行政組織の中からだけでは実現が難しい、チームみらいならではの提案です。

このように、特定の政権の方針に左右されず、長期的な視点とオープンな対話を通じて社会全体の変革を推進します。
