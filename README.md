...
観光客の増加に伴うごみ問題や、多言語対応の遅れなどの課題に対応するため、入国税・観光税の導入を検討します。
観光地のゴミ箱増設や清掃費用、交通機関や公共施設の多言語対応などに充当し、持続可能な観光立国を目指します。
国民的な議論を喚起し、幅広い視点から検討を進めます。
政策の実現に向けて、皆様からのご意見を募集しています。
