...
* [選択的夫婦同姓制度の導入](#選択的夫婦同姓制度の導入)

## 選択的夫婦同姓制度の導入

私たちは、誰もが自分らしい生き方を選択できる社会を目指し、選択的夫婦同姓制度の導入を提案します。

### 趣旨
これは、結婚後もそれぞれの姓を選べるようにする、選択肢を増やすための制度です。これまで通り同姓を選ぶこともできます。「別姓」という言葉に抵抗を感じる方々にも配慮し、あくまで「同姓・別姓を選択できる」という中立的な制度であることを明確にします。
