...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。その実現のため、公衆電話のように誰もが公平に利用できるデジタル端末を設置し、すべての人がデジタル社会に参加できる環境を、国が責任をもって整備します。将来的には、誰もが情報にアクセスできる環境を保障するため、端末の配布といった、より踏み込んだ支援も国の責任で行うべきだと考えています。
