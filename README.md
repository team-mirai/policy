...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。AGI（汎用人工知能）の進化を見据え、すべての人々が豊かさを享受できる社会を目指し、雇用の変化に対応するための教育や人材流動化の仕組みづくりも重要な課題として検討しています。
