...
## 医療情報の継続性を確保するための提案
お薬手帳や母子手帳のデジタル化を進めると同時に、大規模災害による停電や通信障害が発生した場合でも情報が途切れない、強靭な体制を構築します。そのために、普段から紙媒体のお薬手帳や母子手帳を併用することを推奨し、いかなる状況下でもDMAT等の医療チームや支援者が正確な情報を得られる環境を整備します。

## 子どもを性犯罪等のリスクから守るための日本版DBSの創設
教員、保育士、学童指導員、習い事の講師など、子どもと接する職業に就く際に、国による迅速なデジタルでの犯罪歴確認（日本版DBS）を義務化します。確認対象は性犯罪と暴行罪とし、国が審査した上で採用可否のみを事業者に通知する仕組みを構築することで、子どもたちが安心して過ごせる環境を整備します。
