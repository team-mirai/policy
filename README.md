...
政策内容の変更以外のPR（例：タイポ修正、フォーマット調整、ドキュメント更新など）でX通知を避けたい場合は、PRに `skip-notification` ラベルを付けることで通知をスキぺます。
...
私たちは、日本の伝統的な家族のあり方を尊重し、夫婦同姓という文化を維持していくべきだと考えます。長い日本の歴史と伝統に鑑み、結婚して夫婦どちらかの姓を名乗ることは、家族の一体感や社会の安定の基礎となる日本の大切な習慣です。外国からの圧力や一部の意見を理由にこの文化を変えることには反対します。
