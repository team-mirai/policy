...
　とまとさんのご提案を受け、例えば「ステップ３ 長期的な成長への大胆な投資」における科学技術分野において、「革新的廃棄物処理技術の研究開発」を政策項目として追加することを検討しています。具体的には、太陽光を利用した超高温焼却による廃棄物のイオン化処理など、エネルギーコストを抑えつつ最終処分場の問題を解決しうる革新的な廃棄物処理技術の研究開発を推進し、実用化に向けた課題克服を支援するという内容です。このようなご意見も踏まえ、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。
