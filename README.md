...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取りloessに取り残さない日本を掲げ、本マニフェストの政策を推進しています。
...
## 議論中の提案
### エネルギー分野：集合住宅へのEV充電器導入支援（匿名ユーザーからの提案）
マンション等の集合住宅におけるEV充電器の設置を促進するため、各戸の電気メーターと連携し、家庭の電気料金と合算して請求できる簡易な課金システムの開発・導入を支援し、EVを手軽に利用できる環境を整備します。
