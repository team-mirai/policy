...
* **デジタル化における信頼と透明性の確保:** 国民の皆様の信頼なくして、行政のデジタル化はありえません。特にマイナンバー制度など、国民生活に深く関わるシステムについては、セキュリティに関する客観的な証拠（エビデンス）を分かりやすく提示し、徹底した情報公開を行います。政府の取り組みに対する国民の皆様の懸念や不信感を真摯に受け止め、対話を通じて信頼を確保することを、デジタル化推進の大前提とします。
