...
ようこそ！　ここはチームみらいの公約（マニフェスト）を、みんなでオープンに話し合って、もっとよくしていくためのページです。ここでは、[おしゃべりできるシステム『いどばたシステム』](#おしゃべりできるシステムいどばたシステムについて)というAIとの対話を通じて、だれでも自由にマニフェストへの意見や要望を出すことができます。
...
- この会話のやり取りは、お使いのブラウザに一時的に保存されます。そのため、異なる端末やブラウザをご利用の場合や、ネットワーク環境によっては、会話の履歴をうまく引き継げないことがあります。
