...
　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。例えば、みなさんとの対話の中から「母子手帳は、ワクチン接種歴や成長記録のような管理すべき情報は電子で確実に管理しつつ、手書きの温かみやエコー写真などを残せるアルバムのような紙の手帳も希望者が利用できるようにしてはどうか」といった、具体的なアイデアが生まれることもあります。
