...
### マイナンバーカード連携による投票ポイント制度の導入
*   **目的：** 若者をはじめとする国民の政治参加を促し、投票率を向上させます。また、ポイントの利用を地域に限定することで、地域経済の活性化にも貢献します。
*   **仕組み：** マイナンバーカードを利用して投票の事実を確認し、ポイントを付与します。誰に投票したかという情報は記録されず、プライバシーは保護されます。
*   **ポイントの活用：** 付与されたポイントは、地域の商店街などで利用できる「地域限定ポイント」とします。
