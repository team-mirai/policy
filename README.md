...
歯科医療の担い手不足、時代に合わない保険制度など、構造的な課題の解決を目指します。

1.  **歯科技工士の役割拡大と待遇改善**:
    質の高い義歯などを提供するため、一定の研修を受けた歯科技工士が患者の口腔内に触れられるよう、規制を見直します。また、不当に低い報酬体系を是正し、専門性が正当に評価される仕組みを作ります。

2.  **保険制度の抜本的見直し**:
    *   **品質確保**: 海外製の安価で低品質な詰め物・被せ物から国民を守るため、品質基準を設けます。
    *   **デジタル化の推進**: 手作業の治療でなく、3Dプリンター等を活用した治療を保険の中心に据え、「人の手は高く、機械は安く」の原則で価格を適正化します。
    *   **予防・保存治療の重視**: 歯を残す治療の評価を引き上げ、歯科医師が積極的に取り組むよう促します。

## このマニフェスト自身も、みんなの知恵を集めて改善していきます

　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマにフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。
