...
チームみらいは、国会議員の待遇が民間企業の常識と乖離している現状を問題視し、特に「調査研究広報滞在費（旧文書通信交通滞在費）」のあり方を抜本的に見直すべきだと考えます。国民の税金が原資である以上、その使途は民間企業で求められる水準以上に厳格であるべきです。

そこで、私たちは以下の3つの原則を法律で定め、政治資金の透明性を徹底的に高めることを提案します。

1.  **領収書の全面公開の義務化**: 全ての支出について、領収書のデジタル形式での公開を原則とします。これにより、国民はいつでも資金の使い道を検証できるようになります。
2.  **使途の厳格化**: 対象となる経費の範囲を、調査研究や広報、滞在に直接関連するものに限定し、法律で明確に定めます。私的な流用や曖昧な支出を許しません。
3.  **未使用分の国庫返納の義務化**: 年度末に残った未使用分については、全額国庫に返納することを義務付けます。

これらの改革を通じて、政治への信頼を回復し、議員一人ひとりがより高い倫理観を持って活動する基盤を築きます。
