...
　なお今後も議論の結果、これらのマニフェストの内容がまだ変わる可能性がある点はご理解いただけますと幸いです。また、同性婚の扱いなど、まだ十分に議論が尽くされていない重要なテーマについても、今後、多様な意見をいただきながら検討を進めてまいります。チームみらいとしては、こうしたテーマについて党として画一的な方針で候補者を拘束するのではなく、各候補者の判断を尊重することを基本的な考え方としています。
