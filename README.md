...
本マニフェストへの変更提案は、主に２つの方法で受け付けています。ご自身に合った方法で、お気軽にご参加ください。

*   **AIアシスタントに話しかける（簡単な方法）**
    [こちらのページ](https://policy.team-mir.ai/view/README.md)から、AIアシスタントとチャットすることができます。
    「こうしたらもっと良くなるかも？」といった漠然としたアイデアでも大丈夫です。AIが対話を通してあなたの考えを整理し、具体的な改善案としてまとめるお手伝いをします。技術的な知識は一切不要です。

*   **GitHubで直接提案する（詳しい方向け）**
    [GitHub](https://github.com/team-mirai/policy/pulls)上で、具体的な変更案を直接提案（Pull Requestを提出）することもできます。

いただいたご提案は、チームみらいが責任をもって一つひとつ確認します。マニフェストに反映させるかどうかの最終的な判断はチームみらいが行いますが、当初の考えと異なるご意見であっても、真剣に検討し、より良い政策にするために活かしていきます。
