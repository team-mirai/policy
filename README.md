...
### 3歳児健診の視力検査の改善（埼玉県サポーターの田中様よりご提案）

現在、多くのお子様の将来に関わる重要なご提案をいただいております。

*   **課題**: 3歳児健診の視力検査が家庭での実施が基本となっており、弱視の見逃しリスクがあること。また、保護者への案内が古く分かりにくいこと。
*   **提案**:
    1.  3歳児健診の視力検査は、一次検査の段階から眼科医などの専門家が関与する体制を整備する。
    2.  保護者向けの案内を、より分かりやすく現代的な内容・デザインに刷新する。

この貴重なご意見に基づき、現在「ステップ１『デジタル時代の当たり前をやりきる』」の「２．子育て」の項目を中心に、マニフェストの改訂作業を進めております。
