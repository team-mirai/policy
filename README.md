...
## 助産師の専門性を守り、どこでも使える産後ケアを実現する

助産師は、看護師資格に加えて高度な専門知識と技術を持つダブルライセンス、トリプルライセンスの専門職です。その専門性が正当に評価されず、キャリアと尊厳が守られていない現状は、日本の周産期医療の危機に直結します。

**1. 助産師の専門性に見合った処遇改善とキャリアの保護**
*   助産師の専門性を正当に評価し、看護師の処遇改善に加えて、「アドバンス助産師」等の高度資格に対する専門手当を創設します。
*   助産師本人の希望に反し、産科以外の部署へ異動させることを原則禁止し、経験豊かな助産師が現場を離れることを防ぎます。これにより、安全な分娩体制と後進育成の基盤を守ります。
*   精神疾患を持つ方や高齢出産など、身体的・精神的リスクの高い妊産婦さんが増えている現状を踏まえ、産科における人員配置基準を見直し、より手厚いケアを可能にします。

**2. 必要な人が、必要な時に、どこでも使える産後ケアの実現**
*   産後ケアを、住民票の所在地に関わらず、里帰り先など今いる場所（滞在先）の自治体で利用できる全国共通の仕組みを構築します。これにより、産後の心身が不安定な時期に、地理的な制約によって孤立するお母さんをなくし、「全国どこでも安心して産後ケアを受けられる社会」を実現します。
