...
ようこそ！ ここはチームみらいの政策マニフェストのトップページです。皆さんとオープンに議論し、より良いものにしていくために公開しています。ここでは、ページの右下にあるチャットボタンからAIアシスタントを呼び出し、対話しながらアイデアを出したり、修正の提案をすることができます。
...
* ページの右下にあるチャットボタンからAIアシスタントを呼び出し、対話しながら政策要望を提出できます。  
