...
　現在、以下のような改善提案が議論されています：
*   **デジタル民主主義の推進（パブリックコメントの機能強化）**: マイナンバー等を活用した本人確認のもと、市民がオンラインで法案に賛成を示せるようにします。この『デジタルの賛意』が一定数に達した場合、少数政党などが法案を提出する際の賛同者数としてカウントできる仕組みを構築し、国民の声を直接国政に届けます。
