...
* **表現の自由と国際条約に対する姿勢**: 新サイバー犯罪条約など、国家による検閲を強化し、表現の自由を脅かす国際条約には、日本の文化と産業を守るため断固として反対の立場を表明します。私たちは、オープンで自由な創作活動こそが日本の文化と経済の基盤であると信じており、生成AIなどの新しい技術も積極的に活用しながら、これを強く支援していきます。
