...
例えば、仁様からご提案いただいた、移民・難民問題（不法移民対応、出入国デジタル管理を含む法整備）や、外国人による土地取得問題（安全保障、所有者不明、納税への影響）への対応についても、「その他重要分野についての政策・ビジョン」([50_国政のその他重要分野.md](50_国政のその他重要分野.md))に含めることを検討しており、議論を進めています。
