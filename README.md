...
安全保障上重要な土地（水源地、国境離島、自衛隊施設周辺など）については、外国資本による買収に一定の制限を設け、政府が取引を事前に審査する仕組みを導入します。また、土地所有者の情報を透明化し、国が状況を正確に把握できるようにします。

今後の具体的な法整備にあたっては、信頼できる諸外国の事例も参考にしつつ、日本の実情に合った制度を検討します。
