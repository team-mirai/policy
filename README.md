...
　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。ただし、人命をはじめとする取り返しのつかない要素が絡む分野の政策実現においては、安易な試行錯誤（アジャイル的なトライアンドエラー）を避ける慎重な姿勢を原則とします。

　「考えがまだまとまっていないではないか」とご批判を受けるリスクを積極的に取りながら、未熟なバージョンであっても公開に踏み切ります。なぜそうするかといえば、批判の目をたくさん入れ、意見を取り入れてゆくことが最も良い政策を作るやり方だと思うからです。政策の具体化にあたっては、制度を現場で担当している主任・係長級の方々への聞き取りのほか、適切な科学的根拠・論理的根拠を持つ多様な専門家から情報を確認する方針をとります。また、これはシンプルな多数決のように「意見が多いものを取り入れる」ということではありません。意見は聞きますし、プロセスの透明化も行いますが、あくまで意思決定は既存政党と同様にチームみらいの人が行います。これは、責任を取れる『人』が主体となって判断をすることが重要であるという価値観に基づくものです。
...
* **情報公開の透明性と対象者の保護**：ヒアリング等で得られた情報の公開においては、対象者の安全とプライバシーを保全するため、個人情報を特定できない形でその正当性を公開します。なお、本マニフェストや党の目的にとって不都合な情報が出たとしても、これを隠蔽することなく公開します。
* **内部告発者の保護**：万が一、情報の隠蔽などが行われた場合、内部告発を奨励し、告発を行った者に対する一切の不利益な扱いや処罰を禁止します。
