...
テクノロジーで誰一人取り残さないと言いながら、マニフェストを書く人を取り残していた現状がありました。これまで、マニフェストの内容に関するご意見をいただくことを優先しており、システム利用に関する専用の窓口の整備が追いついていませんでした。ご不便をおかけし申し訳ございません。今後は、皆様からのお声を踏まえ、以下の通り対応を強化いたします。
また、マニフェスト編集システムのご利用にあたり、エラーが発生した場合や、その他お気づきの点がございましたら、下記の窓口までお気軽にご連絡ください。いただいたご意見は真摯に受け止め、サービスの改善に努めるとともに、必要に応じて対応状況をご報告いたします。
