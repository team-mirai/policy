...
### 発達障害児への専門的支援と、全児童の安全な学習環境の確立

*   発達障害児を専門的にケアするための特別クラスを、全公立小学校に設置します。
*   上記クラスには、専門知識を有する教員や支援員を、児童数に応じて手厚く配置します。
*   児童間の暴力行為により他の児童に危害が及んだ場合、被害児童と保護者へのケアを最優先し、学校側の対応プロセスを明確化し、説明責任を徹底します。
