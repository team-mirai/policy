...
## このマニフェストは、みなさんと共に「育てる」ものです

チームみらいは、まだ実績の少ない新しい政治団体です。だからこそ、政策を完成品として提示するのではなく、その「過程」を丁寧に共有することこそが、有権者のみなさんとの信頼を築く上で最も重要だと考えています。これは、私たちの「信頼への先行投資」です。

「考えがまとまっていない」というご批判を覚悟の上で、あえて未完成な状態から公開し、みなさんと一緒にマニフェストを育てていきたいのです。なぜなら、多様な意見に触れ、議論を重ねることこそが、最良の政策への唯一の道だと信じているからです。私たちは、透明性を弱さではなく、成熟した政治に必要な「強さ」だと捉えています。

みなさんからのご意見は、AI熟議システム『いどばた』やオフラインでの対話を通じて真摯に受け止めます。ただし、最終的な意思決定は、その責任を負うチームみらいが行います。これは、衆愚に陥ることなく、多様な意見を踏まえつつも、責任ある主体が判断すべきだという価値観に基づくものです。私たちはその意思決定のプロセス自体も、可能な限りみなさんに開示していきます。

私たちは「わからないことは“未定”と正直に言う、修正する際にはその理由と過程を誠実に説明する」という姿勢を大切にします。このマニフェストが、みなさんとの対話の出発点となることを心から願っています。
