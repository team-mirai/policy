...
少子高齢化と現役世代の減少に対応するため、持続可能な社会保障制度を構築します。現行の収入のみに基づく負担算定を見直し、不動産や金融資産を含む個人の資産状況をマイナンバーによって正確に把握し、社会保険料や自己負担額の算定に反映させる仕組みを目指します。これは、真に支援が必要な人々を支え、世代間の公平性を確保するための重要な一歩です。国民の皆様から信頼される行政運営を大前提とし、必要な情報の活用を進めます。
