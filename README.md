...
### 労働市場の透明性を高め、不当な「中抜き」を是正する

匿名ユーザーからの提案に基づき、以下の政策を検討します。

**背景:**
現在の労働市場、特に建築業界などでは、多重下請け構造の中で労働の価値に見合わない手数料が不当に搾取される「中抜き」が深刻な問題となっています。また、フリーランスやギグワーカーなど新しい働き方が広がる中で、こうした人々を保護し、公正な取引を確保する仕組みが追いついていません。

**提案内容:**
1.  **政府主導の公正な職業マッチングプラットフォームの構築:**
    *   フリーランス、パートタイム、一人親方など、企業に所属しない多様な働き手も対象とした、オープンで透明性の高い全国的な職業マッチングプラットフォームを政府が構築・運営します。
    *   これにより、労働者は自身の能力や実績に見合った仕事を、不当な手数料なしに探せるようになります。
2.  **取引データの収集と分析による「悪質な中抜き」の可視化:**
    *   プラットフォーム上で行われる契約や報酬のデータを収集・匿名化した上で統計的に分析します。
    *   業種ごとの適切な仲介手数料の割合などを割り出し、それを大幅に超えるような「悪質な中抜き」を行う事業者を特定し、是正勧告や指導を行います。

**期待される効果と将来展望:**
*   労働者が能力に見合った正当な報酬を得られるようになり、生活の安定と向上につながります。
*   労働市場の透明性が高まり、健全な競争が促進されます。
*   AGI（汎用人工知能）の発展など、将来の社会変化で増加が見込まれるプロジェクト単位の働き方に柔軟に対応できる、社会基盤を構築します。
*   既存の民間事業者との関係性については、丁寧な議論と調整を行います。
