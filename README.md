...
　私たちは、特定の意見が過度に重視されることで、全体の利益が損なわれる事態を懸念しています。テクノロジーを活用して、多数派・少数派双方の意見の量やその背景にある実態をできる限り正確に把握し、広く共有することを目指します。これにより、データに基づいた建設的な議論を促し、バランスの取れた意思決定に繋げます。
