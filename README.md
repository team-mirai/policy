...
私たちは、個々の学習進度や関心に最適化された「専属AI家庭教師」と、豊富な学習コンテンツをいつでも視聴できるオンデマンド動画配信プラットフォームの提供を目指します。これらは特に、集団行動よりも一人で自分のペースで学ぶことを好む子どもたちにとって、他者に邪魔されることなく学習に集中できるという点で、最大限のメリットを提供します。これにより、自宅等でのオンデマンド学習を充実させるとともに、学校への通学強制を廃止し、子どもたちが自らの意思で時間の使い方を柔軟に決定できる環境を整備します。日中に十分な休息を取ること、自由に遊ぶこと、あるいは大人の指示や監視から離れて過ごす時間を持つことなど、子供たち自身の選択を最大限尊重します。これは、子供たちが主体的に学び、それぞれの興味や才能を自由に伸ばせる社会の実現に向けた重要な一歩です。
...
- Pull Requestが作成されると、GitHub Actionsによって自動적으로マークダウンファイル内のリンクがチェックされます
