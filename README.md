...
*   **投票所へのタブレット端末導入**：インターネット投票に伴う秘密投票の担保や、システム開発コストの問題を回避しつつ、投票のデジタル化を推進するため、投票所にタブレット端末を設置します。既存の代理投票制度を参考に、デジタル機器に不慣れな方への人的サポート体制も整備します。
*   **一人10投票点制度の導入**：有権者が持つ票を一人10点とし、選挙区・比例代表の別なく、複数の候補者や政党に自由に配分できる制度を導入します。これにより、有権者の多様で細やかな意思をより正確に政治に反映させることを目指します。
