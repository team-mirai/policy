...
今の世界は分断とブロック化の只中にあります。アメリカも中国も過激化し、ヨーロッパは議論に疲弊しつつある。その中で日本が取るべきは、「誰の味方か」ではなく「誰にも切られない存在」になることです。「信頼できるが従属しない」、「静かに支えるが外せない」ポジションを目指します。

* 通貨・外交の安定性は、口先の主張ではなく、信用の積み重ねでしか生まれません。
* チームみらいが提案する「静かな合理性」「行政の誠実さ」が外交にも反映されることで、日本は世界の中で**“使われる国”ではなく、“信頼される国”になれる**はずです。
