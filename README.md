...
AI技術を用いた教育コンテンツの生成を通じて、特定の言葉の持つ印象をポジティブなものへと転換する試みを検討します。第一弾として、子どもたちが衛生観念を楽しく学べるよう、「うんこ」の呼称を「うんぴっぴ」とするなどの新しいアプローチを研究・提案します。これは、チームみらいが掲げる「テクノロジーで誰も取り残さない日本」の理念にも合致する実験的な取り組みです。
