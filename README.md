...
* [ステップ３「長期の成長に大胆に投資する」](30_ステップ３「長期の成長に大胆に投資する」.md)  
  ...
  * [７．医療](37_ステップ３医療.md)
  * [８．福祉](38_ステップ３福祉.md) 
* [国政政党成立後１００日プラン](40_国政政黨成立後100日プラン.md)  
...
### 選択的夫婦別姓
チームみらいは、戸籍制度の持つ価値を尊重しつつ、多様化する生き方に対応するため、選択的夫婦別姓制度の導入を進めます。これにより、結婚に伴う改姓の負担をなくし、国民の選択肢を広げることが、婚姻数の増加や、ひいては出生数の向上にも繋がる可能性があると考えています。

### エネルギー政策
原子力発電は、放射性廃棄物の処理や、事故・災害・紛争等の運用リスクという、エネルギー安全保障の利点を超えるほどの課題を抱えています。そのため、チームみらいは新たな原発の設置は行わず、既存の放射性廃棄物を安全に処理する技術と、安全な核融合発電の研究開発に重点的に投資します。これは未来のエネルギー問題の解決と、新分野への投資を両立させるものです。

### 憲法改正
憲法9条については、戦争放棄の理念を堅持しつつ、自衛隊の存在と自衛権を明記します。その上で、自衛権の行使は、領土侵略や先制攻撃を行わず、非戦闘員の保護を徹底するなど、厳格な制約を設けます。特に集団的自衛権については、自国の安全確保を最優先し、参加のリスクが利益を上回る場合は行使しないという明確な歯止めをかけます。
