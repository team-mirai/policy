...
チームみらいは、表現の自由を、特に創作活動において最大限尊重します。創作活動は、あらゆる個人に保障された基本的な権利です。公権力による安易な介入は、文化の多様性と発展を阻害するため、原則として行うべきではありません。
特に、性表現などに関する規制は、明確な法的根拠に基づき、必要最小限にとどめるべきです。現状見られるような画一的な修正の強制は、表現の多様性を損なうため、見直しを検討します。私たちは、行政による過度な介入ではなく、民間の自主的なゾーニングやレーティングといった取り組みを尊重し、クリエイターの自由な創作活動を支援します。
また、特定の事業者による決済手段の一方的な停止など、民間による事実上の規制が、クリエイターの経済的基盤を脅かすことにも懸念を表明します。私たちは、誰もが安心して創作活動を行い、その対価を得られる環境を守ります。
