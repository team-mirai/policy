...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。例えば、様々な事情で投票所に行くことが難しい方々のために、マイナンバーカード等を活用したインターネット投票の導入を検討するなど、具体的な政策でこれを実現します。
