...
　国会議員がいない現状で責任は取れるのか、というご批判はもっともです。私たちは、言葉だけでなく行動で示すことこそが責任だと考えます。国政の議席がなくても、賛同する自治体や団体と連携し、政策のモデル事業を実行します。失敗も含めた結果を全て公開し、社会と共に改善を重ねる。この「行動と透明性」こそが私たちの責任の取り方です。

　また、『将来世代に負担をかけない』という耳障りの良い言葉だけで支持を得ようとは思いません。赤字国債に頼る現状を直視すれば、負担の議論は不可避です。私たちは、経済成長と改革で財源確保に全力を尽くし、将来世代への過度な負担増を抑制すること、そしてそのプロセスを徹底的に透明化することをお約束します。
...
私たちは、国政での実現を目指すだけでなく、このマニフェストに賛同する地方自治体や市民団体と積極的に連携し、政策のモデル事業を全国各地で立ち上げます。その財源は、寄付やクラウドファンディングによって確保し、使途はウェブサイトで全て公開することで、活動の透明性を徹底します。十分な寄付が集まらない場合でも、活動を断念することはありません。まずはオンラインでの情報発信や、小規模な勉強会の開催など、限られた資源で始められる活動から実行し、着実に実績を積み重ねていきます。
...
　頂いた変更提案は、チームみらいが責任をもって確認します。変更提案をマニフェストの反映させるかどうかについては、チームみらいが権限を持ちます。当初マニフェストとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。
