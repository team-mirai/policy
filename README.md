...
チームみらいは、「テクノロジーで誰も取り残さない」という理念に基づき、すべての人が自分らしく生きられる社会を目指します。その一環として、ジェンダー平等と多様性の尊重を重要な政策課題と位置づけます。

### 主な政策
*   **同性婚の法制化:** 婚姻の平等を保障し、すべてのカップルが等しく法的な保護を受けられる社会を実現します。
*   **婚姻・離婚手続きのオンライン化:** デジタル技術を活用し、当事者の負担を軽減するとともに、手続きの利便性を向上させます。
*   **公的書類における性別欄の見直し:** 不必要な性別情報の記載をなくし、トランスジェンダーやXジェンダーの方々が直面する困難を解消します。
*   **包括的セクシュアリティ教育の推進:** 科学的根拠に基づいた正確な知識を子どもたちに提供し、性の多様性や自己決定権、他者への尊重を育む教育を推進します。
