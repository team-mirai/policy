...
## NPO/NGO等への補助金・助成金の透明性と公正性の向上

国や地方自治体からNPOやNGO等へ支出される補助金・助成金について、その使途の透明性を確保し、国民の信頼を高めるため、以下の制度を導入します。

1.  **情報公開のデータベース化**: 補助金等の交付団体、金額、住所、活動内容を網羅したウェブデータベースを法整備によって構築し、誰でも閲覧可能にします。
2.  **厳格な第三者監査の義務化**: 思想や政党色に偏りのない公認会計士など、中立な専門家による会計監査を義務付け、その結果も公開します。
3.  **住民参加の仕組みづくり**: 交付前に、地域住民や納税者が意見を述べられる「パブリックコメント制度」を導入します。
4.  **審査プロセスの透明化**: 審査員の名簿や選定の過程・基準を公開します。
...
[安NOたかひろ公式YouTube](https://www.youtube.com/@%E5%AE%89%E9%87%8E%E8%B2%B4%E5%8D%9A)
