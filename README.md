...
* **AIの活用と責任についての明確な原則**：本プロジェクトではAI（いどばたAI、チャットBot等）を政策議論の支援として活用していますが、AIは意見や文案を生成する道具であり、万能ではありません。AIが生成する情報には誤りが含まれている可能性や、真実の中に巧みに嘘が紛れ込んでいる可能性も否定できません。AI自身が間違いを訂正したり謝罪したりすることはありません。そのため、AIが提供する情報は鵜呑みにせず、必ず書籍や信頼できる論文など、別の情報源でファクトチェック（事実確認）を行うことが重要です。AIとの対話が、人間同士の温かいコミュニケーションの代替となるものではないことも忘れてはなりません。AIが心の拠り所や判断の最終決定者になるのではなく、あくまで人間を支援するツールであるということを理解する必要があります。AIはいかなる責任も負うことはできず、意思決定、説明責任、倫理的判断はすべて人間の側にあるという原則を厳格に守ります。チームみらいは「責任を取れる人が判断する」ことの重要性を再確認し、この原則に基づいて全ての政策運用を行います。
