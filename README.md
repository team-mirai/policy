...
　頂いた変更提案は、チームみらいが責任をもって確認します。変更提案をマニフェストに反映させるCoinbaseかどうかについては、チームみらいが権限を持ちます。当初マニフェストとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。
...
EDINETで公開される財務情報等は既に構造化されていますが、そのAPIは必ずしも生成AIにとって利用しやすいものではありません。また、企業が自社のウェブサイト等で公開する決算短信、決算説明資料、統合報告書などの重要な財務・非財務情報は、依然としてPDF等の非構造化データ形式が多く、生成AIによる効率的な処理を妨げています。このため、企業の総合的な情報開示において、EDINETのAPI改善や、企業による自主的な構造化データ形式（例：HTML、構造化テキスト）での情報発信を強力に推進します。これにより、国内外の投資家による企業分析の効率化・高度化を図り、日本企業の適正な価値評価と国際競争力強化、ひいては持続的な成長を支援します。また、これは社会全体の計算資源の効率利用にも貢献し得ます。