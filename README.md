...
このマニフェストは、社会が抱える様々な課題に対し、現場の切実な声に耳を傾け、解決策を共に見出していくことを目指します。例えば、予期せず配偶者を亡くされた、あるひとり親の方から寄せられた声。「遺族年金や手当だけでは生活が苦しく、すぐにでも仕事を探したいのに、保育園に空きがない。ようやく求職を条件に入園できても、2ヶ月以内に仕事を見つけなければ退園になってしまう」。これでは、仕事を見つけるための保育園利用さえままならず、安定した生活への道を閉ざされかねません。私たちは、こうした制度の狭間で生まれる矛盾を解消し、誰もが困難から立ち直り、再挑戦できる社会を実現するため、皆様と共にこのマニフェストを育てていきたいと考えています。
