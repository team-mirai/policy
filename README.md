...
**「地域みんなで子育て」サポートシステムの創設**

核家族化やワンオペ育児など、孤立しがちな現代の子育てを、地域全体で支える仕組みを作ります。

*   **利用登録の自動化:** お子さんが生まれた全ての家庭が、地域のサポートシステムに自動的に登録され、いつでも気軽にサービスを使えるようにします。
*   **保育園機能の開放:** 保育園に通っていないお子さん（特に0〜1歳）と保護者の方も、園庭で遊んだり、給食を体験したり、専門の保育士さんに育児相談ができるように、保育園の機能を地域に開放します。
*   **利用料の無償化:** 経済的な理由で利用をためらうことがないよう、これらのサポートは原則として無償で提供します。
