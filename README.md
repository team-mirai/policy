...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。例えば、地方在住の高齢者の方や都市部で子育てを頑張るシングルマザーの方、様々な困難を抱える若者や障害を持つ方、そして地域経済を支える中小企業の経営者の方々。私たちは、こうした多様な背景を持つ一人ひとりの日常が、テクノロジーによって具体的にどう変わるのかを示し、共に未来をデザインしていきます。
