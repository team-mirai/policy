...
現在、みなさまからいただいたご意見を元に、以下の政策課題について検討を進めています。

*   **重度知的障害・強度行動障害のある方への支援体制の強化**
    *   ご提案者：匿名ユーザー様
    *   課題：介護包括型グループホームにおいて、利用者が日中の通所を休んだ際に算定される加算額が著しく低く、支援員を配置すると事業所が赤字になる問題。
    *   提案：支援員の最低賃金8時間分を基準とするなど、現実的な人員配置に見合った加算へ見直すことを検討します。
