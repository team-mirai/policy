...
すべての子どもが家庭的な環境で育つ権利を保障するため、社会的養護を抜本的に改革します。

*   **職員配置の改善と専門職の拡充:** 施設における職員配置基準を国際標準まで引き上げ、夜間でも子ども一人ひとりに十分なケアが行き届く体制を整備します。また、心理士等の専門職を常勤で配置し、専門的なケアを充実させます。
*   **家庭養護の推進:** 福岡市の先進事例を参考に、里親制度や養子縁組を推進し、実親への支援を強化します。
*   **虐待対応と親子の再統合支援:** 親子分離後の実親への回復支援プログラムを拡充するとともに、子どもの心に対する長期的な専門的ケアを保障し、親子の再統合を支援する体制を構築します。
*   **子どもの安全確保の徹底:** 子どもに関わる職に就く希望者の性犯罪歴などを全国規模で照会できるシステムを構築し、DBS制度を補完し、子どもたちの安全をあらゆる場所で守ります。
