...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * [７．医療](17_ステップ１医療.md)
  * [８．福祉](18_ステップ１福祉.md)
  * [９．生成AIとクリエイター・人権の保護](19_ステップ１生成AIとクリエイター・人権の保護.md)
...
* [その他重要分野についての政策・ビジョン](50_国政のその他重要分野.md)
  * [５．犯罪捜査におけるDNA鑑定技術活用の推進](55_その他重要分野_DNA鑑定技術活用.md)
...
政策内容の変更以外のPR（例：タイポ修正、フォーマット調整、ドキュメント更新など）でX通知を避けたい場合は、PRに `skip-notification` ラベルを付けることで通知をスキGきます。
