...
チームみらいは、永田町に約10名規模の技術者集団「永田町エンジニアチーム」を設置します。本チームは、国会議員による政策立案支援を行うとともに、行政との連携を通じて実装フェーズへの橋渡しを担います。具体的には、デジタル庁・総務省・自治体DX推進室などと協調し、各種政策支援ツールの開発・展開に携わります。また、政党の理念に基づいた技術戦略を立案し、他党・自治体・民間とも柔軟な連携を図る独立型アドバイザリーとして機能します。
...
### ライセンス設計
チームみらいが開発・公開する政策支援ツール群（例：Polimoney、広聴AI）は、オープンソースソフトウェア（OSS）として公開されます。ライセンス設計においては、以下の原則を重視します：

*   公共性と再利用性の両立：MITやBSDなどの寛容なライセンスを基本としつつ、一定の再配布や改変時に条件を課すGPL/LGPL等も、公共性の高いツールに対して柔軟に検討します。

*   透明性と責任の明記：ツールごとに明確なライセンス文書を付与し、再利用者が遵守すべき指針やガイドラインを併記します。

*   市民との共創精神の保持：OSSは誰でも改善・提案できる公共財と捉え、市民・開発者・政策関係者の三者による「合意形成型運用」を心がけます。

ライセンス選定の過程においては、「OSSガバナンス委員会」による評価・助言を受け、民主的かつ技術的合理性に基づいた決定を行います。

### レビュー体制
チームみらいは、OSS運用における品質と透明性を担保するため、以下のレビュー体制を構築します：

*   三者合議型レビュー GitHub上でのPull Request（PR）に対して、技術チーム・市民開発者・政策担当者の三者がレビューを行う合議制を導入します。これにより、技術的妥当性と政策的整合性、市民視点のバランスを確保します。

*   公開型Issue管理 政策支援ツールに関する課題や提案は、GitHub上のIssueとして誰でも投稿・閲覧・議論可能とします。これにより、開発プロセスの透明性と参加性を高めます。

*   レビュー基準の明文化 コードレビューにおける評価基準（例：セキュリティ、再利用性、政策との整合性など）を文書化し、OSSガバナンス委員会の監督のもとで定期的に更新します。

*   ドラフトPRと早期レビュー 完成前のコードでもドラフトPRとして提出可能とし、早期のフィードバックを促進します。これにより、開発者の心理的安全性と改善の柔軟性を確保します。

### AI倫理に関する基本原則と運用体制
チームみらいは、政策支援AIの設計・運用において、国内外のガイドラインに基づく以下の基本原則を尊重します：

*   人間中心性：AIは人間の意思決定を補助するものであり、最終判断は人間が担うべき

*   公平性と非差別：性別・人種・思想などに基づく不当な差別を防ぐ設計が必要

*   説明責任と透明性：AIの判断根拠を明示し、政策形成における影響を説明可能にする

*   プライバシー保護：意見収集や分析において個人情報の取り扱いに厳格な配慮が必要

*   アカウンタビリティ（責任所在）：AIの判断が政策に影響を与える場合、誰が責任を持つかを明確にする

これらの原則を実装するため、以下の体制を構築します：

*   外部有識者・市民代表・技術者による AI倫理レビュー委員会 の設置

*   政策支援AIには Algorithmic Impact Assessment（AIA） を添付し、判断根拠・影響範囲・リスク評価を明示

*   OSSガバナンス委員会と連携し、倫理原則の更新を 公開レビュー形式 で実施

*   広聴AIなどには フェアネス評価ツール を組み込み、バイアス検出・修正を可能にする設計を採用
