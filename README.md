...
### 匿名ユーザーからのご提案：柔軟な名前のあり方について

**提案の概要：**
国のデジタル基盤（マイナンバー制度など）で個人がきちんと識別できるなら、もっと自由に名前（姓）を選べるようになっても良いのではないか。

**提案の背景：**
この提案は、DV被害から身を守るために名前を変えたい方や、ご自身の姓に強い愛着やアイデンティティを持つ方など、多様な個人の事情に寄り添うことを目的としています。
