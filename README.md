...
キャッシュレス決済の普及を加速するため、決済手数料を政府負担により無料化します。これにより事業者のコストを削減し、現在普及の障壁となっている手数料負担の問題を解決します。財源はキャッシュレス化がもたらす経済全体の生産性向上で確保します。また、QRコード規格を統一し、全事業者が同じ規格を利用できる環境を整備することで、健全な競争を促進し、一層のサービス向上と技術革新を目指します。
