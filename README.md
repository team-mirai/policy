...
匿名ユーザーからの提案（議論のためたたき台として記載）

### 背景
外国人の投資目的の不動産購入が、不動産価格の高騰を招き、国民の住宅取得を困難にしている懸念がある。

### 提案内容
不動産の投機的な短期売買を防ぐため、以下の施策を検討する。
- 外国人が日本国内の不動産を売却する際の税率を、現行よりも高く設定する。
- 特に、購入後の保有期間が短い不動産を売却する場合には、さらに高い税率を課す（短期売却に対する重課）。
- 購入前の審査と購入後の実態調査を強化し、実需に基づかない投資目的の不動産取得を抑制する。
