...
現在、みなさまからのご意見をいただき、動物の権利と福祉に関する政策の具体化を進めています。特に、以下のような視点を重視しています。
*   **公的な保護・譲渡体制の強化**: 自治体やボランティア任せにせず、国として保護施設の運営基準策定や財政支援を行います。
*   **責任ある飼育文化の醸成**: ヨーロッパの事例も参考に、生体販売の規制や飼い主の登録制度導入を検討し、動物が安易に捨てられることのない社会を目指します。
*   **動物虐待の防止**: 動物虐待に対する罰則を強化し、すべてのいのちが尊重される社会を実現します。
このテーマについては、今後さらに議論を深め、具体的な政策としてマニフェストに正式に位置づけていく予定です。
