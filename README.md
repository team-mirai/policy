...
#### １．控除制度の抜本改革：現代の社会課題に対応する税制へ
現行の控除制度は「少子化・共働き・介護・予防医療」という課題に対応できていません。働く世代を公平に支援するため、以下の税制改革を提案します。

- **扶養控除の0歳から適用**
- **介護控除の新設と、老人扶養控除の同居要件緩和**
- **配偶者控除を、世帯単位で考える「夫婦控除」へ転換**
- **医療費控除に、人間ドックなどの「予防医療」を追加**

#### ２．国会の財政監督機能の強化：「独立財政評価局」の設置
予算編成の権限が財務省に集中しすぎている現状を改め、国会が主体的な財政議論を行えるようにするため、国会直属の「独立財政評価局」を設置します。与野党が推薦する専門家で構成し、政策が財政に与える影響を客観的に評価・公表する機関とします。
