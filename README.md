...
ようこそ！　ここはチームみらいの公約（マニフェスト）を、みんなでオープンに話し合って、もっとよくしていくためのページ（オープンソースレポジトリ）です。ここでは、だれでも自由にアイデアを出したり、修正の提案をすることができます。特に、このマニフェストの根幹として、性別にかかわらず誰もが、出産や育児といったライフイベントを経験しながら、キャリアの断絶を恐れることなく、円滑に仕事に復帰できる社会の実現を、私たちは重要な柱として考えています。
...
以下は、nkmさんとの議論を踏まえて作成された政策案の下書きです。

### 未来への投資！キャリアアップ休暇制度

**目的:** この制度の大きな目的は、**出産や育児による女性のキャリア断絶という課題を、社会全体の仕組みとして根本から解決する**ことにあります。性別や理由を問わない新たなキャリア休暇を普及させることで、企業内に「社員が休暇を取得し、成長して復職する」という好循環の前例を数多く作ります。これが、**育児休業からの復帰など、様々なライフイベントを経た後の復職を、特別なことではなく当たり前のプロセスとして受け入れる企業文化を育む**ことにつながります。国は、休暇の取得と円滑な復職支援を不可分のセットとして力強く後押しします。

**対象者:** 年齢を問わず、キャリアアップを目指す全ての希望者

**支援:**
*   休暇取得を認めた企業への税制優遇を強化。
*   国は、企業に対し、代替人材の確保支援や、復職後のキャリアプランニングに関するコンサルティングを提供する。
