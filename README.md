...
このマニフェストはバージョン0.3(超初期版)として公表したものであり、頂いたご意見を踏まえてどんどんアップデート（改善）をしてゆきます。
...
（かめ様からのご提案）選挙プロセスの効率化を目指し、ビラやポスターへの証紙貼付を廃止します。また、公設ポスター掲示板を原則として廃止し、代替措置としてオンラインでの選挙ポータルサイトを国が整備・運営し、全ての候補者情報を公平に有権者に届ける仕組みを構築します。これにより、選挙活動における無駄なコストや労力を削減し、政治家がより本質的な政策議論に集中できる環境を整えます。

　このマニフェストは皆さんの声を拾いながら改善していくためのバージョン0.3（超初期版）であり、まだまだ議論中、作業中の箇所がたくさんあります。チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。
