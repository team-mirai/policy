...
---
## matskenさんからのご提案：デジタル郵便受け
*この内容はmatskenさんとの対話に基づき、「３．くらしと行政」の項目への追加を想定して作成された下書きです。*

希望者に対しては、行政からの通知や民間の各種明細書（クレジット、光熱費など）を手軽に確認できる安価な機器（デジタル郵便受け）を配布または貸与します。この機器は、HDMI出力でテレビに接続して閲覧し、USB端子に接続したプリンタで印刷できる仕様とします。また、このデジタル郵便受けはIR受信機を備え、テレビのリモコンのような一般人にもなじみのあるもので操作できる簡便なUIを備え、かつ、ITに詳しい人はキーボードとマウスを接続して、より迅速に操作できます。官民が連携し、誰もがデジタル化の恩恵を受けられるプラットフォームの構築を推進し、郵便物の削減と利便性の向上を目指します。
