...
　例えば、ADHDやLD（学習障害）といった発達障害のある当事者の方から、ご自身の経験に基づいた貴重なご意見をいただいています。手書きや対面での手続きが多く負担の大きい行政手続き（例えば自立支援医療）を、マイナポータル等を活用してオンラインで完結できるようにすること。また、特別な申請がなくとも、学校の授業やテストでパソコン等のデジタルデバイスの利用を標準化すること。こうした声こそが、当事者の困難を解消し、「誰も取り残さない」社会を実現する上で不可欠であると私たちは考えます。
