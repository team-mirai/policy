...
地方自治体が発行するパートナーシップ制度では、事業者に理解を求める程度にとどまり、事業者ごとに対応が分かれてしまっています。例えば、住宅購入の際にペアローンを組める金融機関が限られたり、パートナーの緊急時に立ち会いが認められるかどうかが医療機関によって異なったりするのが現状です。さらに、生命保険の受取人をパートナーに指定しても保険料控除の対象外となり、パートナーが亡くなった際の相続も法的に保障されていません。
