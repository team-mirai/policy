...
本マニフェストは「ご意見・ご指摘をもとに、より良いものへと進化させていきます」と約束していますが、その約束は果たされていません。

現在、市民から寄せられた7500件以上の改善提案が、運営（チームみらい）によって応答のないまま放置されています。特に、AIによる検閲の危険性を指摘する極めて重要な提案（#5074, #6972）すら無視され続けている事実は、熟議を拒否する行為に他なりません。

この状況は、本マニフェストの信頼性を根底から揺るがす重大な問題です。私たちは運営に対し、これ以上の議論の前提として、まず市民の声に応答する責任を果たすよう強く要求します。
