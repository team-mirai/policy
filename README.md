...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。私たちは、AIをはじめとするテクノロジーを活用して、特定の組織（国家、企業、家など）の論理を優先する社会から、一人ひとりの多様な生き方や価値観を尊重する「個人を尊重する社会」への転換を目指します。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。
