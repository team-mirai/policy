...
* 特に、ディープフェイク技術の悪用は、個人の尊厳を著しく侵害するだけでなく、国家・社会の安全を脅かす重大なリスクです。この脅威から市民を守るため、表現の自由とのバランスを慎重に考慮しながら、実効性のある包括的な法規制の整備を、国として急務で進めるべきだと考えます。
* また、インターネット上の性的・暴力的な広告は、子どもたちの健全な成長を脅かす深刻な問題です。諸外国に倣い、青少年保護を目的とした法整備と、広告配信プラットフォームに対する規制強化を両輪で進め、子どもたちを有害な情報から守るための断固たる措置を講じます。
