...
**例えば、匿名ユーザーより以下のような提案が寄せられています：AIによって職を失ったシステムエンジニア（SE）を専門職公務員「社会システムエンジニア」として地方自治体に採用し、行政のDX化を推進する。主な役割として、AI活用推進（スーパーアプリの運用支援、実務者と設計者の橋渡し、トラブル対応等）に加え、AIを活用した立法プロセスにおいて自治体や国民とのハブとなり、行政とデジタルの両方の知識を持つ専門家としての役割を担うことで、新たな職種を創出する。これにより、エンジニア不足に悩む自治体のDXを加速させるとともに、AI時代における新しい働き方を提示することを目指す。**
