...
### 川上どんぶらこ様からのご提案：行政システムの標準化による効率化

図書館の予約システムや公共施設の予約システムなど、多くの行政サービスで自治体ごとにシステムがバラバラに開発・運用されている現状があります。そこで、国が主導してこれらのシステムの標準仕様を策定し、共同で利用できるシステムを提供することを提案します。これにより、各自治体の開発・運用コストを削減し、住民の利便性向上（全国で使い方が統一される、マニュアル動画なども共通化できる等）も期待できます。これは、「ステップ１『デジタル時代の当たり前をやりきる』」の「くらしと行政」分野の具体策として位置づけられるものと考えます。
