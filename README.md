...
* [その他重要分野についての政策・ビジョン](50_国政のその他重要分野.md)
  * **【選択的夫婦別姓制度に対するチームみらいの考え方】**
    選択的夫婦別姓制度については、様々な議論がある一方で、国民生活に密接する、より優先度の高い課題が数多く存在します。私たちはまず、これらの喫緊の課題解決に全力を尽くすべきだと考えます。したがって、国民的な関心が高いとは言えない現状において、現時点での制度変更には慎重な立場をとります。
