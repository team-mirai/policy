...
チームみらいは、本マニフェストを通じて、国民一人ひとりの幸福度を高め、G7の代表国として誇れる日本の実現を目指します。
...
㠠行政手続きにおけるデジタル化の遅れや、自治体ごとに異なる非効率な手続きが、市民や企業に負担を強いている現状を重く受け止めます。例えば就労証明書については、その必要性を根本から問い直し、書式の全国統一、押印の原則廃止、さらには税務情報等の行政内連携による企業介在の不要化といった、提出廃止に向けた具体的な解決策を盛り込んでいきます。さらに、デジタル庁との横断的な人材ローテーションを推進し、業務の属人化を防ぎ透明性を高めることで、行政サービス全体の効率化と質の向上を目指す
