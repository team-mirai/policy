...
## 選挙運動のあり方
チームみらいは、有権者との丁寧な対話を重視し、街頭演説は原則行いません。代わりに、公民館やカフェなどで地域の方々と直接語り合う「タウンホールミーティング」や、YouTubeなどを活用した「オンライン対話集会」を積極的に開催し、双方向のコミュニケーションを大切にします。また、既存の選挙啓発予算を見直し、その財源を、選挙無関心層にも情報を届けるため、全国の主要な広告ビジョンで全政党の公約を公平に紹介する新たな取り組みに投資します。
