...
* **AIと著作権に関する私たちの考え**：チームみらいは、クリエイターの権利が保護されることを極めて重要だと考えています。生成AIの学習データに著作権物が含まれる問題については、クリエイターの努力と権利が不当に侵害されることのないよう、法整備や技術的対策を積極的に推進します。私たちは、創造性と技術革新が共存できる社会を目指します。
