...
*   動物取扱業の種別に、「撮影」「理美容」「ふれあい」を新設し、規制対象を現代の多様なビジネスモデルに合わせて拡大します。これにより、動物の福祉を一層向上させ、事業者と利用者の安全を守ります。
*   ペットの生涯を通じた情報追跡システムの構築：出生から販売、譲渡、そして生涯の終わりまで、ペットの情報を追跡できる全国データベースを構築し、流通の透明性を確保します。
*   販売・譲渡事業者の責任の法制化：動物を販売・譲渡した事業者は、飼い主が飼育困難になった場合の引き取りや再譲渡の責任を負うこと、また、繁殖引退動物の生涯福祉を保障することを法律で義務付けます。
