...
個人の意思を尊重し、多様な家族のあり方を認めるため、選択的夫婦別姓制度の導入を目指します。

これは、改姓が婚姻の障壁となる現状や、改姓が女性に偏りがちな点を解消し、婚姻率の向上や男女平等の実現に繋がると考えます。家族の一体感は、姓の同一性でなくコミュニケーションによって育まれるという価値観に基づき、多様な生き方を尊重できる社会を目指します。
