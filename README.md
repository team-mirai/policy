...
ようこそ！ このページは『チームみらい』の政策を、みなさんと一緒に議論し、改善していくための対話の場です。

**政策を閲覧したい方**
*   [政策ビューア](https://policy.team-mir.ai/view/README.md)で、政策の全体像を読むことができます。

**議論・提案したい方**
*   このページで、AIアシスタントと対話しながら、変更提案をまとめたり、疑問を投げかけることができます。
