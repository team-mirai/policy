...
現在、富岡さんより下記のご提案をいただき、議論を進めています。

*   **概要:** 小学校区のような身近な場所に高齢者施設を設置し、在宅介護が困難な方や希望する方が入居できる社会を目指します。希望するすべての人が入居できることを目標とします。
*   **職員の雇用形態:** 施設の職員は「準公務員」として雇用し、安定した待遇を確保することで、介護の担い手不足解消につなげます。
*   **費用負担:** 施設の設置・運営費用は、国と自治体が負担します。利用者の負担は本人の年金を充当し、家族などが流用できない仕組みを構築します。

このテーマについて、ご意見やさらなるアイデアを募集しています。
