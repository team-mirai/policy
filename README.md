...
<h2 id="election-reform">ステップ１追加提案：選挙制度改革</h2>

**cow eyeさんによる提案**

### 地方の首長選挙から「優先順위付投票制」を導入
都道府県知事選挙と市区町村長選挙に、優先順位付投票制を導入します。

#### 目的
1.  **過半数の民意の反映:** 過半数の支持を得た当選者を決めることで、選挙の公平性と正当性を高めます。
2.  **多様な選択肢の提供:** 予備選挙や政党間の候補者調整が不要となり、有権者はより多様な候補者から選択できるようになります。

#### 有権者にとっての利点
*   **簡単な投票:** 投票用紙に好みの候補者から順番に番号を記入するだけです。全ての候補者に順位を付ける必要はありません。
