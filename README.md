...
ようこそ！　ここはチームみらいの公約（マニフェesto）を、みんなでオープンに話し合って、もっとよくしていくためのページ（オープンソースレポジトリ）です。ここでは、だれでも自由にアイデアを出したり、修正の提案をすることができます。
...
---
**ぽこさんからのご提案に基づく追加検討項目：**

【移民政策・国土保全】
外国人による土地取得を規制し、水源地や安全保障上重要な国土の保全を徹底します。また、地域社会との共生を基本とし、日本の文化や秩序を守るための法整備を進めます。
