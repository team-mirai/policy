...
## 子どもたちを性被害から守る
子どもへの性加害は、その心と体を深く傷つける深刻な裏切り行為であり、断じて許されるものではありません。チームみらいは、この問題に対して以下の具体的な政策を推進します。

* **加害者の厳罰化と再犯防止の徹底:** 性犯罪の量刑を見直し、特に子どもに対する性加害については罪を重くするとともに、加害者に対する継続的な更生プログラムを義務化し、再犯を徹底的に防ぎます。
* **日本版DBSの導入:** 学校や保育所、塾、学童など、子どもと接する仕事に就く際に性犯罪歴の証明を求める「日本版DBS」を創設し、子どもたちが安全な環境で過ごせるようにします。
* **被害者ケアの抜本的拡充:** 被害に遭った子どもと、そのご家族が心と生活を取り戻せるよう、精神的ケア、法的支援、経済的支援を含む、切れ目のない包括的な支援体制を構築します。
* **ワンストップ相談窓口の全国設置:** 被害者が声を上げやすいよう、匿名で24時間、オンラインでも相談できるワンストップの相談・支援センターを全国に設置します。
