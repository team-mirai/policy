...
### 国会における投票方式のデジタル化について（匿名ユーザーからの提案）

国会における投票方式のデジタル化は、審議の効率化に不可欠です。参議院で一部導入されている押しボタン式投票の運用実績や課題を参考に、衆議院においても導入を検討します。将来的には、国会全体での電子投票の全面的な活用を目指し、その利点と課題について国民的な熟議を重ねながら、丁寧な制度設計を進めます。
