...
### **伝統と利便性を両立する、旧姓通称使用の拡大**

私たちは、家族の絆の証しであり、自らのルーツを知る上で重要な役割を果たす日本の戸籍制度を、今後も維持・継承していくべきだと考えます。

一方で、結婚等に伴う改姓によって生じる、銀行口座や各種証明書の名義変更といった事務的な負担が大きいという声も、真摯に受け止めなければなりません。

そこで私たちは、選択的夫婦別姓制度の導入ではなく、旧姓の通称使用を社会のあらゆる場面で拡大していくことを提案します。これにより、親子で姓が異なることによる混乱を避けつつ、改姓に伴う実生活での不便を解消することが可能です。

この方法は、行政システムの大きな改修を必要とせず、法制度の柔軟な運用で対応できるため、社会的なコストを抑えながら迅速に実現できる、効果的な解決策です。
