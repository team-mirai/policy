...
## 人権に関する基本原則：全ての政策の絶対的制約条件

チームみらいのあらゆる政策、テクノロジー活用、システム設計は、何よりもまず「基本的人権」を絶対的な制約条件とします。

私たちは「誰も取り残さない」と掲げていますが、この言葉の定義を曖昧なままにしてはなりません。「誰も」とは誰か？ 「取り残さない」とは何を基準とするのか？ これらを明確にする「人権のフレーム」がなければ、声の大きい者の意見が優先され、マジョリティに最適化された制度となり、結果的に弱い立場の人々を切り捨てかねません。

私たちは、人権を達成すべき「目的」の一つではなく、いかなる政策目的を追求する上でも決して逸脱してはならない「制約条件」と定義します。
