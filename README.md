...
　年金制度をはじめとする社会保障制度は、運用の専門性と透明性を確保します。将来世代へ過度な負担を強いることのないよう、制度設計の責任の所在を明確にすることから始めます。

　いかなる少子化対策であっても、妊娠・出産における当事者の意思と選択を何よりも尊重することを基本原則とします。その上で、妊娠・出産・子育てがキャリアの断絶ではなく、その人の人生の豊かさの一部として尊重される社会を目指します。企業には、透明で公正な評価制度を求め、ライフステージの変化がキャリアの不利益とならない仕組みづくりを推進します。
