...
### 多様なパートナーシップのあり方（同性婚など）について

- **目指すべき社会像:** 性別に関わらず、全てのカップルが平等に結婚できる社会を目指します。
- **議論の一つの選択肢:** 上記の社会像を最終目標としつつ、社会的合意形成を丁寧に進めるため、まずは子どもがいない同性カップルに限定して法的な保障を進めるといった、段階的なアプローチも重要な選択肢として検討します。

## このマニフェスト自身も、みんなの知恵を集めて改善していきます

　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマనిఫెస్టోを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。
