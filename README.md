...
このマニフェストは、みなさんとの対話を通じて進化していきます。現在、以下のようなテーマについて議論を深めています。

*   **多様なパートナーシップ制度の創設**
    *   性別や恋愛感情の有無にかかわらず、誰もが望む相手と法的なパートナーシップを結べる制度を目指します。
    *   同性カップルはもちろん、異性間の友人など、複数の個人がお互いを支え合う関係を公的に登録し、相続などで不利にならない仕組みを検討します。
*   **親子の心身の健康を守る支援の強化**
    *   出生率の向上だけでなく、親と子が共に健やかに生きられる社会を目指し、「親子検診」制度の創設や、若年期からの婦人科検診の機会提供など、具体的な支援策を検討します。
