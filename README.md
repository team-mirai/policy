...
**“聞く”から“ともにつくる”へ：謙虚さと共感を組織文化にするための構造改革**

チームみらいが未来を切り開く存在であるためには、「聡明さ」ではなく「信頼される謙虚さ」こそが最大の資産です。善意からであっても、一方的に他者をリードしようとする姿勢は、「上から目線」「遠い存在」と映るリスクを常に伴います。本提案は、立場の異なる他者の現実を「変える」よりもまず「尊重し、学ぶ」ことを前提とする政治姿勢への転換を目指すものです。

チームみらいが「高学歴・高スキルゆえに社会の多数派とズレているのでは」という懸念に正面から向き合い、“語る側”ではなく“聞く側”としての姿勢と構造をチームの中に内在化させるため、以下の取り組みを進めます。

**〇 アクションプラン：「知る」ことから「なる」ことへ**

**ステップ1：今すぐ始めること**
*   **「聞く責任」の発信と傾聴の徹底：** SNSやイベントで「私たちは変えるために話すのではなく、変えられるために聞く」という姿勢を貫きます。あえて答えを出さない「解決しない対話会」を定期開催し、徹底した傾聴を実践します。
*   **「特権性レポート」による自己開示：** 政策担当者自らが、自身の経歴や背景と社会とのギャップを「特権性レポート」として可視化・開示。「自分には見えていない現実がある」という前提から出発する文化を醸成します。
*   **現場交差配置の試験導入：** 政策担当メンバーが「週1日介護・NPO等の現場体験」に参加し、生活の現実を肌で感じます。
*   **当事者レビュー委員会の暫定設置：** 少人数でも、政策案を当事者の視点でレビューするプロセスを即時に開始します。

**ステップ2：将来目指す制度・文化**
*   **「ズレの可視化」ワークショップの制度化：** 「月収15万円での家計設計」「中卒世帯への政策説明」など、他者の視点を身体で理解する研修を定期開催し、政治的な“思い込み”を構造的に解きほぐします。
*   **市民メンター制度の導入：** 地域の生活者や支援者をメンターとして迎え、候補者や政策担当者が定期的に「感覚のズレ」を指摘してもらう関係を築きます。
*   **生活者政策パートナーの常駐化：** 福祉・介護・教育など専門の当事者を有償で組織に加え、恒常的に内部からフィードバックを得られる体制を目指します。
*   **ローカル政策ワークショップの連続展開：** 全国の複数拠点で市民・専門家と合同ワークショップを定期的に運営します。

**ステップ3：継続的な改善のための仕組み**
*   **言語・表現の不断の見直し：** 「10歳でもわかる言葉か？」を基準に、難解な専門用語やカタカナ語を避けます。「語彙チェックリスト」を導入し、「伝える人」より「伝わる人」が前に出る発信体制を構築します。
*   **「エリートバイアス監査チーム」の設置：** チーム内に“上から目線”や“無意識の偏り”がないかを点検する内部レビューと外部モニター制度を設け、継続的なフィードバックループをつくります。
