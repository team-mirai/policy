...
> この項目は、漫画家のもち様から頂いたご意見をもとに作成した、現在議論中のテーマです。チームみらいは、今後この分野の専門家や現場の方々へのヒアリングを重ね、政策を具体化していきます。

AI技術の発展は、漫画やアニメ、音楽などの創作活動に大きな可能性をもたらす一方で、クリエイターの権利保護という重要な課題も提示しています。チームみらいは、AIの推進とクリエイターの保護を両立させ、日本の文化・コンテンツ産業が持続的に発展できる環境を目指します。

**主な論点:**

*   **クリエイターの権利保護の強化:** 著作物が無断でAIの学習データとして利用されることを防ぐための法整備と、違反した場合の罰則化を検討します。
*   **公正な利益還元モデルの構築:** AI技術の利用によって利益が生まれる場合、その利益が学習元のクリエイターにも公正に還元される仕組みづくりを推進します。音楽分野における成功事例などを参考に、漫画などの分野にも応用できるモデルを模索します。
*   **クリエイターを支援するAI開発:** クリエイター自身の創作活動を支援する（作風を学習させる、作業を効率化するなど）AIツールの開発を後押しします。一方で、AIの利用がアシスタントなど専門職の雇用を不当に奪うことのないよう、慎重な検討を行います。
*   **現場の声の重視:** 法律やルールを作る際には、実際に創作活動を行っている漫画家、イラストレーター、アニメーターなど、現場の方々の声を最も重視します。ヒアリングの機会を積極的に設け、実情に即した政策立案を目指します。

私たちは、10年後、20年後も、日本の漫画文化が世界に誇るコンテンツであり続けるために、テクノロジーを活用しつつ、全てのクリエイターが安心して創作に打ち込める環境を整えていきます。
