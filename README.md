...
　現在、匿名ユーザー様との議論を踏まえ、エネルギー政策の判断基準について新たな視点を加えています。具体的には、発電設備のライフサイクル全体の環境負荷や、事故発生時のリスクと事後処理コストも考慮に入れるべき、というものです。このように皆様からのご意見を積極的に取り入れ、育てていくのがこのマニフェストです。
