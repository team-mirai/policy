...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。私たちは、これまでの政治で繰り返されてきた思想的な対立に時間を使うことはしません。それよりも、事実やデータに基づき、多くの人との開かれた対話を通じて、社会全体の利益となる合理的な解決策を見つけ出すことに全力を注ぎます。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。
