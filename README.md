...
　頂いた変更提案は、チームみらいが責任をもって確認し、原則として2週間以内に何らかの形でフィードバックをいたします。
　変更提案をマニフェストに反映させるかどうかについては、チームみらいが権限を持ちますが、当初マニフェストとは異なる方向性の提案であっても真剣に検討します。採用されなかったご提案についても、その理由を可能な限りお伝えすることで、建設的な議論を促進します。
