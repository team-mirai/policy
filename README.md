...
特に、デジタル政策の推進にあたっては、様々な立場の方々の視点を取り入れることが不可欠です。例えばデジタル母子手帳のような便利な仕組みも、医療現場の負担が増えたり、多様な家庭環境（祖父母による育児、離婚後の共同養育など）に対応できなければ、誰もが恩恵を受けられるものにはなりません。私たちは、こうした現場の具体的な課題や、データのあり方といった根本的な問いにも向き合いながら、真に『誰も取り残さない』デジタル化を進めていきます。
