...
* [ステップ２「変化に対応できる、しなやかな仕組みづくり」](20_ステップ２「変化に対応できるしなやかな仕組みづくり」.md)  
  ...
  * [５．福祉](25_ステップ２福祉.md)
    * **（新規提案）制度の狭間にいる若者への就労機会の創出:** 不登校の経験などを理由に、学歴や障害福祉の枠組みだけでは支援が届きにくい若者が社会との接点を持てるよう、身近な地域での就労機会を創出します。具体的には、地区センターや社会福祉協議会などと連携し、清掃、環境整備、受付補助といった業務を、簡単な手続きで始められる柔軟な仕事として提供する仕組みを構築します。
