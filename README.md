...
* [中期的なデジタル改革ロードマップ](45_中期的なデジタル改革ロードマップ.md)
...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。私たちは、デジタル化を急ぐあまり、現場の行政職員や開発事業者に過度な負担をかけるべきではないと考えています。既存の重要なシステムに拙速な変更を加えるのではなく、まずはこれまで手がつけられてこなかった領域から改革を進めるなど、現場の実情に十分に配慮したアプローチをとります。
