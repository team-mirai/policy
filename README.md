...
テクノロジーで誰一人取り残さないと言いながら、マニフェストを書く人を取り残していた現状がありました。
これまで、マニフェストの内容に関するご意見をいただくことを優先しており、システム利用に関する専用の窓口の整備が追いついていませんでした。ご不便をおかけし申し訳ございません。今後は、皆様からのお声を踏まえ、以下の通り対応を強化いたします。
