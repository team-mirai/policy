...
## 医療制度に関する新たな提案（ゆんさんより）

現行の医療保険制度、特に高額療養費制度について、より公平で持続可能な制度への改革を目指します。具体的には、以下の観点から見直しを検討します。

*   **制度の簡素化:** 「年間外来合算制度」や「高額介護合算制度」など、制度を複雑化させる給付を見直し、被保険者にとって分かりやすいシンプルな制度設計を目指します。
*   **給付の適正化:** 不正受給のリスクが指摘される「海外療養費制度」など、給付の必要性や公平性を精査し、医療保険財源の適正な配分を追求します。民間保険で対応可能な部分は、そちらの活用を促します。
