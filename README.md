...
---
**高次脳機能障害を持つ方などへのオンライン支援の拡充**
専門医へのアクセスやリハビリ機会の地域差をなくすため、高次脳機能障害に特化したオンライン診療の体制を整備します。あわせて、AIを活用したオンラインリハビリ開発を推進し、患者一人ひとりの生活の質の向上を継続的に支えます。さらに、障害特性によるコミュニケーションの困難さを解消するため、会話を記録・補助するAIアシスタントの開発も支援します。
---
