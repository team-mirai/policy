...
変更提案は、以下のいずれかの方法で受け付けています。

*   **チャットで提案する**
    *   **PCでご覧の場合：** 画面左側に表示されているチャットウィンドウから直接ご意見をお寄せください。
    *   **スマートフォンでご覧の場合：** 画面右下に表示されている吹き出しのアイコンをタップするとチャットが開きますので、そちらからご意見をお寄せください。
*   **（詳しい方向け）GitHubで提案する**
    *   [GitHub](https://github.com/team-mirai/policy/pulls)でPull Requestを提出してください。
...
**チャット利用について**
チャットでご意見いただく際のお名前は、ニックネームなどお好きな名前でお気軽にご参加ください。設定したお名前は、基本的にはそのままでご利用いただくことになります。ご入力いただいたお名前やチャット内容は、このマニフェスト改善の目的にのみ利用し、他の目的で利用することはありません。
