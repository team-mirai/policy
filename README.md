...
匿名ユーザー様からのご提案に基づき、以下の草案を追記します。

*   原則として、移民の受け入れは高度な専門性を持つ人材に限定します。
*   特に人手不足が深刻な医療・福祉分野では、サービスの質を維持するため、専門知識や技能に関する厳格な審査基準を設けます。
*   これは、制度を悪用する者から、ルールを遵守し日本社会に貢献している外国籍の人々を守るための区別でもあります。
