...
チームみらいは、消費税を社会全体を支える重要な基幹税の一つと位置づけています。税の公平性を重視する観点から、特定の品目に対する軽減税率の導入は、制度の複雑化を招く可能性があるため、慎重な検討が必要だと考えます。

一方で、消費税が所得の低い方々にとって大きな負担となりうるという課題（逆進性）も深く認識しています。

この課題に対し、私たちは税率の引き下げではなく、より直接的な支援策を組み合わせることで対応します。具体的には、所得控除の拡大や、所得状況に応じた現金給付などを通じて、真に支援を必要とする方々の負担を効果的に軽減することを目指します。
