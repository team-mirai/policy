...
私たちは、国会議員の給与や経費のあり方をはじめ、政治の透明性と誠実さを徹底的に追求し、国民のために尽くす政治家が正当に評価され、支持される社会の実現を目指します。
...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。また、SNSなどを活用し、難しい政治の言葉をできるだけ使わずに、若者を含む幅広い世代の方に政策を分かりやすく届けます。
