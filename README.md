...
*   **障害厚生年金制度の見直し:** 自身の特性を理解し働き続ける方が、真に支援を必要とするタイミングでセーフティネットを活用できるよう、障害厚生年金の申請期限を撤廃します。財源とのバランスを考慮し受給期間には上限を設けますが、期間終了後も支援が必要な方には、再申請や他の支援制度へスムーズに繋ぐ仕組みを構築します。
