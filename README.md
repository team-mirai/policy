...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。また、IPCC（気候変動に関する政府間パネル）の報告書が示すように、気候変動が人間活動に起因するものであるという科学的知見を深刻に受け止めています。私たちは、気候変動対策を政治の最重要課題の一つと位置づけ、将来世代への責任を果たすために、科学的根拠に基づいた政策の議論と実行を推進します。
