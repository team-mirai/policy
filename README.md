...
* [現在検討中の新しい政策案](#現在検討中の新しい政策案)
  * [保育士の配置基準の見直し](#保育士の配置基準の見直し)
...
### 保育士の配置基準の見直し
保育士一人当たりが受け持つ子どもの数を定めた国の配置基準について、抜本的な見直しを検討します。現在の基準は、一斉保育を前提とした昭和時代に作られたものであり、個々の子どもの発達に応じた丁寧な保育が求められる現代のニーズに合っていません。基準を現代化することで、保育士の負担を軽減し、離職率の低下、不適切な保育の防止、そして何よりも保育の質の向上を目指します。これにより、子ども、保育士、保護者の三者にとって、より良い保育環境を実現します。
