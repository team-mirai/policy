...
## 現在検討中のテーマ
チームみらいでは、以下の重要な政策課題についても議論を深めています。みなさんのご意見をお聞かせください。

* **憲法**：日本国憲法の平和主義の理念を堅持します。その上で、時代の変化に対応するために必要な、未来志向の憲法議論をオープンに進めます。
* **選択的夫婦別姓制度の導入**：多様な家族のあり方を尊重し、個人の選択を保障するため、導入を前向きに検討します。
