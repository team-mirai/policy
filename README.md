...
チャットを通じていただいたご意見は、原則として個人情報を削除したうえですべて公開されます。
...
## AIチャットとの対話で、マニフェストを改善できます

専門的な知識は一切不要です。このAIチャットで話すだけで、誰でもマニフェストの改善に参加できる仕組み（いどばたシステム）です。

**対話の簡単な流れ**
1.  **話す:** まずは気になる点や改善案を、AIに話しかけてください。
2.  **練る:** AIが質問や提案をします。一緒に議論を深め、より良い案を練り上げます。
3.  **任せる:** 案が固まったら、AIがあなたに代わって「改善提案」の形にまとめ、公開の場に提出します。**提案が完了したら、このチャットで確認用のリンクをお知らせします。**

これで、あなたのアイデアが正式な議題として記録され、誰もがその内容を確認できるようになります。技術的な操作は全てAIが担当しますので、安心して議論に集中してください。
