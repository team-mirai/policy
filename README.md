...
　チームみらいは、テクノロジーの活用を推進する一方で、それが全ての人にとって最適な手段ではない可能性も認識しています。特に、高齢者や認知症の方など、新しい技術への適応が難しい方々が社会から孤立することのないよう、既存のやり方やアナログな手段も尊重し、誰もが安心して利用できる選択肢を確保するバランスの取れた政策を目指します。
