...
チームみらいは、テクノロジーの力で「誰も取り残さない日本」を実現します。

古い政治や行政の仕組みを根本から見直し、あらゆる人が時代の変化に対応しながら、安心して豊かに暮らせる社会基盤を構築します。このマニフェストは、その未来を創るための、具体的で実行可能な設計図です。

皆さんの声を聞きながら、この設計図をより良いものに育てていきたいと考えています。
