...
* [誰もが安心・安全な全国医療情報共有システムの構築](#誰もが安心安全な全国医療情報共有システムの構築)  
...
## 誰もが安心・安全な全国医療情報共有システムの構築

全国の医療機関で、患者の正確な病歴や薬剤情報を共有できるシステムを構築し、医療従事者の負担軽減と医療の質の向上を目指します。

**プライバシー保護とアクセシビリティの両立:**
患者のプライバシーを最優先に考え、情報へのアクセスは本人の許可がある場合に限定します。アクセス方法は、スマートフォンアプリやマイナンバーカード、医療機関窓口での本人確認など、デジタル機器の利用が困難な方にも配慮した複数の手段を用意し、誰もが安心して利用できる仕組みを整えます。
