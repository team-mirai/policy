...
　最近の議論では、匿名ユーザー様より、AI・SNS時代における偽情報への対策や、国の財政状況を誰もが直感的に理解できるよう「見える化」するといった、信頼性の高い情報発信に関する重要なご提案をいただきました。これらの視点は、信頼できるデジタル社会と開かれた政治の基盤として、マニフェストの中でさらに具体化を検討していきます。
