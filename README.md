...
### 現在検討中のテーマ：介護現場の人員配置について

介護士のyuさんとの対話の中から、介護現場における人員配置基準が実態と乖離している問題が提起されました。これを受け、チームみらいでは以下の政策案について検討を開始しています。

**【政策案】介護現場の実態に合わせた人員配置基準へと見直し、正直な施設運営を支援します。介護に直接従事しない職員を算定対象から除外するルールを明確化します。同時に、基準を遵守する施設には介護報酬の加算などで手厚く支援し、職員の待遇改善と人材確保に繋げ、質の高いケアと働きやすい環境の両立を目指します。**

このテーマについて、さらに皆様からのご意見を募集しています。
