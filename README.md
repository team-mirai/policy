...
### 障害者支援
障害を持つ方々が、その能力を最大限に発揮できる社会を目指し、義務教育後の切れ目のない支援を実現します。具体的には、障害者手帳の保有者やそれに準ずる方が、義務教育以降も個々のニーズに合わせた教育や就労支援を無償で受けられる制度を構築します。
また、企業の障害者雇用を促進するため、法定雇用率に加え、業務委託など多様な形態での貢献も評価する新たな指標を導入します。これにより、中小企業等、様々な事業者が障害者支援へ参加しやすい環境を整えます。
