...
* **デジタル化と対面支援のバランスの重要性**：デジタル化は多くの利便性をもたらしますが、それによって対面でのコミュニケーションが持つ価値が失われることがあってはなりません。特に、支援を必要とする方々の状況を深く理解するためには、直接お会いして対話することが不可欠です。本マニフェストが推進するデジタル化は、あくまで対面での温かみのある支援を補完し、強化するためのものであり、それに取って代わるものではないことを明確に原則とします。
