...
*   **自治会向けアプリの開発・導入支援**: 自治会運営のDX化を推進するため、自治体と連携したアプリの開発支援や、既存ツールの導入費用補助を行う。役員負担の軽減、会員間の交流促進、災害時の安捕確認の効率化を目指す。
*   **士業の電子証明書をマイナカードに一本化**: 士業がオンライン申請等で使用する電子証明書をマイナカードに統合し、取得コストの撤廃と行政手続きの効率化を図る。
