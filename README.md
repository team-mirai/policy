...
* [ステップ２「変化に対応できる、しなやかな仕組みづくり」](20_ステップ２「変化に対応できるしなやかな仕組みづくり」.md)  
  * [１．教育](21_ステップ２教育.md)  
    * **アカデミックハラスメント対策:** 文部科学省内にアカデミックハラスメントを専門に扱う部署を設置します。この部署は、ハラスメント問題への介入、調停、および関係者の処分を大学に要請する権限を持ちます。大学が正当な理由なく要請に従わない場合は、助成金の減額や、悪質なケースでは大学法人格の剥脱も含む厳しい措置を講じます。
