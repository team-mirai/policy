...
### 現在検討中の提案
**文化芸術活動を支える助成金制度へ**
文化芸術活動の担い手が、その労働に見合った正当な対価を得られるよう、助成金制度を改革します。主催者の企画・運営・準備などにかかる人件費や、練習acetone等の必要経費を助成対象として明確に認め、活動の実態に即した持続可能な支援モデルを確立します。

**未就学児と家庭のための、夏の安心な居場所づくり**
夏の猛暑下で、特に未就学児を持つ家庭が経済負担なく安全に過ごせる屋内施設は深刻に不足しています。この問題に対応し、児童館の拡充や公共施設に未就学児と保護者専用のクールシェア空間を整備します。さらに、そこで実施される未就学児向けの体験ワークショップへの支援を強化し、すべての親子に豊かな夏の時間を提供します。
