...
* 高齢者が免許を返納した後も、農作業など、これまでの暮らしを続けられるよう、地域に合わせた自動運転技術の導入を支援します。
* 農地の宅地化を防ぐため、農地の炭素吸収量を価値に変える「J-クレジット制度」の活用を推進します。国が市場を整備し、農家が農地を維持する経済的メリットが宅地化の利益を上回るよう支援します。
