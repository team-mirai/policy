...
　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。例えば、チームみらいのメンバーが政治哲学について議論する様子を定期的に配信し、広く意見を募るといった、政策の根幹に関わる議論も積極的に行っていきます。なぜなら、倫理や正義、自由といった普遍的価値を明確に定義することが国民からの信頼を築くうえで不可欠であり、多様な意見を持つ市民との対話を通じて社会の分断を防ぎ、長期的なビジョンを共有することに繋がると信じるからです。
