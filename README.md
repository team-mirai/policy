...
### 【新規提案】AIと電子マネーによる税務改革で、公平でシンプルな行政へ
*   **目的:** 国管理の電子マネーとAI活用で税務を自動化し、国税庁職員の人件費や税務調査、確定申告にかかっていた膨大な時間・諸経費などの行政コストと、国民が納税手続きに費やしていた時間的・心理的負担を大幅に削減します。これにより生まれる人員や財源は、国民サービス向上のために再投資します。
*   **具体的な仕組み:**
    *   税務手続きについて、国が管理する電子マネーとAIを活用した新しい電子的な仕組みと、従来の現金と書面による手続きを選択できることとします。プライバシーへの配慮と、新しい仕組みを選択した場合の減税などのメリットを両立させ、なだらかな移行を促します。
    *   これまでの税務調査の専門知識を持つ職員を、デジタル化に不慣れな方々をサポートする相談員として再配置します。これにより、専門人材の雇用を維持しつつ、誰一人取り残さない丁寧なデジタル化を実現します。
