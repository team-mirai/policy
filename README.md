...
チームみらいの活動は、みなさまからのご支援に支えられています。寄付やボランティア、イベントなど、様々な形でのご参加をお待ちしております。詳細は公式サイトをご確認ください。

*   [寄付で応援する](https://team-mir.ai/)
*   [ボランティアとして参加する](https://team-mir.ai/)
*   [イベントに参加する](https://team-mir.ai/)
