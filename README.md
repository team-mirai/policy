...
### 現在検討中の改善案（ふじさんご提案）
#### 期日前投票における、なりすまし防止のための厳格な本人確認の導入
現在、期日前投票において口頭での本人確認のみで投票できてしまい、なりすましのリスクがあるというご指摘をいただきました。この課題に対し、以下の改善案を検討しています。
1.  **投票の際、写真付き身分証（マイナンバーカード、運転免許証など）の提示を原則とします。**
2.  **写真付き身分証をお持ちでない方に限り、投票所で顔写真を撮影し、本人の同意のもとでデータを記録します。**
3.  **撮影された顔写真データは、なりすまし等の不正調査を目的として厳格に管理し、選挙の異議申し立て期間が終了した後、速やかに消去します。**
この提案は、選挙の公正性を確保しつつ、プライバシーにも配慮し、すべての方が安心して投票できる環境を目指すものです。
