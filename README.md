...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * [７．医療](17_ステップ１医療.md)
    *   **診療情報の全国的な共有:** どの医療機関でも必要な時に患者の情報を参照できる「ユニバーサル電子カルテ」を導入します。これにより、遠隔の施設間でのコンサルテーションを円滑にし、医療機能のリモートでの統合・集約を進めます。
    *   **病床情報のリアルタイム共有:** 全国の空床情報を共有化し、スムーズな転院・搬送を実現するシステムを構築します。
  * [８．福祉](18_ステップ１福祉.md)
