...
キャッシュレス決済の普及を加速するため、決済手数料を政府負担により無料化します。これにより事業者のコストを削減し、現在普及の障壁となっている手数料負担の問題を解決します。手数料の無料化により、会計処理の迅速化や現金管理コストの低減といった効果が期待されます。財源は、こうしたキャッシュレス化がもたらす経済全体の生産性向上で確保します。また、QRコード規格を統一し、どの事業者の決済アプリからでも交通機関や店舗での支払いが可能になる環境を整備します。これにより健全な競争を促進し、一層のサービス向上と技術革新を目指します。
