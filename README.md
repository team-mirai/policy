...
　作業中の箇所もたくさんあるため、議論の結果、これらのマनिフェストの内容がまだ大きく変わる可能性がある点はご理解いただけますと幸いです。より多くの方々にこのマニフェストをご理解いただくため、特にデジタル技術に馴染みのない方々やご高齢の方々にも分かりやすい表現や伝え方を検討し、積極的に情報をお届けする工夫を重ねてまいります。
