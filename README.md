...
チームみらいは、表現の自由を最大限尊重します。これは健全な民主主義社会の土台であると考えるからです。

個人攻撃や差別的な発言は、建設的な議論を阻害するものであり、批判されるべきです。しかし、これらの言動を安易に「禁止」することには、慎重であるべきだと考えます。なぜなら、禁止の範囲を定めることは難しく、権力を持つ者による恣意的な運用のリスクが常に伴うからです。

私たちは、禁止という手段に頼るのではなく、悪意のある言動がもたらす害を最小限に抑え、建設的な議論を促進するための、より良い仕組みを探求します。例えば、攻撃的で悪評の多いユーザーの投稿の表示優先度を下げたり、通報システムにおいて特定集団からの集中的な通報の重みを調整したりするなど、技術的なアプローチも検討していきます。

私たちは、自由な議論の場を守り、育てていくために、皆さんと一緒に知恵を絞っていきたいと考えています。
