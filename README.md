...
例えば、このような熟議を通じて「ネット選挙」の導入に関するアイデアも議論されています。子育て中の方や出張が多い方々の投票参加を促すため、マイナンバーカードと二重認証を活用したシステムの導入が提案されています。これにより、投票率の向上や開票作業の効率化が期待される一方、サイバー攻撃への対策や、デジタルに不慣れな方への配慮、投票の公正性をどう担保するかといった課題についても、引き続き議論を深めています。
