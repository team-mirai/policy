...
**まず、これをやります！：後を絶たない詐欺被害から、AI技術であなたの暮らしと財産を守ります。私たちは、そのための新たな法案作りを最優先で実現します。**
...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。次の国政選挙では、私たちの政策を実現するために、20議席の獲得を目指します。また、宣伝カーを用いた街頭活動を積極的に行い、有権者の皆様との対話を重ねます。
