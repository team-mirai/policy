...
---
### **新たな品質認証制度（仮称：エンペラー・ワラント・マーク）の創設**

インバウンド需要の取り込みと国内産業のブランド価値向上、技術承継の促進のため、政府が認定する新たな品質認証制度を創設します。和菓子、食品、嗜好品、料理店、宿泊施設、工芸品、家電、日用品と、多岐にわたる分野を対象とします。本制度は、優れた製品・サービスの品質を保証するとともに、事業者の継続的な努力を可視化し、国内企業の活性化を目指します。

#### 認定基準と貢献度の評価
認定基準には、製品・サービスの品質や環境への配慮に加え、「就労環境の良さ」を重要な柱とします。これは、後継者不足に悩む優れた技術を持つ中小企業の事業承継を後押しする狙いもあります。就労環境の評価は、公的データや民間調査会社の情報を活用し、賃金、労働時間、休暇取得率などを客観的に判断する仕組みを構築します。集約した就労環境データは、求職者にも提供し、就職のミスマッチ解消を目指します。

さらに、社会貢献度も評価の対象とします。例えば、国内原材料の積極的な使用、障がい者雇用、被災地や公的機関への寄付などが評価項目に含まれます。

#### マークのデザインと等級制度
マークには、認定事業者の貢献度を示す等級（階級章のようなデザインを想定）と、登録開始年数を明記します。これにより、消費者は一目でその事業者の実績と信頼性を確認できます。
等級は、企業の継続的な品質向上や社会貢献活動に応じて昇格する仕組みとします。もし認定が取り消された場合、再認定時には最低等級から再スタートすることとし、品質保持への高い意識を促します。

#### 運営体制
認定された事業者は、「エンペラー・ワラント・マーク保持者協会」に加入します。協会は、登録料（分割または一括納付）を財源とし、マークの不正使用の取り締まり、品質管理活動、審査基準の維持・設定を行います。
