...
現行の所得税制度は、所得の変動に対する柔軟性が課題とされています。そこで、たしさんより「生涯所得課税」の導入についてご提案いただきました。これは、納税者の累積所得の平均に基づいて課税する制度です。具体的には、各年の課税額を、これまでの累積平均所得に累進税率を適用して算出し、前年度までの納税額を差し引くことで決定します。

この制度により、所得の変動による税負担の不公平を是正し、所得が減少した際には税の還付が行われるなど、税制に保険機能を持たせることが期待されます。これは社会保障の対象から漏れがちな現役世代の保障充実にも繋がると考えられます。

実施には、納税者の累積所得情報を正確に把握・管理する必要があり、現代のデジタル技術を活用することで、実務的な課題を克服できる可能性があります。これは、デジタル時代にふさわしい税制へのアップデートと言えるでしょう。

この提言は、所得の変動が激しい現代社会において、より公平で柔軟な税制を実現するものです。

（参考：[TKFD提言「令和の日本型累進的生涯所得税の構想」](https://www.tkfd.or.jp/research/detail.php?id=3703#_ftn1)）
