...
このマニフェストはバージョン1.0です。今後も頂いたご意見を踏まえてどんどんアップデート（改善）をしてゆきます。例えば、直近では匿名ユーザーから「雇用の安定を原則とし、真に柔軟な人員調整が必要な場合にのみ、例外的に非正規雇用を認める。その場合でも、同一労働同一賃金を徹底し、不合理な待遇差をなくす」という提案をいただいており、マニフェ使途への反映を検討しています。
