...
　チームみらいは、政策をより良いものにするため、オープンな議論を通じてみなさんと一緒にマニフェストを育てていきたいと考えています。私たちの政策づくりは、大きく分けて二つの段階で進みます。

　第一に、広くみなさんからご意見を募る「探索」の段階です。AI熟議システムの『いどばた』やオフラインの対話などを通じて、多様な視点や課題を集めます。「考えがまだまとまっていない」というご批判を恐れずに未熟なバージョンを公開するのは、この「探索」を何よりも大切にしているからです。

　第二に、集まったご意見を専門家と共に深く検討する「検証」の段階です。特に、再生医療や医薬品の規制など、高度な専門知識を要する分野については、この「検証」のプロセスを重視し、科学的知見や現場の声に基づき慎重に政策を練り上げます。

　ただし、これは単なる多数決ではありません。いただいたご意見や専門家の知見を踏まえつつも、最終的な意思決定は、責任主体であるチームみらいが行います。これは、責任を取れる「人」が判断することこそが重要であるという私たちの価値観に基づくものです。

　今後も議論の結果、マニフェストの内容が変更される可能性がある点をご理解いただけますと幸いです。
