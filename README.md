...
* **個人の医療・教育データへのアクセス権に関する原則**：デジタル母子パスポートのような個人の情報を扱うデジタルサービスを推進するにあたり、情報の主体である本人（子供）が、成⻑の過程および成人後に、自身の情報へ確実にアクセスできる権利を保障することを最優先します。親権者の意向や、利用するサービスの都合によって、本人のアクセス権が不当に妨げられることのないよう、国が責任をもってデータを管理・保全する仕組みを構築します。
