...
　このマニフェストは皆さんの声を拾いながら改善していくためのバージョン0.1（超初期版）であり、まだまだ議論中、作業中の箇所がたくさんあります。チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。例えば、行政の透明性を高めるため、ODAや海外企業への助成金の監査体制強化、改善計画の策定・公表の義務化、進捗報告に加え、改善が見られない場合の罰則規定導入といった具体的な提案も現在議論されており、今後のマニフェスト改定に反映させていくことを検討しています。
