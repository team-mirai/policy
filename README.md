...
また、匿名ユーザーさんから、確定申告の簡素化（利用者識別番号のデジタル管理の導入や、誰にでも分かりやすい申告システムの実現など）について具体的なご提案をいただきました。このようなご意見も参考に、『ステップ１行政改革』などの関連項目で検討を進めてまいります。さらに、匿名ユーザーさんからは、障害年金制度における審査基準の不透明さや、医師の診断書の書き方・審査員の裁量によるばらつきといった運用面の課題について、具体的なご指摘をいただきました。障害のある方が公平かつ安定して支援を受けられるよう、審査基準の明確化と透明性の向上を求める貴重なご意見として、関連する政策分野で検討を進めてまいります。
