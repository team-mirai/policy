...
### 【ご提案】個人の状況に合わせた「プッシュ型」行政サービスの実現（ももこさんより）

妊娠、子育て、障害の有無など、個人の状況で必要な情報は異なります。しかし現状では、情報が点在し、本当に必要としている人に届いていません。国が統一アプリを開発し、出産予定日などを登録するだけで、検診や手当といった最適な情報が自動で届き、申込も完結。引っ越しても設定変更だけで対応できます。この仕組みは障害者支援などにも応用し、誰も情報から取り残されない社会を目指します。
