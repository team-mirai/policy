...
　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマనిフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』などを活用したデジタル空間での議論と、全国で開催するオフラインミーティングなど顔の見える関係での対話を両立することで、世代や立場を超えて多様な知恵を集めていきたいと考えております。また、独自に行う専門家へのインタビューなどを通じても、知見を深めていきます。
