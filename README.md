...
* [ステップ２「変化に対応できる、しなやかな仕組みづくり」](20_ステップ２「変化に対応できるしなやかな仕組みづくり」.md)  
  ...
  * [２．くらしと行政](22_ステップ２くらしと行政.md)  
    * 在留カード連携DBによる、外国人雇用の公正化
  * [３．産業](23_ステップ２産業.md)  
    * デジタルIDによる観光DXと免税不正利用の防止
  * [４．医療](24_ステップ２医療.md)  
...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。私たちは、あらゆる分断に反対します。テクノロジーで誰も取り残さない日本を掲げ、その力で、誰もが孤独を感じずに支え合える温かい社会を創ります。分断に疲れた人々の、希望の受け皿となること。それがチームみらいの約束です。
