...
現在も、ひろみさんとの対話は、子育て支援から社会全体の健康問題、職場のコミュニケーションへと発展しました。さらに、これらの課題に対し、膨大なデータを個人の生活や企業活動にどう活かすか、そして、うまく機能しない仕組みを常に見直し改善していくフィードバックのサイクルの重要性についても議論を広げています。SNSのいいね機能のように関心のある人が自発的に記録する仕組みや、無作為に意見を求める『裁判員制度のメール版』のような画期的なアイデアについて検討を深めています。
