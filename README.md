...
## 現在検討中の新しい政策案（まろさんからのご提案）

現在、まろさんより、子育て世代の就労と育児の両立を支援するための、以下のような新しい政策案が提案されています。

*   未就学児を育て、時短勤務を行っている家庭には給与の９割を補償する。
*   小学校３年生までの児童についても時短勤務制度を創設し、給与の８割を補償する。

この提案について、みなさんのご意見を募集しています。
