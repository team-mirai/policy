...
デジタル化から誰も取り残さないため、高齢者などを対象に、スマートフォンやPCの基本的な操作を対面で手伝う有償の「デジタル支援員」を設けます。

*   **目的:** デジタル機器が苦手な方への一時的な支援（過渡期の制度）
*   **場所:** 市役所、公民館、病院などで気軽に申請
*   **費用:** 月4回まで無料（超過分は利用者負担）
*   **担い手:** 若者も参加しやすい短時間の仕事とし、世代間の交流も促します。
...
## 【追加提案】対人支援サービスの拡充：ケースワーカーの増員

デジタル化で生まれる余力を、本当に人の手が必要な場所へ。私たちは、児童相談所や生活保護のケースワーカーといった、対人支援の最前線に人的資源を重点的に再配分します。

*   **目的:** デジタル化による業務効率化の恩恵を、専門的な対人支援（ヒューマンサービス）の質の向上に繋げます。これは、制度の利用者だけでなく、社会全体に「困ったときには助けがある」という安心感をもたらし、すべての人のくらしの質を高めるものです。
*   **具体的な目標:** ケースワーカーが担当する世帯数を、現在の「1人あたり80世帯」から「**1人あたり50世帯**」へと削減します。これにより、一人ひとりに寄り添った質の高い支援を実現し、担当者との相性を考慮した柔軟な対応も可能な体制を構築します。
