...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * [３．行政改革](13_ステップ１行政改革.md)  
    * 国民一人ひとりが行政サービスをより便利に活用できるよう、以下のデジタル化を推進します。
      * **年金等の重要な行政通知について、希望者はアプリや専用ウェブサイトで受け取れるようにします。これにより、郵送による書類の紛失リスクを減らし、必要な情報をいつでも確認できるようにします。また、不要な電話連絡を減らし、国民の時間を尊重します。**
  * [４．産業](14_ステップ１産業.md)  
