...
### 検討中の政策提案
現在、みなさまから頂いたご意見を元に、以下の政策について検討を進めています。

*   **ストーカー等加害者への治療的アプローチの確立（匿名ユーザーからのご提案）:**
    ストーカー行為は、加害者自身もコントロールできずに苦しむ脳の神経系症状であるとの知見に基づき、加害者自身が穏やかな日常を取り戻すことを主眼とした治療的アプローチを確立します。これは被害者を守るための最も本質的な対策にも繋がります。
    具体的には、逮捕後の加害者に専門治療を法で義務付け、社会復帰後も治療経過を管理する仕組みを導入します。このアプローチは性犯罪等にも応用が期待されます。専門家の協力を得て、実効性のある法整備と体制づくりを急ぎます。
