...
　このマニフェストは皆さんの声を拾いながら改善していくためのバージョン0.1（超初期版）であり、まだまだ議論中、作業中の箇所がたくさんあります。チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。例えば、教育分野においては、AI家庭教師の導入により、生徒が自分のペースやタイミングで学習できる選択肢を増やし、ゲーム性を取り入れた反復練習の導入や、CBT形式による柔軟な単位認定試験（いつでも何度でも受験可能とし、絶対評価による認定を行い、相対評価に依らない仕組みを目指す。例えば、全日制高校によっては授業が開講されず単位取得自体ができない高等数学について、学校の枠組みとは独立した外部機関によるCBT試験を導入し、民間資格のように本人が好きなタイミングで何度でも受験でき、分野別の習得能力を証明する合格証明書（基礎力・理解度・到達度を示す）を発行することで、大学入試以外でも特定分野および特定科目の学力を証明できる（特に数学IA・IIB・IIICのCBT試験の設置により、高校の授業成績や大学入試の結果とは独立して、個人がいつでも受験して自分の能力を証明できるというメリットは分かりやすい）仕組みも検討する）の導入を通じて、個別最適化された学びを支援するといったご意見も頂いており、検討を進めています。
