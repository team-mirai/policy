...
### 【髙野晃輔様からのご提案】コンテンツ庁（仮）の創設によるIP保護と経済成長
> コンテンツ庁を作ってそこから経済成長を目指したら、今話しているような減税か給付かではなく、経済成長による税収増加で根本的かつ持続的な国民の生活の満足度向上に繋がるのではないか？
>
> アニメやゲーム、音楽などのIP産業の保護、特に海外で無料で使われてしまっている日本のコンテンツに対して特許のような形で価値を担保し、海外の企業がサービスで用いたい場合に課税する仕組みを取りまとめる
>
> 著作権とは異なり、日本の価値のあるコンテンツであることを国として証明する資格のようなもの。
>
> 課税については、ライセンス料のイメージ
>
> クリエイターの契約利益に対して、何%か課税するイメージ。価値の基準は世界遺産のようなイメージで統一の基準を作りそこに見合うかどうか。メリットは海外で無料で使われてしまっているコンテンツを保護し、利益が著作権を所有している本人に渡るようになる。また、政府の保護を受けることで自分で自走できるようになるまでの支援を受けやすくなる。お墨付きをもらうことで世間からも評価されやすくなる。
