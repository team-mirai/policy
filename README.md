...
### 追記提案：スパイ防止法に関する提案（江場仁彦）

スパイ防止法を創設し、国民の生命と財産を守ることを目指します。プライバシーへの配慮を大前提とし、目的と対象を限定した上で、人権に配慮した捜査手続きを定めます。

*   **目的を限定**
    *   国防、産業・経済安全保障、学術研究、皇族や政治家など要人の生命保全に目的を絞ります。

*   **対象を限定**
    *   規制対象は、外国のエージェント（国籍不問）および内乱を企図・準備する日本国民に限定します。

*   **プライバシー・人権保護の徹底**
    *   **公正な捜査:** 取り調べは動画録画を義務付け、拷問等を防ぎ、長期拘束を禁止します。通訳を手配し、容疑者の翻訳権を保障します。
    *   **情報管理の厳格化:** 捜査情報の無断複写・印刷や外部持ち出しを禁じ、情報流出を防ぎます。
    *   **無実の場合の措置:** 裁判で無実が証明された場合、謝罪するとともに、収集した個人情報を完全に削除・破棄する措置を講じます。

*   **段階的な導入**
    *   まずは上記に絞った形で法案成立を目指し、実運用上の課題を検証しながら、必要に応じて段階的に内容を検討・拡大します。
