...
## 選挙運動のあり方の見直し：静かで公正な選挙のために

現在の選挙で見られる個別のポスター、ビラ、名前を連呼する街宣活動は、市街地の景観や静かな生活環境を損なっています。そこで、選挙公報や自治体の広報活動を中心とした情報提供に転換し、選挙費用を削減し、すべての候補者に公平な活動機会を確保するとともに、政策本位の静かな選挙を実現します。
※これは、政策を訴えるための集会や対話の機会そのものを制限するものではありません。
