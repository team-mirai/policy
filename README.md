...
　例えば、ある有権者の方からは、「本当に投票したい候補者はいるが、当選の見込みが薄いため、当選しそうな他の候補者へ投票する」といった行動が、真の民意を反映しづらくしているという課題のご指摘がありました。この対策として、複数の候補者に順位をつけて投票できる「優先順位付き投票制度」の導入が提案されています。チームみらいでは、このような建設的なご意見を歓迎し、みなさんと一緒に議論を深めたいと考えています。
