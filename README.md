...
## shuさんからの新しい提案: 国会対応のDXとルール形成による行政効率化
国会議員の質問対応等で生じる行政の過度な負担を軽減するため、政府情報をセキュアな形でデータベース化し、与野党議員が迅速にアクセスできるシステムを構築します。また、各党からの問い合わせを効率化するルールを設け、行政官が本来の政策業務に集中できる環境を整備します。
(この内容は、今後「ステップ２ くらしと行政」に正式に反映される予定です。)
