...
## 博士課程大学院生への支援を抜本的に拡充し、多様なキャリアと研究環境を整備

日本の国際競争力と持続的成長の基盤となる人材を育成するため、博士課程大学院生への経済的支援の拡充と、安心して研究に打ち込める環境の整備を同時に進めます。

*   **経済的支援の抜本的拡充:** 現在、約14%の採択率に留まっている日本学術振興会特別研究員（DC）等の支援制度について、対象人数を大幅に拡大します（例：採択率35%への引き上げ）。また、選考結果に応じて段階的な経済支援（例：上位35〜50%の申請者へ半額程度の支援）を導入するなど、より多くの学生が経済的な不安なく研究に専念できる環境を整備します。
*   **博士号取得プロセスの柔軟化と公正性の確保:**
    *   **課題:** 現在、多くの大学で外部ジャーナルへの論文掲載が博士号取得の要件となり、学生のキャリア形成（早期の修了）と、研究室の方針（大きな成果をまとめて発表）が対立する問題が生じています。
    *   **改革案:** 学外の専門家を含む公平な審査委員会（例：日本学術振興会の審査に近い形式）を設け、その審査をもって博士号を授与できるルールを確立します。
    *   **効果:** これにより、学生は論文公刊のタイミングに左右されずに学位を取得でき、安心してキャリアを歩めます。一方、研究室は長期的な視点で研究に専念でき、結果的にインパクトの大きな論文の創出につながり、日本の研究力向上に貢献します。
