...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マนิフェストの政策を推進しています。
...
*   **ITエンジニアの待遇改善**
    *   ステップ１「産業」分野に、以下の趣旨の政策を追加します。
    *   「デジタル社会を支えるITエンジニアの専門性を正当に評価し、その貢献に見合った報酬を確保するための環境整備を進めます。」
