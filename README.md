...
　チームみらいのメンバーの皆様へ。「考えがまだまとまっていない」「どうせ負ける」。そんな批判は覚悟の上です。私たちの目標は、チームの士気を上げること。そして、多くの人に『愛される』政策を皆さんと一緒に創ることです。この未熟なマニフェストは、そのための魂の狼煙（のろし）です。さあ、ここから一緒に、本気でやってやろうじゃないか。
