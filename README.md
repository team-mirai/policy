...
　例えば、精神障害をお持ちの方々の障害年金について、『対象者を拡大し、支給額を増額することで、生活保護への移行を防ぎ、ご本人の生活の質向上と社会保障リソースの効率化を両立させるべきだ』と、当事者の視点からご意見をいただきました。さらに、就労収入に応じて支給額を柔軟に調整する制度の導入もご提案いただいています。チームみらいは、こうした建設的なご意見を真摯に受け止め、より良い政策へと結実させていきます。
