...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。チームみらいは、都市部だけでなく、地方や過疎地域が抱える課題にも真剣に向き合い、徹底的な現場主義で政策を考えます。そのはじめとして、国政政党成立後100日以内に、チームのメンバーが直接、様々な地域に赴き、住民対話を実施することを約束します。
