...
* [ステップ２「変化に対応できる、しなやかな仕組みづくり」](20_ステップ２「変化に対応できるしなやかな仕組みづくり」.md)  
  ...
  * [３．医療](23_ステップ２医療.md)
    * **提案（たかさんより）**: 持続可能な医療と就労意欲向上のため、医療費自己負担のあり方を見直します。難病や先天性疾患等やむを得ない場合を除き、現在無料のケースも生活状況に配慮しつつ少額の自己負担導入を検討します。これにより不適切な医療利用を抑制し、就労意欲の阻害要因を減らし、公平性の確保と制度の持続可能性向上を目指します。
