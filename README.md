...
　この考えに対し、ある方から「AI任せ、他人任せの政治はうまくいかない」「どんなに立派なマニフェストも、実行されなければ意味がない」という、魂のこもったご指摘をいただきました。「DXはあくまで手段であり、目的ではない。DXに囚われず、人々の暮らしを豊かにするために本当にやるべきことがあるのではないか」という言葉は、私たちの核心を突くものです。このマニフェストに書かれた言葉が、絵に描いた餅で終わらぬよう、チームみらいは「実行する覚悟」を何よりも重んじ、その行動によってのみ、皆様の信頼を得られると信じています。
