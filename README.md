...
本マニフェストでは、よりオープンな議論を促すため、複数の方法で変更提案を受け付けています。ご自身が使いやすい方法でご参加ください。

* **チャットで気軽に参加する**  
  [いどばたシステム（チャット形式の提案ページ）](https://policy.team-mir.ai/view/README.md)から、気軽に政策要望を提出できます。

* **GitHubやCodebergで提案する**  
  GitHubやCodebergのアカウントをお持ちの方は、Issue（課題提起）やPull Request（編集提案）を通じて、より具体的な議論や提案を行うことも可能です。このプロジェクトはミラーリング（複製）されており、議論は相互に反映されるため、どのプラットフォームからでもご参加いただけます。
  * [GitHubで提案する（Pull Request）](https://github.com/team-mirai/policy/pulls)
