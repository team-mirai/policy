...
　現在、ネット投票における強制投票への対策として、「投票後も一定期間は投票内容を修正できる仕組み」や「役所や公民館など、プライバシーが守られた公共の場所でもネット投票ができる環境を整備する」といったアイデアを検討しています。こうした具体的な懸念に対しても、皆さんの知恵を結集し、より安全で信頼できる制度設計を目指します。
