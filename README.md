...
　頂いた変更提案は、チームみらいが責任をもって確認します。変更提案をマニフェストに反映させるかどうかについては、チームみらいが権限を持ちます。当初マニフェストとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。GitHubを通じてご提案いただいた内容は、通常、GitHub上でご確認いただけます。もし見当たらない場合は、お手数ですが再度ご確認をお願いいたします。「いどばたシステム」でご提案された場合は、システムにログイン後、ご自身の活動記録や投稿履歴を表示するメニュー（例：マイページ、アクティビティログなど）からご確認いただけると考えられます。具体的な確認方法は、「いどばたシステム」のヘルプや案内をご確認ください。
