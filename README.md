...
離婚やパートナーシップの解消は、誰にでも起こりうる人生の転機です。しかし、その後の生活再建、とりわけ経済的な自立が困難となるケースが少なくありません。特に、育児や介護、あるいはパートナーの転勤などにより長期間キャリアを中断された方々が、離婚後に貧困のリスクに直面する現状は深刻な社会問題です。これは個人の努力だけで解決できる問題ではなく、社会全体でセーフティネットを構築し、再出発を支援する仕組みが必要です。チームみらいは、キャリア再構築支援、住まいの確保、法制度を含めた包括的な支援策の検討を、重要な政策課題として認識し、議論を深めていきます。これにより、誰もが安心して人生の再設計ができる社会を目指します。
