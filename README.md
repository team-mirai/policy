...
**現状の課題:**
現在のマニフェストでは、AIメンタルアシスタントについての言及はあるものの、学校現場で重要な役割を担うスクールカウンセラーについての記述が不足しています。

**改善提案:**
既存の教育政策（特にステップ１「デジタル時代の当たり前をやりきる」）に、以下の点を追記・明確化することを提案します。

1.  **スクールカウンセラーの役割の明記:**
    いじめや不登校などの問題発生時の対応と予防、子どもや保護者へのカウンセリング、教職員との連携（コンサルテーション）といった、スクールカウンセラーが既に果たしている重要な役割をマニフェストに記載します。
2.  **AIと人間の連携:**
    AIメンタルアシスタントは、24時間対応可能である点やビッグデータを活用した予測に強みがあります。このAIアシスタントを、スクールカウンセラーと連携・補完する存在として位置づけ、AIが検知した緊急性の高い事案の通報先や、専門的な対応の担い手としてスクールカウンセラーの重要性を強調します。

これにより、テクノロジーと専門家の知見を組み合わせた、より多角的で実効性のあるメンタルヘルスサポート体制の構築を目指します。