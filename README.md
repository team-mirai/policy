...
また、私たちは、医療や介護などの社会保障は、単なるコストではなく、すべての世代の生活を支えるセーフティネットであるべきだと考えます。誰もが安心して必要な医療や介護を受けられる社会を目指し、持続可能な制度の維持・強化に努めます。
...
* **デジタル化の推進における留意点**：私たちはデジタル化を強力に推進しますが、それが常に最善の解決策だとは限りません。お薬手帳や母子手帳のように、物理的な形が重要な場合もあります。デジタル化を進める際は、実際にそれを利用する医療機関のような現場の専門家や関係者と対話し、合意形成に努めることを原則とします。その具体的なプロセスは、それぞれのテーマに応じて、最も関係の深い方々の意見を伺いながら丁寧に設計します。
