...
私たちは、政党助成金の使途を抜本的に見直し、その一部でエンジニアチームを組織します。このチームは、国会審議や予算執行を可視化するシステムに加え、AIを活用して膨大な議事録や法規を分析し、政策立案を支援するシステム等を開発・提供します。これは政権獲得の有無に関わらずオープンソースで開発し、誰でも開発に参加し恩恵を受けられるようにします。
