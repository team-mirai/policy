...
個人の尊厳を守り、家族の多様なあり方を支えるため、選択的夫婦別姓制度を導入します。これにより、結婚後も各自が望む姓を名乗ることを可能にし、改姓に伴う不利益やアイデンティティの問題を解消します。また、IT技術を活用し、別姓を選択した家族が行政サービス等で不利益を被ることのないよう、社会システムを整備します。
