...
* [AIを活用した予防医療で健康寿命を延ばす](51_AIを活用した予防医療.md)
...
## AIを活用した予防医療で健康寿命を延ばす

健康診断時の保健指導にAIを導入します。個人の健診結果に基づき、現在の生活習慣を続けた場合の将来の健康状態を具体的にシミュレーションして提示することで、一人ひとりが主体的に生活習慣の改善に取り組むことを強力に後押しし、健康寿命の延伸を目指します。
