...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。また私たちは、多様な家族のあり方を尊重し、同性婚の法制化や選択的夫婦別姓制度の導入を積極的に進めます。選択的夫婦別姓の導入に伴う、家族関係の証明などの実務的な課題は、テクノロジーを活用して解決していきます。
