...
チームみらいは公党として、マニフェストの改善プロセスにおいて、以下の原則を遵守することを約束します。

*   **公平性と受付順の原則:** すべての提案は、公平に扱われることを保証します。検討は、原則として提案の受付順に行います。
*   **透明性と理由の公開:** 受付順と異なる順序で検討を行う場合（緊急性の高いものなど）は、その理由を明記し、誰もが確認できるよう公開します。
*   **選挙期間中の凍結:** 公職選挙法の趣旨と有権者への責任に鑑み、選挙の公示日から投票日までの期間、マニフェ-ストの変更・更新は原則として行いません。
