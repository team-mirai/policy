...
ようこそ！　ここはチームみらいの公約（マニフェスト）を、みんなから広く意見を募り、オープンに改善していくためのページ（オープンソースレポジトリ）です。ここでは、だれでも自由にアイデアを出したり、修正の提案をすることができます。

マニフェストは[こちら](https://policy.team-mir.ai/view/README.md)のページから見ることをおすすめします。いどばたという対話システムを活用しており、あなたの疑問にお答えしたり、変更提案の作成をお手伝いしたりすることができます。
