...
* 対話AI（チャットボット）ご利用時の注意点： このAIは、現在開いているファイルの内容しか理解できず、またチャット内容に関してはファイルごとの１セッション内の対話しか参照できません。そのため不正確な回答をしたり、参照できない内容を不完全に生成してしまう場合があります。また、仕様上不可能なことを「できる」と応答してしまう場合があります。AIとの対話はあくまでたたき台とし、最終的な提案内容はご自身でご確認をお願いします。
