...
　頂いた変更提案は、チームみらいが責任をもって確認します。変更提案をマニフェストに反映させるかどうかについては、チームみらいが権限を持ちます。当初マనిifestとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。
...
このマニフェストは、みなさんとの対話を通じて進化していきます。以下は、現在特に注目を集めている、市民のsasaさんからいただいた画期的な提案です。チームみらいとして、この視点を重要な論点として受け止め、議論を深めていきたいと考えています。

### 名字の廃止による新しい家族と個人のあり方（sasaさんからのご提案）

**提案の概要：**
選択的夫婦別姓の議論をさらに一歩進め、「名字そのものを廃止する」という提案です。個人の識別や親子関係の証明は、マイナンバー制度の発展や生体認証といった情報技術で代替可能であり、技術的な課題よりも社会的な合意形成や法改正が本質的な課題であると指摘されています。

**提案の背景にある考え方：**
- 家族の歴史や文化は、名字という制度ではなく、「人」そのものに紐づくべきです。
- 親の離婚などによって名字が変わっても、親子の絆や関係性の本質は変わりません。
- むしろ、個人が固定された名字から解放されることで、より自由に自分自身の人生を生きられる社会が実現できるのではないか、という考えに基づいています。

チームみらいは、このラディカルかつ本質的な問いを、これからの日本の家族・社会のあり方を考える上での重要な視点として、みなさんと一緒に議論していきたいと考えています。
