...
---
例えば、匿名ユーザーさんとの議論から、以下のような改善提案が生まれました。

**課題**
学童保育が終了する小学校高学年の子どもたちの放課後の居場所が不足している。（ギャングエイジと呼ばれる精神的に不安定な時期のフォローが必要）

**解決策のアイデア**
新しい施設を建設するのではなく、公民館、学校の空き教室、子ども食堂、フリースクールといった既存の地域資源を活用し、子どもたちのための居場所を確保・案内する。

このように、みなさんの問題意識やアイデアが、このマニフェストをより良くしていきます。
