...
* [ステップ２「変化に対応できる、しなやかな仕組みづくり」](20_ステップ２「変化に対応できるしなやかな仕組みづくり」.md)  
  ...
  * [５．福祉](25_ステップ２福祉.md)
  * [６．家族法制の見直し](#家族法制の見直し（匿名ユーザーからの提案）)
...
## 家族法制の見直し（匿名ユーザーからの提案）

### 課題：不貞行為に対する慰謝料制度の機能不全
現状の不貞行為に対する慰謝料は、その抑止力として十分に機能していない。「慰謝料を払えば良い」という風潮が、不貞行為を助長し、多くの家族を苦しめているという実情があります。

### 提案：慰謝料の最低保証額と収入に応じた追加請求権の導入
この問題を解決するため、慰謝料制度を以下のように見直すことを提案します。
1.  **最低保証額の設定：** 不貞行為が認定された場合に請求できる慰謝料に、法的な最低保証額（例：500万円）を設けます。これにより、相手の経済状況によらず、被害者は最低限の救済を確保できます。
2.  **収入等に応じた追加請求権の明確化：** 最低保証額に加え、不貞行為を行った側の年収や資産に応じて、追加で慰謝料を請求できる権利を法律で明確にします。これにより、高所得者に対する抑止力を高め、制度の公平性を図ります。

この変更を通じて、婚姻の尊重と家族の保護を強化することを目指します。
