...
### 誰にも知られずにアクセスできるセーフティネットの構築

親や周囲に知られずに、子どもや若者がオンラインでアクセスできる、精神的ケアを含む複合的なセーフティネットを構築します。学校のPCや公共の端末など、プライバシーが守られる環境からアクセスできる窓口を設け、精神的ケア、法的支援、一時避難場所の案内など、個々の状況に応じた多角的な支援を提供します。これにより、家庭環境などに困難を抱える人々が、社会から孤立することなく、自立に向けた支援を受けられる体制を全国的に整備します。