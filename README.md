...
皆様から頂く貴重なご意見を政策に反映させていきます。例えば、子育ての不安を解消するため、関連情報をアプリで集約したり、柔軟な働き方を導入するなど、「子育てが豊かさにつながる社会」を目指す、といったご提案を頂いています。
...
t頂いた変更提案は、チームみらいが責任をもって確認します。変更提案をマニフェESTに反映させるかどうかについては、チームみらいが権限を持ちます。当初マニフェストとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。
