...
　直近では、あびる様より、AIやデジタル技術を活用した医療の効率化（オンライン診療の推進、スマート受付・キャッシュレス化など）を進め、それによって生まれる財源（年間数千億円規模との試算も頂いています）を将来的な社会保険料の負担軽減に繋げるべき、という重要なご提案を頂きました。このようなご意見も真摯に受け止め、政策をさらに具体化してまいります。
