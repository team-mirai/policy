...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。私たちの「デジタル時代の当たり前をやりきる」という政策は、テクノロジーを無理に押し付けるものではありません。むしろ、すでに始まっているAI時代という不可避な変化の波から誰も取り残されることのないよう、社会全体の「備え」を万全にすることを目指しています。
