...
チームみらいは、掲げた政策を実現するために、最も効果的な方法を追求します。将来的には、与党として政策を主導することを目指しますが、そこに至る過程では、政策ごとに他の政党と協力することや、連立政権に参加することも柔軟に検討します。私たちの目標は、党の形にこだわることではなく、マニフェストに掲げた政策を実現し、社会をより良くしていくことです。
