...
過去にもテクノロジーを活用した政策提言は存在しましたが、近年のAI技術の急速な進化や、シビックテック活動を通じた社会全体の理解の深まりといった背景が、当時とは異なる大きな推進力となっています。チームみらいは、これらの変化を捉え、具体的な技術的知見とオープンな議論を組み合わせることで、過去には実現が難しかった課題解決を目指します。
