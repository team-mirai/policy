...
本マニフェストへの変更提案は、主に２つの方法があります。

*   **AIアシスタントと相談しながら提案する（推奨）**
    [こちら](https://policy.team-mir.ai/view/README.md)のページで、AIアシスタントとチャットしながら提案を練ることができます。ここでの変更はまずあなた専用の「下書き」に保存され、公開マニフェストがすぐに変わることはありません。じっくり議論を重ねた後、納得のいく形でチームみらいに「提案書」として提出できます。

*   **直接提案を提出する（技術者向け）**
    [GitHub](https://github.com/team-mirai/policy/pulls)で直接提案（Pull Request）を提出することも可能です。

どちらの方法で頂いた提案も、チームみらいが責任をもって確認し、反映するかを検討します。
