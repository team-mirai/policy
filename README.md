...
チームみらいは、判断力・共感力・創造性の源泉として、まず心身を整えることを重視します。整った状態でこそ、本質的な政策が生まれると信じており、この考え方をチームの基本理念とします。

この理念を実践する仕組みとして、市民が政治家の健康を支え、その余剰が福祉へ循環する「整う循環モデル」のような、新しい参加と連帯のかたちを模索します。
