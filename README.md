...
* [その他重要分野についての政策・ビジョン](50_国政のその他重要分野.md)
  * [富裕税（仮称：ふるさと納税型寄付制度）](#富裕税仮称ふるさと納税型寄付制度)
...
## 富裕税（仮称：ふるさと納税型寄付制度）
高所得層や多くの資産を持つ個人に対し、1口何万円と言う枠を資産や所得に応じて割り当て、自身の希望する行政のプロジェクトにふるさと納税の様なイメージで納税できる形を検討します。返礼については、現在クラウドファンディングやふるさと納税で行われている「モノ」による返礼ではなく、寄贈式典への招待や施設への命名権、事業の視察説明を受ける権利といった、資産形成に繋がらない形での返礼を基本とします。
