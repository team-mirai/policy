...
直近では、匿名ユーザーより以下の経済財政に関するご提案をいただき、チーム内で検討を進めています。
*   消費税については、国民負担軽減の観点から、そのあり方を抜本的に見直し、将来的には廃止も視野に入れた段階的な引き下げと、代替財源の確保策をセットで検討します。
*   代替財源の一つとして、政府保有金融資産の運用益を非課税財源として活用する財政構造改革を検討します。
*   また、新たな財源確保策として、外国人観光客等を対象とした新たな付加価値税（仮称）の導入を検討し、その税収を消費税収の補填や国内の社会基盤整備に充当することを検討します。
