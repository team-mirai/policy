...
　現在、市民が政治家や政策を評価するのを助ける「信頼スコア」の導入について、皆様から頂いたご意見をもとに議論を進めています。例えば、記者会見など公の場での政治家の発言が、言い訳に終始したり、質問から逃げたりしていないかといった「発言の誠実さ」や、公約が実行されているかを追跡して「やるやる詐欺」を許さない仕組みなどを目指します。これは、情報の透明性を高め、市民と政治の距離を縮めるための重要な試みです。
