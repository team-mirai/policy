...
（注）GitHub上でPull Requestを提出すると、ご自身のGitHubアカウント名が公開されます。本名での登録をされている方で、名前の公開を希望されない場合は、事前にニックネームなどに変更いただくことを推奨します。

　頂いた変更提案は、チームみらいが責任をもって確認します。変更提案をマニフェストに反映させるかどうかについては、チームみらいが権限を持ちます。当初マニフェストとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。

## 注意事項

* **GitHubアカウント名の公開について**：本プロジェクトでは、変更提案を頂いた方の貢献を記録するために、GitHubアカウント名を表示しています。Pull Requestを提出する際には、ご自身のGitHubアカウント名が公開されることにご留意ください。本名での公開を望まない方は、事前にアカウント名をニックネームなどに変更してください。
