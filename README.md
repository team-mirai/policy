...
　なお今後も議論の結果、これらのマニフェストの内容がまだ変わる可能性がある点はご理解いただけますと幸いです。また、政策の透明性を確保する一環として、行政システム等を開発する際には、その仕組みを専門家でない方にも分かりやすく解説した『説明書』を公開します。これにより、デジタルに馴染みのない方々に行政サービスへの安心感を持っていただくとともに、この『説明書』を学校教育におけるプログラミング等の教材としても活用し、子どもたちが実社会のシステムに触れる機会を創出します。
