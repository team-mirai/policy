...
私たちは、有権者が候補者を多角的に理解し、より適切な判断を下せるよう、情報開示のあり方を追求します。その一つとして、学歴や経歴に加え、候補者の現在の知識や能力を客観的に示すため、第三者機関が実施する試験の結果を開示することを提案します。これは足切りを目的とするものではなく、あくまで有権者の方々への判断材料を増やすためのものです。
