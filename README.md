...
　頂いた変更提案は、チームみらいが責任をもって確認します。変更提案をマニフェストに反映させるかどうかについては、チームみらいが権限を持ちます。当初マニフェストとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。例えば、皆さんとの対話の中から「消費税率の柔軟な変更を可能にするレジシステムの標準化」といった具体的な政策アイデアも生まれています。
