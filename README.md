...
## ままさんからの新しいご提案
### タイトル：オンライン上の子どもたちの安全を守るための対策強化
*   ネット掲示板等の運営者に、子どもの安全を脅かす投稿の監視と削除を義務付けます。
*   犯罪行為に関する投稿は、警察へ通報することも義務化します。
*   義務を怠った運営者には、罰則を科します。
### タイトル：性犯罪の厳罰化と被害者の実態に即した司法制度の実現
*   子どもへの性加害を始めとする性犯罪に対し、刑罰を大幅に引き上げます。
*   裁判において、身体的な怪我の有無だけでなく、被害者が受けた精神的苦痛が量刑に適切に反映されるよう、司法の判断基準を見直します。
*   被害者が恐怖で抵抗できない状況や、自己防衛の準備が、不利に解釈されることのないよう、法律の運用を改めます。
### タイトル：パパクォーター制度の導入による、父親の育児参加の促進
*   育児休業の一部を父親専用に割り当てる「パパクォーター制度」を導入します。
*   この父親専用の期間は、母親に譲ることができない仕組みとします。
*   これにより、父親が育児に参加しやすい環境を企業と社会全体で作り出し、育児の負担が母親やその職場に偏る現状を是正します。
### タイトル：各種支援における所得制限の原則撤廃
*   子育て支援や各種手当に設けられている所得制限を、原則として撤廃します。
*   公平な負担は、所得制限ではなく累進課税が担うべきであり、現状は働く意欲や次の子どもを望む気持ちを削ぐ「二重の負担」となっている問題を解消します。
*   全ての人が意欲を持って働き、安心して子どもを育てられる社会を目指します。
### タイトル：保育園の完全無償化の実現
*   すべての子どもが質の高い幼児教育・保育を受けられるよう、保育園の利用料を完全に無償化します。
*   子育て世帯の経済的負担を抜本的に軽減し、親の就労形態にかかわらず、すべての子どもに等しい育ちの機会を保障します。

### タイトル：成長期の子どもたちの実態に合わせた学校給食の改善
*   画一的なカロリーや塩分基準にとらわれず、成長期の子どもたちの心身の発達に本当に必要な量・品数が確保されるよう、学校給食の基準を見直します。
*   子どもたちが食の楽しさを感じ、心身ともに健やかに成長できる、豊かで満足感のある給食を目指します。
