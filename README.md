...
　さらに、私たちはマニフェストの信頼性を高めるため、「目標の数値化」と「第三者評価」を原則とします。目標は可能な限り具体的な数値で示し、その達成度は私たち自身だけでなく独立した第三者の視点からも評価を受け、結果を公表します。これは、客観的な評価が難しいとされる政治の世界に、一般社会の当たり前を取り入れ、真の説明責任を果たすための挑戦です。
