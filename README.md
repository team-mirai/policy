...
すべての政策は、その効果を定期的にデータに基づいて検証し、必要に応じて見直すことを原則とします。これにより、税金の無駄遣いをなくし、常に国民にとって最善の政策となるよう継続的な改善を行います。さらに、政策の目標や進捗状況の「見える化」を徹底するとともに、目標達成に向けて国民一人ひとりができる具体的な行動を提示し、共に行動することを呼びかけます。
