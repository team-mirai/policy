...
### 【議論中の提案】投票に行かない方への新しい仕組み（提案者：非合理さん）

投票率の向上と、選挙に行かない方の意見も政治に活かすことを目指し、新しい制度を検討しています。

*   **概要:** 選挙に行かなかった方にアンケートハガキを送り、意見を書いてもらう。原則として、指定された期間内に実際の選挙会場の場所へ直接提出してもらいます。病気や障がいといった特別な事情がある方は、郵送や代理人による提出も可能です。これにより、投票所の場所を覚えるきっかけにもなります。
*   **皆で考えたい論点:** ハガキの提出を促す、より良い方法を募集します。一つの案として「提出しないと次回の投票用紙が自動で郵送されない」等の案がありますが、罰則ではなく、あくまで政治参加を促す前向きな仕組みにしたいと考えています。ぜひご意見をお聞かせください。
