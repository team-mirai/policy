...
### 教育分野におけるメンタルヘルスサポートの充実

**提案者:** 匿名ユーザー

**議論の概要:**
AIメンタルアシスタントの記述に加え、スクールカウンセラーの重要性をマニフェストに追記することを提案。具体的には、スクールカウンセラーが既に果たしている役割（いじめ・不登校対応、カウンセリング、教職員との連携）を明記し、AIアシスタントとスクールカウンセラーが連携する体制を構築することで、テクノロジーと専門家の知見を組み合わせた、より多角的で実効性のあるメンタルヘルスサポート体制を目指す。

**具体的な追記案（「11_ステップ１教育.md」への追記を想定）:**

**スクールカウンセラーとの連携による、きめ細やかなメンタルヘルス支援**

子どもたちの心の健康を守るためには、AIの活用と人の専門家の両輪が不可欠です。24時間対応可能なAIメンタルアシスタントと並行し、スクールカウンセラーの配置を拡充・役割を強化します。

*   **多様な役割：** いじめや不登校への対応と予防、子どもと保護者のカウンセリング、教職員との連携を通じて、個々の状況に合わせた学校生活を支援します。
*   **AIと人の連携：** AIが捉えた緊急性の高い事案は、速やかにスクールカウンセラーへ共有・連携する体制を構築します。
