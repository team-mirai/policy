...
### 福祉分野：官民連携による支援アクセスの改善
現状、医療的ケア児のご家族など、本当に支援を必要とする方々へ、民間の優れたサービスを含めた情報が届きにくいという課題があります。行政の縦割りや、公共施設での営利サービスの紹介に関する制約が背景にあります。
チームみらいは、行政が民間サービスを適切に評価・認証し、公的な窓口で積極的に情報提供できる仕組みづくりを推進します。官民が連携することで、必要な支援が、必要な人に、迅速に届く社会を目指します。
