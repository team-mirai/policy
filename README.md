...
　さらに、政策の効果を客観的に検証するため、デジタルツインの活用を推進します。我々の政策だけでなく、他の政策案についても、経済、生活環境、社会制度への長短期的な影響を科学的にシミュレーションし、その結果を国民の判断材料として広く提供します。これにより、建設的な政策議論を促すとともに、政治家の発言の真偽を検証するファクトチェックとしての役割も担います。
