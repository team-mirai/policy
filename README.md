...
年齢や障害の有無を問わず、誰もが多様な学習（プログラミング、資格取得、教養など）に取り組めるよう、個々の進捗や理解度に合わせてマンツーマンで指導する「生涯学習AI」を開発・提供します。これにより、場所や時間を選ばずに学習機会を確保し、個人のスキルアップ、就労支援、社会参加を促進します。この取り組みは、子育て中の親の学び直しや、子どもたちの探求学習の支援にも繋がり、誰もが学び続けられる社会の実現を目指します。
