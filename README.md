...
　特に、新たな制度、とりわけデジタル化を進める際には、単に効率性のみを追求するのではなく、テクノロジーが本来持つべき『包容力』を大切にします。現場で実務を担う方々の声に真摯に耳を傾け、バックオフィス業務に過度な負担が生じたり、デジタルに不慣れな方々が置き去りにされたりすることのない、使う人の立場に立った制度設計を徹底します。
