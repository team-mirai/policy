...
このマニフェストはバージョン0.1(超初期版)として公表したものであり、頂いたご意見を踏まえてどんどんアップデート（改善）をしてゆきます。特に、精神的な困難を抱える方への支援が重要な課題です。オンライン相談窓口の設置や、専門知識を持つ人材育成と処遇改善、そのための財源確保、そして社会全体の理解を深める啓発活動など、多角的な施策の具体化を急いでいます。
