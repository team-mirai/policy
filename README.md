...
　特に、国民の意見が大きく分かれる重要政策（例：選択的夫婦別姓など）については、単に賛成・反対の立場を表明するのではなく、現状の課題、制度変更による利益と不利益を客観的なデータに基づいて広く国民に提示します。その上で、AIなどの技術も活用し、多様な意見を公平に集約・分析し、社会全体への影響を慎重に考慮した上で、結論を導き出します。
