...
* **デジタルが苦手な方への配慮：**スマートフォンの操作が苦手な方など、デジタルサービスを使いこなすことが難しい方々も取り残さないよう、多様な手段でのサポートを提供します。例えば、対面での相談窓口の維持や、電話による丁寧なサポート、やさしい言葉で書かれたウェブサイトを用意するなど、一人ひとりに合わせた方法で支援します。
