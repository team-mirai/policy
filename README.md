...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。国政政党を目指す活動に加え、選挙の結果にかかわらず、誰もが政策づくりに参加できるという理念を実現するため、このマニフェストの改善をはじめとする活動を継続します。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。
