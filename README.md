...
本マニフェストに掲げる政策の実行にあたっては、以下の財政運営の基本原則を遵守します。

*   **歳出の集中と選択:** 政策効果の高い分野に予算を重点的に配分します。
*   **妥当な価格での契約:** 公共調達における公正性と透明性を確保し、コストパフォーマンスを最大化します。
*   **技術革新によるコスト削減:** 最新技術を積極的に活用し、行政コストの継続的な削減を目指します。
*   **運営費の抑制:** 長期的な視点でランニングコストを評価し、持続可能な行政サービスの実現を図ります。
