...
**変更提案は、どなたでもチャットからお気軽にお寄せください**

このマニフェストをより良くするためのご意見や変更のご提案は、すべてチャットを通じて受け付けています。
*   **チャットで政策要望を提出する:** [こちら](https://policy.team-mir.ai/view/README.md)のページから、あなたのアイデアやご意見をお知らせください。特別な知識やアカウント登録は一切不要です。

どのような立場の方からのご提案であっても、チームみらいが一つ一つ責任をもって確認し、公平に検討します。
