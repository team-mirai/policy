...
　こうした議論の中から、新しい政策の種が生まれてきます。例えば今回のように、働く世代の所得を向上させるため、賃上げに積極的な企業の税金を優遇する仕組みを強化することや、各企業がどれだけ利益を従業員に還元しているかを見えるようにすることなど、頂いたご意見を元に具体的な政策として育てていきます。
...
政策内容の変更以外のPR（例：タイポ修正、フォーマット調整、ドキュメント更新など）でX通知を避けたい場合は、PRに `skip-notification` ラベルを付けることで通知をスキEdaットできます。
