...
　例えば、直近では匿名ユーザー様より、医療分野に関して以下のような具体的なご提案をいただき、議論を深めています。

*   公平性のため、高齢者の自己負担は原則3割とし、所得だけでなく資産も考慮した負担へ。
*   マイナンバーに資産を紐付け。プライバシー保護を徹底し、情報は本人が許可した範囲でのみ利用。
*   健康な方への「健康還付金」制度を創設。
*   24時間対応のオンライン・電話相談窓口を設け、過度な受診抑制を防止。

　これらのご意見を参考に、マニフェストのさらなる具体化を進めてまいります。
