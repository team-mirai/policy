...
チームみらいは、現行の年金制度が、特に永続的な障害を持つ方々にとって大きな負担となっている現実を重く受け止めています。障害の実態に即した、より公正で安心できる制度への改革を目指し、以下の政策を推進します。

1.  **永続的な障害に対する年金更新手続きの原則廃止**:
    発達障害のように、その特性が永続する障害について、定期的な年金更新手続きを求めることは、当事者とその家族に不必要な精神的・経済的負担を強いています。医学的知見に基づき、症状が永続すると判断される障害については、更新手続きを原則として不要にします。

2.  **障害基礎年金の適正な給付水準の実現**:
    障害のために厚生年金への加入機会がなかった方が、生活保護費を下回る水準の障害基礎年金だけで生活を強いられる現状は、大きな社会的な歪みです。誰もが人間としての尊厳を失うことなく暮らせるよう、障害基礎年金の給付水準の引き上げや、生活実態に応じた加算制度の創設を積極的に検討します。
