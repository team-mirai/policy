...
現在、コミュニティの皆さんと以下のようなテーマについて議論し、マニフェストの改善を進めています。

*   **デジタル手帳のあり方（母子手帳・お薬手帳など）**: デジタル化の利便性を追求しつつ、紙媒体の良さも残すハイブリッドな形を検討しています。まなさんからのご提案を受け、母子手帳では「手書きの記録など、紙ならではの温かみ」、お薬手帳では「緊急時に第三者が情報を確認できる安全性」を特に重視します。各種手続きはデジタルで効率化し、利用者が自分に合った形を選択できる仕組みを目指します。
