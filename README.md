...
ようこそ！ このページは、チームみらいの政策を『議論し、改善するための対話の場』です。

政策の全体像をまず『閲覧したい』方は、以下の専用ビューアをおすすめします。ワンクリックで全ての政策がスムーズにご覧いただけます。

[マニフェスト閲覧ページはこちら](https://policy.team-mir.ai/view/README.md)
