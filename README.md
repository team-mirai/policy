...
## 皆さんからいただいた主なご意見
*   現在の多数決という仕組みは、本当に合理的なのか。票の価値を可視化するなど、新しい仕組みが必要ではないか。（euricaさんより）
*   議員は、その分野の専門家がなるべきではないか。（euricaさんより）
*   各政党がなぜその政策を掲げるに至ったのか、背景やプロセスが不透明で分かりにくい。（euricaさんより）
*   GitHubは専門的で使いにくい面もあるため、既存の『いどばたシステム』の使いやすさ（UX/UI）を向上させ、SlackのようなチャットツールやSNSのように誰もが気軽に政治や政策について議論できるプラットフォームに発展させてはどうか。（euricaさんより）

これらのご意見を踏まえ、今後は特に『デジタル民主主義』の項目について、具体的な政策案の議論を深めていきたいと思います。
