...
## 検討中の新たな政策案
*   **オーバーツーリズム対策と持続可能な観光**: 国民生活との調和を重視し、投機的な購入等を抑制するため、消費税の免税制度を見直します。また、ESTAのような事前入国審査制度を導入し、不法滞在や犯罪を未然に防ぎます。入国手続きを厳格にすることで、日本の文化や社会を尊重する旅行者を歓迎し、質の高い観光の実現を目指します。さらに、日本の価値観や国際法を尊重しない国に対しては、ビザの発給条件を抜本的に見直し、特に長期滞在ビザの停止を含めた厳格な対応を検討します。
