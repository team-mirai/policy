...
ようこそ！　このマニフェストは、以下の2つの側面を持っています。

1.  **議論の「基盤」の提案:** 政党を問わず誰もが利用できる、透明で開かれた政策づくりの仕組み。
2.  **チームみらいの「政策」:** 1.の基盤を使って私たちが実現したい政策の具体案。

私たちは、まずこの「基盤」を整えることが、党派を超えて重要だと考えています。ここは、その両方について、みんなでオープンに話し合い、改善していくためのページです。
...
頂いた負託にお応えするため、私たちはこの「議論の基盤」を具体的に動かす最初のステップとして、プロトタイピング（試行）に最適なテーマを提案します。

選定のポイントは、日本の未来にとって重要でありながら、特定の政治的イメージに染まっておらず、国民の皆さんとゼロベースで純粋な議論が行いやすいことです。

以下のテーマから、熟議を始めていきたいと考えています。

1.  **未来への投資： 「科学技術への大胆な投資」の是非と具体策**
2.  **現在の課題解決： 「ベーシックインカム導入」の是非と具体策**

これらのテーマは、感情論だけでなく、データや論理に基づいた建設的な議論が求められます。チームみらいの強みを活かしながら、皆さんと一緒に日本の新しい未来を描くための、最初の重要な一歩です。

近日中に、このテーマに関する議論の進め方やスケジュールを具体的にお知らせします。
