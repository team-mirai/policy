...
現状の課題として、例えば、高齢者のデジタルデバイド問題があります。IT機器が苦手な方々がデジタル化の恩恵を受けられないだけでなく、情報アクセスからも取り残されてしまう可能性があります。これに対し、かいごテクさんからは、遠隔操作技術を活用した家族によるサポートや、さらには障害のある方々がITサポートの担い手となることで、高齢者のデジタル活用を支援するという具体的な提案が寄せられています。こうした声も踏まえ、デジタル民主主義のあり方についても議論を深めていきたいと考えています。
