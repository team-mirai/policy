...
## 皇室の安定的な継承に向けた私たちの考え方

私たちは、皇室を日本の社会と文化の安定を支える、極めて繊細で重要な仕組みであると捉えています。その上で、皇位の安定的な継承について、以下の通り私たちの考えを表明します。

*   **女性天皇の容認:**
    歴史上、女性天皇は8方10代存在しており、その歴史的先例を尊重し、女性天皇は容認されるべきであると考えます。

*   **女系天皇への慎重な姿勢:**
    一方で、1000年以上にわたり男系による継承が維持されてきた歴史は、社会の安定性を支えてきた極めて重い「実績」です。私たちはこれを、特定の価値観で安易に判断するのではなく、尊重すべき客観的な事実（歴史的データ）として捉えます。

    女系天皇への変更は、この仕組みの根幹に関わる大きなアップデートであり、社会に予測不能な影響を与え、新たな分断を生むリスクをはらんでいます。

    したがって、世論調査の結果のみを以て結論を急ぐべきではありません。これは永続的な拒否ではなく、この国のあり方を左右する重要な問題だからこそ、時間をかけて国民的な議論を深める丁寧なプロセスが不可欠である、という未来への責任を重視した慎重な姿勢の表明です。チームみらいは、テクノロジーを活用した熟議のプラットフォームなども用いて、この国民的合意の形成に貢献したいと考えています。
