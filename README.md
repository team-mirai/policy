...
このマニフェ스트はバージョン1.0です。今後も頂いたご意見を踏まえてどんどんアップデート（改善）をしてゆきます。
...
　例えば、このような議論がありました。医療現場の方から「物価高騰で医療機関の経営が厳しい」という課題が提起され、診療報酬全体の引き上げ、高齢者の自己負担割合の見直し、そして受診抑制を防ぐための予防医療（健康診断など）への補助拡充という、一連の政策パッケージが提案されました。このように、一つの課題から始まり、その影響や副作用を考慮した多角的な解決策を、皆さんと一緒に探っていきたいと考えています。
