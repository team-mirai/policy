...
### 選択的夫婦別姓とミドルネームの導入（ふるたにさんからの提案）

*   夫婦が別々の姓を名乗る「選択的夫婦別姓」を導入します。
*   子どもが生まれる際には、父母どちらかの姓を戸籍上の姓として選択します。
*   戸籍上の姓として選ばれなかった方の親の姓を、子どものミドルネームとして戸籍に記載します。ただし、日常的に使う身分証明書（健康保険証や運転免許証など）への記載は必須としない想定です。
*   **目的：** この制度により、子どもが両親双方との姓の繋がりを実感でき、家族の絆を深める新しい選択肢を提供します。
