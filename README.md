...
デジタル化をはじめとする新しい政策を推進するにあたり、既存の政治や行政との丁寧な対話・連携は不可欠だと考えます。私たちは、特定の個人や政党を批判することに時間を費やすのではなく、あくまで政策本位で議論を進めます。

所属政党や思想信条にかかわらず、私たちの政策提案に賛同してくださる方とは、積極的に対話し、協力関係を築いていきます。オープンな場でデータに基づいた建設的な議論を行うことこそが、結果として国民全体の利益につながる最も着実な道であると信じています。このマニフェスト自体が、そうした対話の出発点となることを目指しています。
