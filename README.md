...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、特に男女が協力して子育てに取り組める社会の実現を目指し、本マニフェストの政策を推進しています。
...
* **出産・育児に関する議論での配慮のお願い**：出産という経験、特に産後の女性の心身は非常にデリケートな状態にあります。これは社会全体で理解を深めるべき重要な点です。このマニフェストに関する議論においても、当事者の状況を深く理解し、敬意をもって建設的な意見交換を行うことを強く推奨します。
