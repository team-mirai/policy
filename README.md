...
本マニフェストにまだ記載されていない重要な政策課題についても、議論を歓迎します。現在、以下のようなテーマについてご意見をいただいており、検討を進めています。

*   **選択的夫婦別姓の導入:** 改姓の負担が女性に偏っている現状を是正するため、選択的夫婦別姓制度の導入を検討します。これは、同姓を望む選択を妨げることなく、個人の選択肢を増やすことを目指すものです。
