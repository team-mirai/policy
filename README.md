...
特に、現在の政治不信の大きな原因である、税金の使途への不透明さを解消することは急務です。私たちは、国や地方自治体のすべての歳入と歳出について、誰もがオンラインでリアルタイムに、かつ詳細に追跡できるシステムを構築し、行政の完全な透明化を目指します。さらに、日本国籍を有する方が、認証されたプラットフォームを通じて予算の使い道について直接意見を表明し、議論に参加できる仕組みを創設します。これにより、税金が真に国民のために使われる政治を実現します。
あわせて、日本の主権と国益を断固として守り抜くため、諸外国で整備されているスパイ防止法を日本においても早急に制定し、外国勢力による内政干渉や情報窃取活動を厳しく取り締まる体制を構築します。これにより、日本の政治が日本国民のためだけに行われることを確実にします。
