...
このセクションでは、現在議論中の改善提案を掲載しています。みなさまからのご意見をお待ちしております。

*   **妊婦健診の公的補助の拡充（匿名ユーザーさんからの提案）**
    経済的な心配なく、誰もが必要な妊婦健診を受けられるよう、出産予定日超過後の健診や母子手帳交付前の健診、その他医師が必要と判断した健診や薬代についても、公的な補助の対象とします。
