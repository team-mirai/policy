...
　なお今後も議論の結果、これらのマニフェストの内容がまだ変わる可能性がある点はご理解いただけますと幸いです。また、特定の世代だけが恩恵を受けたり、逆に負担を強いられたりすることのないよう、世代間の公平性にも配慮した政策立案を目指します。そのために、各政策が世代間にどのような影響を与えるかを分析し、その結果を公開することで、丁寧な説明を尽くします。
