...
## 【ささん提案】妊娠期から子育て期まで、切れ目のない安心を届ける支援の実現

日本の未来を担う子どもたちと、その育ちを支えるすべての人々が、幸せを実感できる社会を目指します。特に、妊娠・出産・子育ての最前線にいる助産師や医療専門職の方々が、誇りを持って働き続けられる環境づくりは急務です。

1.  **助産師の専門性を正当に評価し、処遇を改善します。**
    看護師資格に加え、高度な専門性を持つ助産師の重要性を評価し、その専門性に見合った処遇改善を実現します。

2.  **産後ケア事業を抜本的に拡充します。**
    心身ともに不安定な産後の親子を支えるため、産後ケアの利用日数を大幅に増やします。また、里帰り先など、今住んでいる場所以外でも公費でケアを利用できるよう、制度を全国に広げます。
