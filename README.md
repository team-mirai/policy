...
時間や場所の制約により働く機会が限られている人々が、その能力を最大限に発揮できる社会を目指します。その鍵となるテレワークを誰もが選択できるよう、以下の政策を推進します。

1.  **スキル証明による採用機会の拡大:** 実務経験がなくとも、資格取得やポートフォリオ、オンライン講座の修了実績などが企業の採用選考で適切に評価されるよう、新たな採用ガイドラインの策定と普及を促進します。
2.  **テレワーク求人の創出と競争緩和:** テレワーク導入企業への税制優遇や補助金を拡充し、求人の絶対数を増やします。また、行政機関においてもテレワーク可能な業務を積極的に創出し、多様な働き方を率先して実現します。
