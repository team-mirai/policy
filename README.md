...
選挙の公平性を保つため、以下のルールを提案します。

*   **選挙期間中の政府広報の制限**: 選挙公示日の2日前から投開票日までの期間、政府による税金を使った広報活動を原則として禁止します。これにより、特定の政党が有利になるような宣伝活動を防ぎ、公平な選挙を実現します。ただし、国民の生命、安全、財産を守るために必要不可欠な緊急情報（災害情報や大規模な感染症に関する注意喚起など）の発信は例外とします。
