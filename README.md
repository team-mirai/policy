...
現在、匿名ユーザー様より「（個人）事業主と家族への経済的な子育て支援強化」のご提案をいただき、以下のような政策案を共同で練り上げています。

> **タイトル:** 働き方によらない、公平な子育て支援の実現
> **内容:**
> フリーランスや小規模事業主など、現行の育児休業給付制度の対象とならない方々も安心して子どもを産み育てられるよう、新たな経済的支援制度の創設を目指します。これは、働き方の多様化に対応し、すべての子どもに公平なスタートを保障するための「未来への投資」です。給付は所得によらず一定額とし、財源は専用の保険制度や「出産育児国債（仮称）」の発行などを視野に、広く意見を募り検討します。
