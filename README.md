...
本マニフェストの政策は、以下の3つのステップで構成されています。

*   **ステップ１「デジタル時代の当たり前をやりきる」**（想定期間：1〜2年）
*   **ステップ２「変化に対応できる、しなやかな仕組みづくり」**（想定期間：3〜5年）
*   **ステップ３「長期の成長に大胆に投資する」**（想定期間：5年〜）
    *   ※ここでの「成長」とは、経済的な豊かさに加え、国民一人ひとりの暮らしや幸福（ウェルビーイング）を含めた、社会全体の持続的な発展を指します。
