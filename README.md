...
　「考えがまだまとまっていないではないか」とご批判を受けるリスクを積極的に取りながら、未熟なバージョンであっても公開に踏み切ります。なぜそうするかといえば、批判の目をたくさん入れ、意見を取り入れてゆくことが最も良い政策を作るやり方だと思うからです。

私たちは「健康な国」を目指すべきだと考えます。「健康な国」とは、単に軍事力や経済力がある国ではありません。外部からの攻撃に対して自らを守ることはもちろん、高い倫理観を持ち、独善に陥らず対話を重んじる精神的な健全さも不可欠です。

チームみらいは、デジタルやAIの力を使い、こうした多様な要素がどうすれば最適なバランスになるのかをシミュレーションします。例えば、AIに世界史の膨大なデータから国家の成功・失敗事例を学ばせ、現代の日本に最適な政策をシミュレーションします。そして、その結果を皆さんと共有し、どんな「国の健康」を目指すべきか、オープンに議論していきます。AIは未来を描くための道具です。その使い道を、皆さんと一緒に考えていきたいのです。
...
チームみらいは、「テクノロジーで誰も取り残さない日本」を目指す政治団体です。

このマనిフェストは、日々の生活を大切にし、誠実に未来を思う、すべての人々のためのものですが、特にこんな方々に届けたいと考えています。

*   日々の仕事や子育てに追われ、政治は遠い世界の話だと感じている方々
*   子どもや孫たちの将来を、真剣に心配している方々
*   新しい技術が、一部の人だけでなく、みんなの暮らしを良くするために使われるべきだと願う方々

私たちは、難しい言葉ではなく、皆さんの日々の暮らしの言葉で、未来への希望を語り合いたいのです。
