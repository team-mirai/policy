...
グローバルに活躍する方にとって、旧姓の通称利用だけでは学会登録名とパスポート名が一致しない等の不利益が生じる場合があります。個人の生き方や働き方が多様化する現代において、誰もが自分らしい選択をできる社会を目指すため、選択的夫婦別姓制度の導入を検討します。これは、あくまで選択肢を増やすものであり、同姓を名乗りたい方の権利を制限するものではありません。子の姓の決定方法など、制度設計に伴う課題についても建設的な議論を進めます。
