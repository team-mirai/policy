...
### 妊娠・出産・子育てに関する支援
* 妊娠中の通勤困難な方の交通費支援制度を創設し、安心して通勤できる環境を整備します。
* 妊娠中や産後の従業員が希望する場合、企業は原則として在宅勤務を認めるよう促します。在宅勤務が困難な場合は、その理由を説明し、時差出勤や短時間勤務など代替案を提示することを企業の義務とします。
* 個々の事情に応じて、時短勤務の時間をより柔軟に設定できるよう法改正を目指します。
* 公共交通機関において、母子手帳や診断書などで必要性が証明された方を対象に、予約可能な『思いやりシート』の社会実験を推進します。
* 医師の診断に基づき、本人が希望する場合、より早い時期から産前休業を取得できるよう制度を改正します。
* 年次有給休暇とは別に、妊娠中の体調不良に利用できる有給の「マタニティ特別休暇」制度の創設を企業に促します。

### 公共交通のアクセシビリティ向上
* 電車やバスにおいて、自動スロープ設置やホーム等との段差・隙間解消をモデル事業として推進します。これにより、介助を気にすることなく、誰もが安全・安心に乗降できる環境を目指します。
* スマートフォン等を活用し、近くの駅員に直接介助を要請できるシステムを導入します。対応可能な駅員へ自動的に通知を繋ぐことで、迅速で確実なサポートを実現します。
