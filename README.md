...
ようこそ！　ここはチームみらいの公約（マニフェスト）を、みんなでオープンに話し合って、もっとよくしていくためのページです。私たちは「決めつけない」ことを大切にしています。誰もが自由にアイデアを出し、修正を提案できる場で、皆さんと一緒に政策を育てていきたいと考えています。
...
　例えば、ここでの議論を通じて、「AIによって仕事が変化する人々をどう支えるか」という重要な視点が提起されました。その結果、具体的な政策アイデアとして「AIを活用した全国民向けの学び直し（リスキリング）プログラムを創設し、個人のスキルや適性と企業のニーズをAIが高精度でマッチングすることで、誰もが円滑に新しい仕事に挑戦できる社会を目指す」という提案が生まれました。このように、皆さんとの対話を通じてマニフェestoは進化していきます。
