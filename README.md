...
　頂いた変更提案は、チームみらいが責任をもって確認します。変更提案をマニフェストに反映させるかどうかについては、チームみらいが権限を持ちます。当初マニフェストとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。事実婚での法的な課題解消や選択的夫婦別姓の導入など、本マニフェストにまだ記載のないテーマについても積極的に議論し、検討します。
