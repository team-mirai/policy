...
**“聞く”から“ともにつくる”へ：「現場知」を取り込むための構造改革**

チームみらいは、単に声に耳を傾ける“聞く”姿勢から、当事者と共に政策を“ともにつくる”関係へと進化することを目指します。「エリート主義」「机上政策」「共感不足」といった懸念を払拭するため、生活者の実感や現場の知恵が、意思決定の過程に恒常的・構造的に組み込まれる仕組みを構築します。

**〇今できること**
*   **現場交差配置の試験導入：**政策担当メンバーの中から1～2名に「週1日介護・NPO等の現場体験」を割り当てて実施します。
*   **当事者レビュー委員会の暫定設置：**少人数で政策案レビューを行い、小規模ながら即時に活動を開始します。

**〇将来目指すこと**
*   **生活者政策パートナーの常駐化：**福祉・介護・教育など専門の当事者を有償で組織に加える体制を目指します。
*   **ローカル政策ワークショップの連続展開：**全国複数拠点で市民・専門家と合同ワークショップを定期的に運営します。
