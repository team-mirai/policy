...
私たちは、すべての子どもの健やかな成長を第一に考えます。共同親権の議論を含め、離婚後の親子関係については、画一的なルールを押し付けるのではなく、一つひとつの家庭の事情に深く寄り添うべきです。協力しての子育てが難しい状況で、一方に共同の責任を強制すべきではありません。そのために、当事者双方の意見を丁寧に聴き、合意形成を尊重する手続きを約束します。同時に、面会交流の支援や養育費の確実な履行など、具体的なサポートも強化します。
