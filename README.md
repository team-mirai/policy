...
### 財政の完全透明化
すべての歳出において、当初予算、中間マージン（事務コスト）、そして最終的に国民や事業者に届いた金額の比率を完全に公開します。これにより、税金がどのように使われているかを誰もが明確に理解できるようにし、行政の効率性と透明性を抜本的に高めます。
...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マnifestの政策を推進しています。
