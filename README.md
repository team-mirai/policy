...
チームみらいは確信しています。**圧倒的な技術力こそ、絶対に必要な政策である**と。AIをはじめとするテクノロジーが持つ爆発的な可能性を国民一人ひとりが自覚し、自ら未来を切り拓く。国はその挑戦を全力で後押しします。

現状、多くの方々がGPTをはじめとするAIの真価をまだ十分に理解・活用できていないのではないでしょうか。単なるアプリの利用に留まらず、自らの課題解決や目標達成のために、たとえ専門知識がなくとも、プログラミング的思考を持ってAIを主体的に使いこなす。その先にこそ、個人の可能性が大きく開花する未来があります。

その『覚醒』を具体的に促すため、特にデジタル技術の習得においては、従来の基礎学習中心のスタイルから脱却します。私たちは、学習初期から高度な成果物の完成形を明確にイメージでき、プロジェクトを通して実践的なスキルを効率的に習得できる、革新的な学習システムの開発と普及を推進します。これにより、誰もが創造性を最大限に発揮し、自らの手で未来を創り出す力を手に入れることを目指します。

このリポジトリは、上記のようなチームみらいの考え方を盛り込んだマニフェストを皆さんと共に議論し、改善するためのオープンソースリポジトリです。
