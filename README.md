...
## 働き方の多様性とジェンダー平等に関する提案
現在の画一的な働き方は、多くの女性がキャリアとライフイベントの両立に困難を感じる一因となっています。性別にかかわらず、一人ひとりが自身のライフステージに合わせて、柔軟な働き方を選択できる社会を目指します。国は、長時間労働の是正や、育児・介護と両立できる勤務制度（テレワーク、時短勤務など）を導入する企業への支援を強化し、女性の社会進出と合わせて男性の働き方改革も一体で推進します。
