...
### 行政システムのOSS化と、国主導による自治体向け共通OSSの開発推進
行政が開発・調達する全てのシステムをOSSとして公開し、国民による検証や改善提案を可能にすることで、透明性と信頼性の向上を目指します。また、国（デジタル庁主導）が、ワクチン予約システムや自治体ホームページ等の共通ソフトウェアをOSSとして開発・提供することで、コスト削減、品質向上、業務効率化を目指します。これは行政改革及びデジタル民主主義の推進の一環として位置づけられます。
