...
このマニフェストはバージョン0.1(超初期版)として公表したものであり、頂いたご意見を踏まえてどんどんアップデート（改善）をしてゆきます。特に教育分野においては、現行のICT活用における課題を踏まえ、タブレットの効果的な利活用促進や、子どもたちが実践的な英語コミュニケーション能力を養うためのアウトプット機会の抜本的拡充（例：オンライン英会話の積極的な導入支援等）といった具体的な提案を検討・追加していく予定です。
