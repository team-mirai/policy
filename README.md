...
* [デジタル社会基盤の革新：透明で効率的な行政サービスの実現](4F_デジタル社会基盤の革新.md)
...
　特に、行政サービスの質を抜本的に向上させるため、制度のルールをコード化し、オープンな技術基盤を活用することで、真に国民一人ひとりの状況に寄り添ったプッシュ型支援や申請の自動化を目指す「デジタル社会基盤の革新」についても、今後具体的な政策として議論を深めていきます。
