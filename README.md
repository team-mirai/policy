...
*   **家庭養護の原則化と子ども中心の徹底:** 乳児院での集団養育や、子どもの発達を無視して年齢を理由に施設を移すといった、子どもの愛着形成を損ないトラウマを生む運用をなくします。代わりに、里親委託や養子縁組を基本とし、子どもが安定した家庭環境で育つことを最優先します。いかなる場合も「子どもの最善の利益」を最優先し、実親の意向より子どもの権利と安全が優先される「子ども中心」の運用を、自治体の専門性や考え方の違いによって左右されることなく、全国で徹底します。
*   **職員の専門性向上と待遇改善:** 職員配置を手厚くし、より家庭的な環境を実現するため施設を小規模化します。社会的養護の現場を支える職員の専門性を高めるための研修を充実させ、適切な人員配置を行います。デジタル技術の活用で業務負担を軽減し、低賃金・重労働といった労働環境を改善することで、慢性的な人材不足を解消します。
*   **子どもの安全・権利確保と地域格差の是正:** 日本版DBSの導入を義務付け、性犯罪歴のある者が職員になることを防ぎます。また、施設内での虐待や権利侵害から子どもを守るため、子どもの声を代弁し権利を守るアドボケイト（アドボカシー）制度を法的に確立し、その独立性を確保します。さらに、児童相談所への弁護士や専門職の配置を標準化し、地域格差を是正します。自らのルーツを知る権利を保障するため、出自に関する記録を生涯にわたって保存し、いつでもアクセスできる仕組みを確立します。
*   **家族への支援と再統合:** 親が抱える困難（貧困、精神疾患、孤立など）に対して治療的なアプローチで支援し、家族の再統合を積極的に目指します。子どもの分離を防ぐための、包括的な家族支援を社会全体で推進します。
*   **切れ目のない支援とパーマネンシーの保障:** 心理専門職を増員し、虐待やネグレクトによって傷ついた子どもの心のケアを充実させます。施設を退所したあとも、孤立することなく社会で自立できるよう、長期にわたる支援体制を構築します。子どもにとって永続的で安定した人間関係（パーマネンシー）を保障することを、社会的養護の基本理念とします。
