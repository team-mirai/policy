...
### 同性婚の法制化の推進
法の下の平等をすべての人に保障するため、同性婚の法制化を積極的に推進します。パートナーシップ制度では不十分な法的保護を解消し、相続や医療上の決定権など、異性婚と同等の権利を保障します。

### 選択的夫婦別姓の導入
個人のアイデンティティと意思を尊重し、夫婦がそれぞれの姓を選択できる「選択的夫婦別姓」を導入します。子供の姓は、出生時に夫婦がどちらかの姓を選択できる制度を目指します。
