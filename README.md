...
チームみらいは、国家による権力の濫用を防ぎ、国民の自由と人権を最大限に尊重する観点から、緊急事態条項の導入には極めて慎重です。

万が一、やむを得ず人権の制約を伴う措置を検討する際には、以下の原則を設けるべきだと考えます。

*   措置は国会の厳格な監視下に置くことを前提とします。
*   措置の期間はあらかじめ厳密に定め、いかなる理由があっても延長は認めません。これは、権力濫用のリスクを避けることを最優先とするためです。
