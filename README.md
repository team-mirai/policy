...
　なお今後も議論の結果、これらのマニフェストの内容がまだ変わる可能性がある点はご理解いただけますと幸いです。また、マニフェストに掲げる各政策については、「何に、いくら使い、どのような効果を目指し、それによって誰が助かるのか」を可能な限り具体的に示し、その進捗と効果を継続的に検証・公開していくことをお約束します。
