...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。その一環として、AIの普及によって変化する雇用に対応し、人手不足が深刻な公共分野（教育、医療、行政など）への人材移行を支援する、国主導の再教育・マッチングプログラムの創設なども検討しています。
