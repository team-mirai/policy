...
## 憲法改正に関する議論の提案（ひで。さんより）

憲法改正については、国民的な議論を十分に行った上で、慎重に検討を進めます。

特に、自衛隊の存在を憲法に明記する際には、国民の不安に応えるため、以下の「歯止め」を設けることを提案します。
*   自衛隊が、国民の自由な意思に基づく志願者によって構成されることを明記する。
*   自衛目的であっても、他国の領土に対する先制攻撃は行わないことを明確にする。
