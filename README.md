...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * [６．デジタル民主主義](16_ステップ１デジタル民主主義.md)　※マイナンバーカード等を活用したオンライン投票システムの導入検討を含む。その推進策についても多様な意見を求む（Kikyoさんより投票所利用時の費用負担等について提案あり）。  
  * [７．医療](17_ステップ１医療.md)  
...
貢献者は、クリエイティブ・コモンズ・ライセンスのCC BY 4.0のライセンス下において、本リポジトリを第三者が利用することに同意したものとみな합니다。  
