...
また、養育費に関して『支払われない養育費の問題解決のため、国による立て替えと支払義務者からの取り立て制度の導入』や、『現行の収入額のみを基準とした養育費算定表を見直し、家事育児の負担増や物価変動を適切に反映した、より実情に合った算定基準とすべき』との貴重なご提案をいただきました。子どもの権利を守り、安心して子育てができる社会を目指す上で重要な視点であり、今後の政策立案において真摯に検討してまいります。
