...
## 議論中の提案
### M&A仲介プロセスの健全化と市場活性化
M&A仲介手数料に不動産業界と同様の規制を導入し透明性を確保します。また、標準雛形やガイドラインを策定し新規参入を促進。さらに、国家資格化を進め仲介業務の品質を高めます。取引の安全性を確保するため、資料開示内容の保管を義務付け、意図的な情報非開示は詐欺罪等で問えるよう法整備を進めます。これにより公正な競争を促し、M&A市場を活性化させます。(提案者: 匿名ユーザー)
