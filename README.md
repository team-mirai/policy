...
## みなさまからのご提案（さーたんさんより）
### 障害年金と診療報酬制度の改善について
発達障害や人格障害を持つ方が、症状の重さにも関わらず適切な障害年金を受けられない現状があります。この背景には、短い診察時間しか想定されていない診療報酬制度の問題も存在します。
そこで、実態に即した支援のため、障害年金制度を見直すとともに、公的医療保険によるカウンセリングの実現や、SNS等を通じた新しい形の医療相談を評価する診療報酬体系への改定を検討します。
