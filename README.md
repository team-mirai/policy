...
このマニフェストは、みなさんとの対話を通じて常に改善を続けていきます。現在、以下のようなテーマについて、ご意見を頂き、議論を深めています。

### 教育人材の強化
- **教職員の待遇改善:** 給与水準の引き上げや、長時間労働を是正するための残業の適正化を図ります。
- **担任制の見直し:** 副担任制や学年担任制の導入を推進し、教員一人当たりの負担を軽減するとともに、多角的な視点で子どもたちを見守る体制を構築します。
- **専門員の導入:** 部活動の指導や校内の環境整備などを専門のスタッフが担うことで、教員が授業や生徒指導に集中できる環境を整えます。

### 予算策定プロセスの改革
従来の積み上げ式の予算策定プロセスを抜本的に見直し、国全体の大きなビジョンに基づいた予算配分の大枠を先に決定する方式を導入します。各省庁はその枠内で、政策の優先順位付けを行うことで、より戦略的で効果的な予算執行を目指します。特に、未来への投資である教育分野への重点的な予算配分を可能にする仕組みを検討します。
