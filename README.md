...
* [ステップ２「変化に対応できる、しなやかな仕組みづくり」](20_ステップ２「変化に対応できるしなやかな仕組みづくり」.md)  
  ...
  * [３．医療](23_ステップ２医療.md)
  * [４．デジタル民主主義](24_ステップ２デジタル民主主义.md)
  * [５．福祉](25_ステップ２福祉.md)
...
### 【要移動】あなた様からのご提案
*以下の項目は、本来「ステップ３『長期の成長に大胆に投資する』」に追記されるべきものですが、システムの都合上、一時的にここに記載しています。担当者による移動をお待ちください。*

**AIなどの先端技術の導入に関する方針案**
AIなどの先端技術を導入する際は、現在人間が行っている作業の時間や費用よりも、AIが担う方が安価で効率的になることを目指します。そのための具体的な費用対効果と予算計画を国民に示し、透明性を確保することで「空約束」に終わらせないことを約束します。
