...
チームみらいは、選択的夫婦別姓制度の導入は不要であると考えます。私たちは、家族が同じ氏を名乗ることで育まれる一体感や絆を重視します。氏は家族というチームの名前であり、その一体感は子供たちの安心にも繋がる大切な価値です。

その上で、結婚後も旧姓を使い続けたい方々の不便を解消するため、あらゆる場面で旧姓を不自由なく使用できる環境を法的に整備します。運転免許証、銀行口座、各種契約、行政手続きなどで旧姓使用を徹底し、名義変更のオンライン化も推進します。
