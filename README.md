...
日本の法令を遵守し、社会に貢献する外国人を尊重し、受け入れの門戸を開きます。一方で、不法行為が認められる場合には、在留資格の付与は行わず、法に基づき国外退去を命じます。土地の取得や公的サービスの利用に際しては、居住年数や納税実績といった客観的な基準に基づき公平なルールを設けることで、制度の不正利用を防止します。これは人種などによる差別を意図するものではなく、日本の社会基盤を維持するための措置です。
