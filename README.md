...
貢献者は、クリエイティブ・コモンズ・ライセンスのCC BY 4.0のライセンス下において、本リポジトリをderde者が利用することに同意したものとみなします。  
