...
## 議論中の政策案
### 子育て支援：成果連動型民間委託契約方式（PFS）の活用
社会的養護下の子どもたちなど、複合的な課題を抱える方々への支援を強化するため、ソーシャルインパクトボンド（SIB）を含む成果連動型民間委託契約方式（PFS）の活用を推進します。これにより、民間の知見や創意工夫を最大限に引き出し、支援の質の向上と効果の最大化を図ります。
