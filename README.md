...
### 安全な次世代電池への移行支援と火災リスクの低減
リチウムイオン電池が原因とみられるごみ処理施設等の火災が社会問題となっています。国民生活の安全を確保し、長期的な社会的コストを削減するため、以下の施策を推進します。
- **次世代電池の研究開発・導入支援:** 発火リスクの低いナトリウムイオン電池など、安全な次世代電池の研究開発及び社会実装を支援します。
- **購入者向け補助制度:** 次世代電池を使用した製品について、販売価格から直接値引く補助制度を設け、消費者の負担を軽減し、安全な製品の普及を加速させます。
