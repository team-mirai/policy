...
## 【すべての人に開かれた投票制度の実現】
私たちは、すべての有権者の声が等しく政治に届く社会の実現を目指し、投票方法の多様化を進めます。

国政選挙をはじめとする選挙においては、従来の投票所での投票に加えて、スマートフォンやパソコンなどの端末を用いたデジタル投票の導入を段階的に検討・推進します。これにより、場所や時間にとらわれず、誰もが投票に参加できる環境を整えます。

さらに、投票所に足を運ぶことが困難な高齢者や障がいのある方々に対しては、選挙管理委員会の運営による「移動型投票端末」等を活用した支援体制の構築を目指します。デジタル技術と公共支援の組み合わせにより、物理的・制度的なバリアを取り除きます。

私たちは、「誰一人取り残さない民主主義」を次世代のあたりまえにするため、法制度・セキュリティ体制・技術基盤の整備を一体的に進めてまいります。
