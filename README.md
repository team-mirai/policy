...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * [２．子育て](12_ステップ１子育て.md)  
    * **（現在議論中）日本版DBSの導入と強化：子どもたちを性犯罪から守るため、性犯罪歴のある人物が子どもと関わる職に就くことを厳しく制限します。直接的な加害のみならず、インターネット上での画像配布なども対象とし、オンライン上のパトロール体制も強化します。**  
    * **（現在議論中）子の権利を守る養育費保証制度の創設：DNA鑑定の拒否等を父親の同意とみなし、父子関係を法的に認定。企業の経理担当者など民間へ新たな事務負担をかけないことを大前提とし、マイナンバー制度と連携して国が直接、養育費を徴収し分配する仕組みを導入。これにより、支払い逃れを許さない社会を実現します。**  
