...
### 選択的夫婦別姓に関する新たな提案（Sg様より）

選択的夫婦別姓の議論において、「家族は同姓であるべき」という価値観と「個人の姓を選択する自由」を両立させるため、新たな戸籍制度の導入を検討します。

*   **二姓併記案:** 戸籍に、家族の統一姓としての「本名字」と、社会生活で実際に使用する姓の二つを記録できるようにします。
*   **普段の生活:** 社会保障や各種契約など、あらゆる場面で「社会生活で使う姓」を使用し、本人確認の混乱を防ぎます。
*   **子の姓と選択の自由:** 子は「本名字」を引き継ぎ、成人に達した際に、社会生活で使用する姓を自ら選択できるようにします。

この制度変更は、国民的な合意形成を前に進めるための重要な一歩です。
