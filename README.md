...
　なお、このプロセスの一環として、パピ子さんより以下の改善提案をいただき、現在マニフェストへの具体的な反映を検討しています。
...
> 
> **【教育・福祉分野の改善案】**
> 個々の特性に合ったコミュニケーションは基本的人権です。しかし、応用行動分析（ABA）や絵カード交換式コミュニケーションシステム（PECS®️）等、科学的根拠のある支援が普及せず、多くの可能性が失われています。これは特別な支援ではなく、聴覚障害のある人に手話や筆談を用いるのと同じく当然の配慮です。年齢や障害の有無を問わず、誰もが最適な方法で学び、意思を伝えるコミュニケーション手段を獲得し、それが社会全体に普及するよう、専門的人材の育成と現場への導入を推進します。
