...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。『挑戦する人が報われ、その挑戦を応援する人もまた報われる社会』を目指します。これは、国民一人ひとりが、互いの挑戦を支え合い、国全体の成長の果実を分かち合う、新しい形の連帯です。
