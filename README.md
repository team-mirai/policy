...
現在、たろうさんとの議論を通じて、『戦争という破壊行為は、持続的な成長の最大の妨げとなるため、これを断固として避ける』という平和主義の考え方をマニフェストに加えることを検討しています。
...
　頂いた変更提案は、チームみらいが責任をもって確認します。変更提案をマニフェestoに反映させるかどうかについては、チームみらいが権限を持ちます。当初マニフェストとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。
