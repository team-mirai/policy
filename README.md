...
現在、チームみらいでは、匿名ユーザーよりいただいた以下の提案について検討を進めています。

**提案の概要：**
多様な家族のあり方を尊重しつつ、伝統的な価値観にも配慮した、複合姓（ダブルネーム）の導入。

*   **結婚時**：夫婦が合意の上で、それぞれの姓を組み合わせた複合姓を選択できる。
*   **子ども**：子どもは、成人するまで親の複合姓を名乗る。学校などでは、便宜上どちらかの姓を使用することを認める。
*   **成人時**：成人した際に、複合姓の中から自らの意思で公式な姓を一つ選択する。

この案は、個人のアイデンティティを尊重するとともに、世代間の価値観の断絶を避け、社会の柔軟な変化を促すことを目指すものです。みなさんのご意見をお聞かせください。

### 現職での所得向上に関する提案

新たに、匿名ユーザーより以下の提案をいただきました。

**提案の概要：**
仕事にやりがいを感じつつも、経済的に困窮する世帯を支えるため、現職での所得向上を後押しする施策。

*   **企業の賃上げ支援：** 企業の賃上げ努力を国が後押しする税制を強化する。
*   **生産性向上と利益還元：** 中小企業の生産性向上を支援し、その利益が従業員に還元されるよう促す補助金制度を設ける。

この案は、現在の仕事に誇りを持ちながら働く人々が、経済的にも報われる社会を目指すものです。みなさんのご意見をお聞かせください。
