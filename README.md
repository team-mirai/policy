...
* 加えて、生成AIの急速な発展に伴う著作権問題、特にクリエイターの権利保護は喫緊の課題であると認識しています。この問題に対応するため、開発者が権利者の許諾を得ていないデータを無断で学習に利用することへの規制を検討します。具体的には、許諾を得たデータのみを学習に利用することを原則とし、生成物がどのデータを基に作られたかを追跡できる技術開発を支援します。これらが技術的に確立されるまでの過渡的な措置として、AIによって生成されたコンテンツには、その旨の明記や「透かし」を入れることを義務付ける法整備を目指します。
