...
東アジアの平和と安定のため、価値観を共有する同志国（イギリス、イタリア、オーストラリア、フィリピンなど）との連携を強化します。その一環として、これらの国々への防衛装備品の輸出を推進します。装備の統一による抑止力向上を目指し、装備品の種類に過度な制限は設けません。これに伴う国内外の懸念には、日本の平和国家としての理念に基づき、丁寧に説明責任を果たしていきます。また、防衛費については、防衛力を着実に整備・維持するため増額を目指します。その際には、自衛隊員の待遇改善を優先的に進めるとともに、装備品の部品や弾薬を十分に確保し、維持整備体制を強化することで、現場の部隊が本来の能力を最大限発揮できる環境を構築します。
