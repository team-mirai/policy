...
　このマニフェストは皆さんの声を拾いながら改善していくためのバージョン0.1（超初期版）であり、まだまだ議論中、作業中の箇所がたくさんあります。チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマనిFestを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。
...
憲法9条が掲げる平和の理念を、日本の貴重な財産として積極的に活用し、世界に貢献する「平和産業」を創出します。

1.  **平和研究の深化と国民的議論の促進:** 「平和とは何か」を議論する場を設け、平和学・平和工学等の研究を支援するシンクタンクを設立します。
2.  **「生存権」を守る技術と人材への投資:**
    *   防衛に特化したサイバーセキュリティ技術やシェルター等の開発を推進します。
    *   これらの技術を世界に提供し、活用できる専門人材の育成と輸出を支援します。
3.  **文化交流を通じた友好関係の構築:** ソフトパワーを活用して各国との相互理解を深め、敵対されない友好な国際関係を築きます。
