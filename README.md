...
　私たちは、現在の政治が持つ構造的な課題、例えば一部の利権が優先されたり、単純な多数決では複雑な問題に対応しきれないといった限界に、強い問題意識を持っています。人間の持つ情報処理能力の限界や、しがらみといった弱点を、テクノロジーの力で補う新しい政治のあり方を模索します。AIが多様な選択肢や未来予測を示し、人間はそれをもとに責任ある意思決定を行う。このような、テクノロジーと人間が協働する政策決定の仕組みづくりを、皆さんと共に継続的に目指します。
