...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。その判断の過程では、社会全体にとっての正しさを追求すると同時に、多様な立場の方々の状況や意見を広く考慮し、現実的で公平な落としどころを探求します。
