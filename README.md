...
日本の国籍を持たない非居住者による不動産取得に対し、国内の住宅市場の安定と国民の住環境保護を目的として、経済状況や国際的な動向を注視しつつ、課税のあり方について段階的な見直しを検討します。

都市部における深刻なヒートアイランド現象の緩和は喫緊の課題です。東京をはじめとする都市部では、公園整備や街路樹の植樹など、緑地化に力が入れられてきましたが、新たな植樹スペースの確保は困難になりつつあります。そこで、より省スペースで導入可能な対策として、在来種を中心とした湿地帯ビオトープの設置を推進します。トロ箱程度の小さなスペースからでも始められるため、公園、学校、公共施設、民間施設等に加え、個人宅のベランダなど多様な場所での展開が期待できます。その際、専門家と連携し、蚊の発生抑制などを含む適切な設計・管理ガイドラインを策定・周知することで、住民の懸念に対応します。これにより、都市の気温上昇の抑制を図るだけでなく、地域の生物多様性保全への理解を深め、自然と共生する持続可能な都市環境の実現を目指します。
