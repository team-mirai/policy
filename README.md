...
　このマニフェストは皆さんの声を拾いながら改善していくためのバージョン0.1（超初期版）であり、まだまだ議論中、作業中の箇所がたくさんあります。チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。例えば、国会におけるペーパーレス化を推進し、紙や印刷、関連業務のコストを削減するといった具体的なご提案も、行政改革の一環として積極的に検討していきます。さらに、国会のオンライン化を進めることで、審議の透明性を高めるとともに、会議運営の効率化も図ります。これにより、報道機関や国民がより議論に参加しやすくなる環境を目指します。ただし、オンライン化を進めるにあたっては、サイバー攻撃などのセキュリティリスクにも十分注意し、報道機関等のアクセスについても認定制にするなど、慎重な対策を講じる必要があります。
