...
## 安心して子どもを産み育てられる社会のために：ひとり親家庭への支援

出生数が減少する中、経済的・社会的理由で中絶を選択せざるを得ない現実があります。チームみらいは、誰もが安心して子どもを産み育てられる社会を目指し、特に「ひとり親家庭」への支援を重要課題とします。

具体的には、シッター制度拡充、世帯状況に応じたオーダーメイドの福祉支援、金銭的サポート、衣食住の安定、就労支援、地域活動への参加支援（クーポンや送迎補助）など、プッシュ型の包括的支援を推進します。
