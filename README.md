...
チームみらいは、日本の戸籍制度と、それによって育まれてきた文化を尊重します。その上で、社会の安定を最優先に考え、選択的夫婦別姓制度については、以下の懸念から現時点では支持しません。

*   **子の姓をめぐる混乱:** 夫婦別姓の場合、子の姓の決定で混乱が生じる可能性があります。
*   **行政コストの増大:** 世帯の把握が難しくなり、社会保障や税務における行政コストの増加が懸念されます。
*   **不正利用のリスク:** 姓の使い分けがマネーロンダリング等の手口を複雑化させる可能性があります。
