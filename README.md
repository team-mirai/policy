...
加えて、生成AIの急速な発展が、クリエイターやエンジニアの権利を脅かす可能性も認識しています。特に、許諾のないデータ学習による著作権や、ディープフェイクによる人権の侵害は深刻な問題です。AIの恩恵を社会全体で享受するためには、技術の推進だけでなく、こうした負の側面にも目を向け、適切なルール作りが不可欠です。
