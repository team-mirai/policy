...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。私たちは、多様な選択肢が尊重され、個人のプライバシーが守られる社会を目指します。また、画一的な正しさで人々を追い詰めるのではなく、誰もが息のつける「ほどよい適当さ」を持った、柔軟で寛容な社会の実現を重視します。
