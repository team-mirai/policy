...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * [．デジタル民主主義](16_ステップ１デジタル民主主義.md)  
    * 政策課題について、賛成・反対両論の意見とその背景、メリット・デメリットを客観的に公表し、関連資料を提示するアプリケーションを開発・提供します。  
    * また、国会の議席数や日程、委員会等の情報を集約するとともに、議員間の公開討論を促進するための「国会アプリ」を開発・提供します。このアプリには、議員の発言に対し、提示された情報源の確度（例：確度の高い資料あり・確度の低い資料あり・資料なし）を客観的に示すファクトチェック支援機能を搭載します。さらに、政府が災害情報等を迅速に通知できる機能も持たせ、国産プラットフォームによる情報管理の透明性と安全性を確保します。
  * [７．医療](17_ステップ１医療.md)  
