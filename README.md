...
　例えば、ある方（たろうさん）からは、「住所変更の手続きを一回行ったら、免許証や車検証などに自動で紐付けして欲しい。そのために何度も有給を取るのはおかしい」「毎回お薬手帳を持参するのは大変なので、医療情報を連携させて不要にしてほしい」といった具体的なご意見を頂いています。こうした現場の切実な声こそが、私たちの政策を前に進める力になります。
