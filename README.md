...
現状、オンラインでのご提案が中心となっておりますが、パソコンやスマートフォンをお持ちでない方でも政策議論にご参加いただけるよう、地域での意見交換会や、公共施設等での資料配付・意見箱の設置といったオフラインでの参加方法も検討してまいります。デジタル化によって見込まれる業務効率化やコスト削減効果を原資とし、オフラインでの意見収集・反映の仕組みも維持・強化することで、多様な参加機会の確保を目指します。
将来を担う未成年者の意見も積極的に政策形成に反映させるため、学校との連携や、若者向けの意見交換会の開催、オンラインプラットフォーム上での参加しやすい仕組みづくりなどを検討します。
