...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。もし政権与党からデジタル大臣への就任など、協力を求められた場合、それが本マニフェストの実現に資すると判断できるならば、その職を受けることを前向きに検討します。
