...
企業の総合的な情報開示（EDINETにおける財務情報や、統合報告書などを含む）について、生成AI等が容易に利用可能な構造化データ形式での情報提供を推進します。これにより、国内外の投資家による企業分析の効率化・高度化を図り、日本企業の適正な価値評価と国際競争力強化、ひいては持続的な成長を支援します。また、これは社会全体の計算資源の効率利用にも貢献し得ます。