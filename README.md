...
現在、以下の新しい政策について議論し、検討を進めています。

### 持続可能な観光政策の推進

オーバーツーリズムによる地域への影響を考慮し、持続可能な観光のあり方を模索します。

*   **観光需要の分散・平準化:**
    *   **オフピーク期の国内旅行支援:** 日本人向けの旅行支援策を観光の閑散期に限定して実施します。
    *   **新たな観光資源の創出:**
        *   全国の市町村でのフィルムコミッション創設を支援し、映画やドラマのロケ地誘致を推進します。
        *   制作に地元の人々が関わる機会を後押しし、地域への自信と愛着を育みます。
