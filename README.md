...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。「テクノロジーで誰も取り残さない日本」を掲げ、本マニフェストの政策を推進しています。これには、ご高齢の方、障害をお持ちの方、多様な出自や言語を持つ方々、地理的・経済的な理由でデジタル機器へのアクセスが難しい方々も含まれます。私たちは、情報アクセスやコミュニケーションの手段がデジタルに限定されないよう、多言語対応や「やさしい日本語」の活用、そして災害等で電力や端末が失われた場合でも機能する頑健な代替手段も確保します。これにより、誰もが安心して暮らせる、災害にも強い社会の実現を目指します。

また、私たちは活動を国政から始めます。課題の多くは地方にありますが、その根本原因は国全体の制度にある場合が少なくありません。社会の仕組みを大きく変えるには、まず国政で大胆な方針転換を行うことが不可欠だと考えます。
