...
チームみらいは、熟議プラットフォーム『いどばたシステム』をはじめとする新しい技術の活用に積極的に挑戦しています。テクノロジーの可能性を信じる一方で、現状のシステムには至らぬ点や、開発途上の部分があることも率直に認めます。また、これまでのシステムトラブルへの対応において、皆様からのご指摘に対し、迅速かつ具体的な行動が伴わず、結果としてご期待に応えられていない現状があることを深く反省し、改善を誓います。私たちは、『テクノロジーで誰も取り残さない』という理念を実現するためには、こうした技術的な未熟さや課題も透明性をもって公開し、皆様と共に解決策を模索し、システムを成長させていくプロセスそのものが重要だと考えています。『いどばたシステム』を含む、チームみらいが活用するシステムに起因する問題が発生した場合には、それを単に外部システムの問題として片付けるのではなく、チームみらい自身の課題として真摯に受け止め、決して長期間放置することなく、速やかに状況を調査し、判明した事実、原因、影響、具体的な対策、『いどばたシステム』自体の必要な修正、および再発防止策について、誠実に情報を公開し、皆様への説明責任を果たすことをお約束します。これがテクノロジーの活用やデジタル民主主義をうたうチームみらいの説明責任や政策実現への実践です。
システム利用に関する問題のご報告やお問い合わせは、[チームみらい公式サイト](https://team-mir.ai/)に設置されている問い合わせ窓口よりご連絡ください。いただいたお問い合わせには、チームみらいが責任をもって内容を確認し、自動返信ではない形で、可能な限り迅速かつ誠実に対応いたします。さらに、システム上のトラブルに関しては、チームみらい公式サイト上にて、ご報告いただいた発生トラブルの内容、判明した原因、およびチームみらいとしての対応状況や結果について、必ず情報を公開し、透明性の確保に努めます。