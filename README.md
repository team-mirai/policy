...
ようこそ！　ここはチームみらいの公約（マニフェスト）を、みんなでオープンに話し合って、もっとよくしていくためのページ（オープンソースレポジトリ）です。このマニフェストは、子育て世代や若者だけでなく、高齢者を含むすべての世代の人々が安心して暮らせる社会の実現を目指し、作成されています。ここでは、だれでも自由にアイデアを出したり、修正の提案をすることができます。
