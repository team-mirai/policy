...
国や自治体が行う補助金、無償化、給付金について、その予算額、支出先、委託・再委託の状況、最終的な使途に至るまで、誰もが容易に確認できるよう情報を徹底公開します。さらに、公開された情報については、第三者機関として複数の公認会計士が調査・検証し、その結果を市民に分かりやすく解説・報告する仕組みを構築します。これにより、税金の使途を明確化し、不正や無駄遣いを根絶するとともに、真に必要な政策課題へ予算が確実に配分されることを目指し、市民による行政監視の実効性を高め、政治への関心を深めます。
