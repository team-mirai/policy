...
## 表現の自由について
日本のコンテンツが世界で評価される礎は、憲法で保障された表現の自由にあります。この自由な創作の土壌を守ることは極めて重要です。昨今見られる表現規制の動きは、日本のコンテンツ創造力を低下させる懸念があります。
一方で、インターネット上の不適切な広告など、表示方法に課題があるケースも見られます。 私たちは、表現そのものを規制するのではなく、成人向けコンテンツを含むサイトでの警告表示など、インターネット空間における「ゾーニング」によって対応すべきであると考えます。
これにより、子ども等を不適切なコンテンツから保護しつつ、創造者の表現の自由は最大限尊重されるべきです。チームみらいは、自由な創作活動を阻害しないルール作りを目指します。
