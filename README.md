...
ここでは、子育てを社会全体で支えるための一つのアプローチとして、「子育ての職業化」を提案します。これは、子育てが個人の努力や負担に偏る現状を変え、子育てそのものに経済的な価値を認め、社会的な仕事として位置づけることを目指すものです。

具体的な提案として、以下を検討します。

*   **多子世帯への経済的支援の拡充:** 4人以上のお子さんを養育する世帯に対し、月額8万円程度の経済的支援を行うことを提案します。これは、子育てに伴う経済的負担を軽減し、多子世帯が安心して子育てに取り組める環境を整備することを目的とします。支給方法としては、子育てを主に担う親（例えば母親）のマイナンバーに紐付けられた口座へ直接振り込むことで、子育てが社会的な役割・職業であることの認知促進を目指します。
*   **所得制限に関する段階的アプローチ:** まずは所得制限を設けずに本支援策を提案します。これにより、広く子育て世帯を支援する姿勢を示します。ただし、財源確保や公平性の観点から反対意見が強い場合には、妥協案として、例えば年収2000万円程度といった高所得者層への所得制限を設けることを検討します。この所得制限ラインは、社会全体の約1%に該当する層を目安としています。

この提案は、子育てがあたかも個人的な営みであるかのような風潮に疑問を呈し、次世代を育成するという重要な社会的役割を担う子育てに対し、より積極的な価値付けと支援を行うべきであるという考えに基づいています。出産数の増加への寄与や、子育てが社会的な仕事であるという認識の醸成も期待されます。
（この項目は赤塚浩明さんの提案に基づき作成されました。）