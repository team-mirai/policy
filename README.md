...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。チームみらいは、社会における多様な意見や価値観、すなわちプルラリティを重視し、政策議論に反映させていきます。その理念に基づき、私たちは性的指向にかかわらず全ての人の婚姻の平等を保障するため、同性婚の法制化を目指します。
