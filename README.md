...
* **個人情報保護と透明性の原則**：プッシュ型支援など、行政サービスをデジタル化する際には、プライバシー保護を最優先します。不正アクセスを防ぐ強固なセキュリティ対策に加え、行政職員が必要な情報にのみアクセスできるようアクセス権限を厳格に管理します。また、誰がいつ、どの情報にアクセスしたかの記録を本人自身がいつでも確認できる仕組みを導入し、不正の牽制と透明性の確保を徹底します。
