...
現在の民主主義社会では、政治・政策に関する情報が高度に複雑化し、多くの市民が「何が問題で、誰が何を主張しているのか」を把握しにくい状況にあります。膨大な議会答弁やマニフェスト、専門用語に溢れた資料は、関心を持つ市民ですらアクセス困難です。

この「情報格差」は、民主主義の本質である「主権者の判断」を曇らせ、結果として政治参加の分断を招いています。

そこで私たちは、「いどばたシステム」にAIによる自動整理・要約機能を統合し、政策議論を論点ごとに構造化・可視化する新たな試みを進めています。これにより、専門家だけでなく、学生・高齢者・忙しい市民など誰もが「いま何が議論されているのか」「どんな立場があるのか」を一目で把握できる仕組みを提供します。

この仕組みは、まさに現代型の**参加型デジタル民主主義のインフラ**となるものです。技術に詳しくなくても、社会課題に関心を持つすべての人が議論にアクセスし、共に考えることができる。そんな未来のために、「AI×構造化」で政治を“読む力”を社会全体に取り戻します。
