...
* [ステップ２「変化に対応できる、しなやかな仕組みづくり」](20_ステップ２「変化に対応できるしなやかな仕組みづくり」.md)  
  ...
  * [３．産業・インフラ](23_ステップ２産業.md)
    * 建設業のＤＸ（デジタル・トランスフォーメーション）を推進。i-Construction、BIM/CIMの導入を強力に支援します。
    * 高等専門学校などでのITと土木の融合分野（社会工学）の創設を後押しし、分野横断的な人材を育成します。
    * IT人材と建設業界のマッチングを促進する仕組みを構築します。
    * 戦略的な社会資本整備を通じて、地方の活性化を図ります。
  * [４．医療](24_ステップ２医療.md)
