...
チームみらいは、誰もが自分らしい生き方を選択できる、多様性に満ちた社会の実現を強く目指します。「誰も取り残さない」という理念に基づき、個人の尊厳と人権を尊重する政策を推進します。

具体的な取り組みとして、以下の実現を目標とします。

*   **選択的夫婦別姓の導入:** 結婚後も、それぞれのアイデンティティやキャリアを尊重し、夫婦が望む姓を選択できる制度を導入します。
*   **同性婚の法制化:** 性自認や性的指向にかかわらず、すべての人が平等に婚姻の権利を享受できるよう、法整備を進めます。
