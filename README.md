...
* [選択的夫婦別姓制度の導入](#選択的夫婦別姓制度を導入し多様な生き方を尊重します)
* [公共トイレのあり方の見直し](#公共トイレのあり方を見直し誰もが安心して利用できる環境を整備します)

## 選択的夫婦別姓制度を導入し、多様な生き方を尊重します

個人の自由と多様性を尊重するため、結婚後も夫婦がそれぞれの姓を名乗ることを認める「選択的夫婦別姓制度」を導入します。

1.  **個人のアイデンティティを尊重:** 結婚によって姓を変えるか否かを自由に選択できることで、個人のアイデンティティや、姓に込められた家族の想いを大切にできる社会を目指します。
2.  **キャリアの継続性を守る:** 姓の変更がキャリアや学術的な業績に与える不利益を防ぎます。
3.  **男女間の不公平を是正:** 現在、改姓の負担が女性に偏っている状況を解消し、より公平な社会を実現します。
4.  **国際標準との調和:** 夫婦同姓を義務付けている数少ない国という現状を改め、国際社会と協調します。

## 公共トイレのあり方を見直し、誰もが安心して利用できる環境を整備します

私たちが本マニフェストで目指すのは、誰もが安心して使える公共空間の実現です。ジェンダーレストイレの導入は、多様性への配慮という意味では重要な試みでした。しかし現実には、プライバシーや安心感が十分に守られていないとの声が多く、特に女性や性的被害の経験を持つ方々にとって心理的なハードルとなっています。

私たちは「廃止」をゴールとするのではなく、すべての利用者にとってより良い代替案──すなわち、完全個室型のユニバーサルトイレや多目的トイレの整備を進めることで、安心・安全・多様性を調和させた空間の設計を提案します。
...
[安ノたかひろ公式YouTube](https://www.youtube.com/@%E5%AE%89%E9%87%8E%E8%B2%B4%E5%8D%9A)
