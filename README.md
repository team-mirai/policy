...
　なお、多くの有権者にとってより読みやすい形のマニフェスト v1.0 は6月中旬に公開予定です。すべての変更履歴は、この共同作業の場（GitHub）で公開され、誰でも確認できます。また、特に大きな政策変更が生じた場合には、その理由や背景を丁寧に説明し、過去のバージョンも参照できるようアーカイブする予定です。
