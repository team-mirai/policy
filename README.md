...
新型コロナウイルスは依然として流行しており、医療機関への負荷が懸念されます。誰もが安心して予防接種を受けられるよう、以下の助成を提案します。

- **現役世代への助成**：高額なワクチン費用（約16,000円）が接種の障壁となっています。自己負担額を5,000円〜10,000円程度に抑えることで、働きながら社会を支える世代の接種を促進します。
- **小児への助成**：子育て世帯の経済的負担は特に大きく、複数回の接種が必要な場合は数万円にもなります。小児のワクチン接種は原則無料、またはインフルエンザワクチン（3,000〜4,000円）と同程度の自己負担とします。また、小児への接種が可能な医療機関が少ないという課題にも取り組み、接種体制を拡充します。
