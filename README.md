...
また、塚本豊様からは、「ステップ２：変化に対応できる、しなやかな仕組みづくり」の具体策として、「人間社会シミュレータ」の活用について更なるご提案を頂いています。このシミュレータは、個人のAIエージェントが様々な選択肢をシミュレーションし未来を予見することで、個人が最適な選択を行えるように支援するものです。また、社会全体の動きを把握するためのペルソナAIと、個々人の行動を模したパーソナルAIで構成されるとのことです。特にパーソナルAIは、シミュレーションを通じて未来を予習し、その結果を本人が活用することで、より高いパフォーマンスのサポートが期待できるという副次的効果もあるとのことです。このような先端技術の民主的な活用も視野に入れ、政策を検討していきます。
