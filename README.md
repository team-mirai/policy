...
ようこそ！　ここはチームみらいの公約（マニフェスト）を、みんなでオープンに話し合って、もっとよくしていくためのページ（オープンソースレポジトリ（注：誰でも自由に閲覧、改善提案ができる文書等の保管場所））です。ここでは、だれでも自由にアイデアを出したり、修正の提案をすることができます。
...
* （玄人向け）[GitHub](https://github.com/team-mirai/policy/pulls)（注：プログラム開発で使われるウェブサービス）でPull Request（注：変更内容を提案する機能）を提出する
