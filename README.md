...
私たちは、有権者が候補者を多角的に理解し、より適切な判断を下せるよう、情報開示のあり方を追求します。その一つとして、候補者の現在の知識や能力を客観的に示すため、第三者機関が実施する試験（例えば、公務員試験や大学入学共通テストのような、広範な基礎学力や一般的な知識・理解力を測るものを想定しています）の結果を開示することを提案します。これは足切りを目的とするものではなく、あくまで有権者の方々への判断材料を増やすためのものです。このような客観的で定量的な指標を開示することは、憲法で保障された参政権に基づき、有権者がより適切な投票を行う上で非常に有益であると考えます。
