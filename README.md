...
## 【現在検討中の新しい提案】公職選挙の候補者の経歴透明化

有権者が候補者を正しく判断する材料を提供し、政治への信頼を回復するため、経歴の透明性を高める仕組みを導入します。

*   **最終学歴証明書の任意提出と公開**
    選挙の立候補者は、最終学歴の証明書のPDFデータを提出することができます。選挙管理委員会は提出されたPDFをウェブサイトで公開します。
*   **提出の有無を公表**
    証明書を提出しないことも自由ですが、提出の有無は選挙管理委員会によって公表されます。これにより、有権者はその事実を判断材料の一つとすることができます。
*   **自治体のIT対応促進と柔軟な運用**
    この仕組みは、全自治体の選挙管理委員会におけるIT対応を促進する効果も期待できます。小規模な自治体の負担を考慮し、近隣自治体との共同対応や、都道府県単位での広域連携など、柔軟な運用を可能とします。
