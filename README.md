...
また、チームみらいは以下の点にも留意して活動します。
* 個別の政策だけでなく、マニフェスト全体の関連性や優先順位について、活動報告会やオンライン説明会などを通じて定期的に説明する機会を設けます。
* 政党交付金を含む政治資金の使途については、法令を遵守するだけでなく、国民の皆様にご理解いただけるよう、高い透明性をもって公開する方針です。
