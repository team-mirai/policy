...
　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマనిフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。今後、特にデジタル時代の表現の自由を守り、アニメ、漫画、ゲーム等の文化への不当な規制に反対する政策を検討します。また、医療制度については、現行制度の維持を求めるご意見もいただいており、引き続き多様な視点から議論を深めていきます。
