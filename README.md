...
### （提案中）発達障害のある子どもたちへの支援
発達障害のある子どもが切れ目なく支援を受けられるよう、就学後の放課後等デイサービスの利用料負担を軽減する。
...
* **Aoiさんからのご提案（検討中）:** 発達障害のある子どもたちが切れ目なく支援を受けられるよう、就学後の放課後等デイサービスの利用料負担を軽減する。このご提案は「ステップ１」の「２．子育て」に関連するものです。
