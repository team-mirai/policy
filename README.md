...
日本社会で外国籍の方々が安心して暮らせる、また、日本国民も安心して外国籍の方々を迎え入れられる社会を実現するため、以下の制度を導入します。

1.  **受入時のルール明確化と多角的な審査**
    *   入国を希望する方には、職務遂行に支障のない程度の日本語能力（日常会話レベルを目安）を求めます。
    *   あわせて、筆記試験や面接、グループでの行動観察などを通じ、日本の文化やルール、マナーへの理解と適応しようとする姿勢を確認します。これは、一方的に評価するのではなく、相互理解を深める機会とします。

2.  **社会適応を支援する「マナー講習」制度の創設**
    *   審査の結果、適応に不安があると判断された「保留」の方を対象に、日本での生活マナー全般（ゴミの分別、交通ルール、地域の慣習など）を学ぶ講習を実施します。
    *   この講習は、国が企業の立ち上げを支援し、民間の専門機関が運営します。日本人講師に加え、日本社会で活躍する先輩移住者にも講師として参加してもらうことで、実践的な知識の習得と、国内の雇用創出を目指します。

3.  **継続的なサポートと交流**
    *   入国後も、年に一度の面談やマナー講習の再受講の機会を設けることで、継続的なサポートを行います。
    *   また、ゴミの分別方法や地域のルールなど、日常生活で生じるささいな疑問に24時間対応できるAIチャットボットを開発・提供し、日本でのスムーズな生活を支援します。

4.  **法の厳格かつ公正な適用**
    *   国籍を問わず、すべての居住者に対して日本の法律を厳格かつ公正に適用します。
    *   社会の安全を脅かす行為に対しては、法の下の平等と適正手続きを遵守しつつ、毅然とした対応を取ります。
    *   また、法執行のプロセスにおける透明性を高め、国民の司法への信頼を確保します。
