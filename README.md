...
実際に、この『いどばた』での対話を通じて、以下のような政策案が生まれ、マニフェストに追記されました。これは、みなさんのご意見が政策をより良くしていくことを示す、素晴らしい実例です。

*   **個人の日々の健康努力が報われる、新しい医療負担の仕組みを導入する**：健康診断の受診や運動習慣など、自らの健康増進に努める人が報われるような、公平で納得感のある医療制度を目指します。（匿名ユーザーからの提案）
*   **オンライン診療と対面診療のスムーズな連携体制を構築する**：オンライン診療の利便性を高めつつ、必要に応じて対面診療へスムーズに移行できるよう、地域の医療機関との情報連携を強化します。（匿名ユーザーからの提案）
...
　頂いた変更提案は、チームみらいが責任をもって確認します。変更提案をマニフェстに反映させるかどうかについては、チームみらいが権限を持ちます。当初マニフェストとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。
