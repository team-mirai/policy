...
### 福祉分野：官民連携による「知る機会」の格差解消
あなたがもし、自分や家族のことで深く悩んで行政の窓口を訪れたとき、本当に役立つ民間の素晴らしいサービスがあるのに「営利だから」という理由で教えてもらえなかったとしたら、どう感じるでしょうか？

現在、このような「制度の壁」によって、本当に支援を必要とする方々へ情報が届かないという課題が起きています。例えば医療的ケア児のご家族は、自ら必死で情報を探し、やっとの思いで支援に繋がっているのが実情です。

これは決して他人事ではありません。チームみらいは、行政が良質な民間サービスを適切に評価・認証し、公的な窓口で積極的に情報提供できる仕組みを推進します。官民の連携で、誰もが最適な支援を選べる社会を目指します。

## 【チームみらいの約束】誰にでも伝わる、優しい情報発信

私たちは、情報発信において、誰一人取り残さないことを約束します。PCやインターネットが苦手な方々にも私たちの考えがしっかりと伝わるよう、ネットだけでなく、地域での対話や紙媒体などの「アナログ」な手段も大切にします。

また、「ソーシャルディスタンス」のような横文字や専門用語を使う際には、必ず分かりやすい言葉で説明を添えるなど、誰もが理解できる優しいコミュニケーションを徹底します。これも、チームみらいが目指す政策の重要な一部です。

## このマニフェスト自身も、みんなの知恵を集めて改善していきます

　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマниフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。
