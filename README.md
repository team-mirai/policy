...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * [７．医療](17_ステップ１医療.md)
  * [８．福祉](18_ステップ１福祉.md)
    * 障害年金の申請から原則1ヶ月以内に受給可否の判断がなされるよう、審査プロセスを抜本的に見直します。マイナンバーを活用した情報連携により、初診日証明をはじめとする提出書類を大幅に削減し、申請者の負担を軽減します。
* [ステップ２「変化に対応できる、しなやかな仕組みづくり」](20_ステップ２「変化に対応できるしなやかな仕組みづくり」.md)  
  ...
  * [５．福祉](25_ステップ２福祉.md)
    * 障害年金の複雑な給付体系を見直し、誰もが理解しやすく公平な制度へと刷新します。
* [ステップ３「長期の成長に大胆に投資する」](30_ステップ３「長期の成長に大胆に投資する」.md)  
  ...
  * [７．医療](37_ステップ３医療.md)
  * [８．福祉](38_ステップ３福祉.md) 
    * 障害のある方が安心して暮らせる社会を実現するため、障害年金の給付水準を引き上げます。
