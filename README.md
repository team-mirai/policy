...
　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。

皆さまからいただいたご意見は、積極的にマニフェストに反映させていきます。例えば、行政の予算編成の仕組みについて、「日本産の優れた民間プラットフォームを政府の適切な管理のもとで活用し、効率化とセキュリティ向上を両立させるべき」といった具体的なアイデアもいただいており、今後「くらしと行政」の項目で反映を検討していきます。
