...
　また、SNSプラットフォームのあり方についても重要な論点として議論を進めています。例えば、プラットフォームの独占状態を見直し、利用者が自身のデータを他のサービスへ円滑に移行できる仕組み（データポータビリティ）を整備することで、より健全な情報空間の実現を目指すといった視点です。こうした論点も「その他重要分野についての政策・ビジョン」の中で今後具体化していくことを検討します。
