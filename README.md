...
## 現在議論中の主要な改善案（いどばたでの対話より）

*   **医療従事者の処遇改善について（さどさんからのご提案）**
    *   物価高騰に対応するため、医療機関の直近の購入実績に基づき、高騰した医療材料費を補填する補助金制度を創設する。その際、AIを活用して不正受給を防止する仕組みも合わせて導入する。
    *   診療報酬改定のプロセスを透明化し、物価や賃金の動向を適切に反映させることで、医療現場の報酬が不当に引き下げられることを防ぎ、安定的な経営を支援する。
*   **介護従事者の処遇改善について（さどさんからのご提案）**
    *   介護サービス事業者の経営を安定させるため、物価高騰に対応した補助金制度を新設します。施設サービスには高騰した物品費や食費を、訪問サービスにはガソリン代などの交通費を、それぞれのサービス種別や実績に応じて補助します。
    *   在宅生活の継続を支える訪問系サービスが、持続可能で質の高いサービスを提供できるよう、介護報酬を重点的に引き上げます。これにより事業の安定化と人材確保を促進し、施設サービスとの報酬格差を是正します。
