...
国防、産業・経済安全保障、学術研究、皇族や政治家など重要人物の生命保全を目的としたスパイ防止法を制定します。

*   **規制対象:**
    *   外国のエージェント（国籍を問わない）
    *   内乱を企図・準備する日本国民
*   **プライバシー・人権への配慮:**
    *   捜査の取り調べは、透明性を確保するため動画録画を義務付け、長期間の拘束を禁止します。
    *   容疑者の翻訳権を保障するため、通訳を準備します。
    *   無実が証明された場合、謝罪と共に収集した個人情報は完全に削除します。
    *   捜査情報の無断での複製や外部持ち出しを固く禁じ、情報流出を防ぎます。
*   **産業・経済安全保障の対象:**
    *   ビジネス情報や技術アイデア、動植物の遺伝子情報などが、不正な目的で国外に持ち出されることを防ぎます。
*   **段階的な運用:**
    *   まずは上記の範囲に限定して法案成立を目指し、運用上の課題をみながら段階的に見直しを行います。
