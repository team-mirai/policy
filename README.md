...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。科学技術が社会に与える影響を多角的に評価し、倫理的な課題に対応するため、人文・社会科学との連携を強化します。これにより、技術の発展が真に豊かな社会の実現につながるよう導きます。
