...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。また、多様な家族の形や働き方を尊重し、経済的な理由だけで特定の生き方を強制されない社会を目指します。どのような経済状況や価値観を持つ家庭であっても、子育てにおける選択肢が実質的に保障される社会づくりを基本理念とします。
