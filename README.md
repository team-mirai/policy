...
学生が自らのキャリアパスをじっくりと考える時間を確保し、学業や社会貢献活動といった多様な経験を積めるよう、新卒一括採用のあり方を見直します。

**具体的な提案:**

1.  **秋採用の義務化:** 一定規模以上の企業に対し、翌年度入社の新卒学生を対象とした採用活動を秋にも実施することを義務付けます。これにより、就職活動の早期化・長期化を防ぎ、学生が腰を据えて様々な活動に取り組める環境を整えます。
2.  **休学経験者採用枠の設置義務化:** 大学等の在学中に休学を経験した学生を対象とした採用枠を設けることを企業に義務付けます。多様なバックグラウンドを持つ人材の採用を促進し、組織の活性化とイノベーション創出に繋げます。これは、個々の能力や個性を尊重し、生産性の高いインクルーシブな労働環境を構築するための重要な一歩となります。