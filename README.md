...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * [３．行政改革](13_ステップ１行政改革.md)  
    * 障害年金の支給決定プロセスにおいて、診断書の標準化を進めます。あわせて、オンライン申請だけでなく、訪問や窓口など、誰もが利用しやすい多様な申請方法を整備し、デジタル技術でこれらの手続きを支援します。さらに、医師への症状伝達や審査プロセスに、AIを活用した全国統一のアンケート形式を導入することで、客観的で公平な支給決定を目指します。また、支給に至らなかったケースのデータを収集・分析し、年金とは異なる形で必要な支援やサービスを受けられる仕組みづくりも検討します。
  * [４．産業](14_ステップ１産業.md)  
