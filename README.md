...
## ジェンダーと多様性に関する基本方針（hoshiさんご提案）

チームみらいは、あらゆる人の尊厳と安全が守られる社会を目指します。その観点から、ジェンダーと多様性に関して以下の基本方針を提案します。

### 慎重な性別移行プロセス
身体への侵襲性を伴う性別転換手術については、本人の長期的な幸福を第一に考え、発達障害の傾向など、他の困難を抱えていないかを確認する多角的な除外診断を含め、慎重な審査プロセスを導入します。これは、不可逆的な選択を後悔することのないよう、十分な支援体制を構築するためです。

### ジェンダーロールの解体と社会的支援
性別によって生きづらさを感じる根本原因の一つに、旧来の固定的なジェンダー観や社会的な男女の不均衡があります。チームみらいは、こうした「ジェンダーロール」を社会全体で解体していくことを目指します。教育やメディア、職場など、あらゆる場面で性別による役割の押し付けをなくし、誰もが自分らしく生きられる社会を推進します。

### 安心・安全な空間の再設計
すべての人が安心して利用できる公共スペースを実現するため、以下の空間設計を推進します。

*   **女性スペースの維持・確保:** 生得的女性が安心して利用できるスペース（トイレ、更衣室、浴場など）は、引き続きその安全性を確保します。
*   **ユニバーサルスペースの設置促進:** 性別や年齢、障害の有無に関わらず誰もが利用できる、プライバシーが確保された「ユニバーサルスペース（誰でもトイレ、ユニバーサル更衣室など）」の設置を公共施設や民間施設に促進します。これらのスペースは、異性の介助が必要な方や、異性の子どもを連れた保護者にとっても有用です。設置にあたっては、盗撮などの犯罪を防ぐための十分な防犯対策と定期的な点検を義務付けます。
*   **男性用トイレのプライバシー向上:** 男性のプライバシー意識の高まりにも応えるため、男性用トイレの個室化を推進します。
