...
- **提案内容:** 「くらしと行政」STEP2の4番目の項目「ルールも行政情報も、"使える公共財"へ変革します」を、「専門家支援で共通インターフェースを整備し、ルールも行政情報も"使える公共財"へ変革します」に変更する。
- **提案理由:** 実務に追われる現場では新しい「インターフェース」の標準を考える余裕がないため、専門家が支援に入り、行政と民間が両方使える共通の形式を作ることで、デジタル化が遅れている分野にも新しい技術が入っていく突破口にすることができる。
