...
### 【くらしと行政】電動キックボード等の新たなモビリティに関する安全対策

近年、電動キックボードなどの新たなモビリティが普及する一方、交通事故の増加が懸念されており、特に子どもの安全確保は喫緊の課題です。そこで、テクノロジーの利便性を活かしつつ、以下の安全対策を推進します。

*   **エリア制限:** 通学路や保育園・幼稚園、小学校周辺での利用を禁止し、当面はビジネスエリアなどに利用を限定します。
*   **免許制度とヘルメット着用義務化:** 安全な利用に必要な知識を証明する免許制度を導入し、ヘルメットの着用を義務化します。
*   **罰則強化:** 危険行為には、自動車と同様に減点制度などを導入し、ルールの実効性を高めます。
