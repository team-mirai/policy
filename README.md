...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。私たちの目的は、AIに政治を任せることではありません。むしろ、テクノロジーを活用して、これまで政治の声が届きにくかった人々の意見を丁寧に聞き、一人ひとりに寄り添った政策を実現することです。
