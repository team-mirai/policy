...
## 歴史への誠実な向き合いと未来への責任
私たちは、過去の歴史と誠実に向き合い、その教訓を未来に活かします。特に、明治維新から敗戦に至る歴史の光と影を深く学び、二度と過ちを繰り返さないという決意を政策の根幹に据えます。
...
政策内容の変更以外のPR（例：タイポ修正、フォーマット調整、ドキュメント更新など）でX通知を避けたい場合は、PRに `skip-notification` ラベルを付けることで通知をスキ ' ' ムできます。
