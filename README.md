...
**現在、みなさまからいただいたご意見を元に、以下のような改善を検討しています。**
*   **（株式会社想ひ人様ご提案）分野横断的な公的サービス検索システムの構築：** 年齢、所得、障害等級などの個人の状況に応じて、利用可能な公的サービス（介護、福祉、医療等）を、国、都道府県、市区町村といった提供主体を横断して検索できるシステムを、国の共通データ基盤のもとで開発します。
