...
### 科学技術分野の強化
科学技術予算を拡充し、特に、すぐに成果が出にくい基礎研究への支援を大幅に強化します。研究テーマの採択においては、短期的な成果よりも独創性や将来性を重視する評価制度を導入します。また、一度採択された研究テーマに対しては、最低5〜10年間の継続的な支援を保証し、研究者が腰を据えて研究に打ち込める環境を整備します。
