...
*   **医療分野の予防医療強化について**
    *   新型コロナウイルスワクチンをはじめ、感染症の重症化リスクが高い方々（妊婦、基礎疾患をお持ちの方など）や子どもたちへのワクチン接種について、補助金や所得控除などの経済的支援を導入・拡充し、予防医療を強化します。特に子どもたちに関しては、感染による発達への影響も懸念されるため、接種機会の確保を徹底します。
