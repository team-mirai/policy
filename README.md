...
## 【ご提案】国による無料タイムスタンプ基盤の整備

電子帳簿保存法などで求められるタイムスタンプは、その手間と費用が負担となり、かえって社会のDXを遅らせる一因になっています。

そこで、国が主体となり、誰もが無料で使えるタイムスタンプ基盤を「公共インフラ」として整備・提供します。これにより、行政手続きの効率化や、民間での電子契約を後押しし、社会全体のDXを一気に加速させます。
