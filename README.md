...
## 生活保障制度の改革：公正で信頼できるセーフティネットの構築
「働いたら負け」という風潮を許さず、納税者が不公平感を抱かない、公正で信頼できる生活保障制度を構築します。その実現のため、主に以下の2点を推進します。

*   **AI・デジタル技術による個々人に最適化した支援と不正防止:**
    AI診断で個々の状況を正確に把握。「就労可能な方」には手厚い自立支援で社会復帰を促し、「真に支援が必要な方」には適切な医療・生活支援を届けます。マイナンバー連携も徹底し、不正受給を根絶します。

*   **外国籍の方への給付の厳格化:**
    入国管理局との連携を密にし、給付基準を厳格に適用することで、制度の公平性を保ちます。

これらの改革を通じ、万が一の時に国民が安心して頼れる、持続可能なセーフティネットを目指します。
...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。チームみらいは、挑戦する人々を支え、失敗からの再挑戦を積極的に応援する社会を目指します。
