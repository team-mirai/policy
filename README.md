...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。2025年の参議院選挙では、比例代表の選択肢となることができません。チームみらいから立候補する候補者への投票をお願いし、ゆくゆくは国政政党を目指し、政策実現に邁進します。
