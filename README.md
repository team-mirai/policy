...
私たちは、誰もが情報にアクセスしやすい社会を目指し、ウェブアクセシビリティの確保に努めます。具体的には、スクリーンリーダーへの対応を考慮し、ウェブサイトのJIS規格（JIS X 8341-3）への準拠を目指すとともに、政策の内容を動画や音声、ルビ付きの「やさしい日本語」など、多様な形式で発信していきます。
