...
　直近の改善案として、ゆうはるさんより、「柔軟でありながら、悪意のある攻撃者には厳しい法制度」の必要性についてご意見をいただきました。これを受け、「新しい技術の社会実装を加速するため、サンドボックス制度（新しい技術やサービスを試行できる制度）を拡充します。同時に、サイバー攻撃などの不正行為に対しては、国際社会と連携し、断固たる姿勢で臨む法整備を進めます。」というアイデアをマニフェストに加えることを検討しています。
