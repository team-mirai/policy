...
## フェイクニュース・偽情報への対策
悪意ある偽情報から民主主義を守り、誰もが安心して情報を得られる社会を目指します。その際、表現の自由を不当に制約することのないよう慎重な制度設計を行います。具体的には、プラットフォーム事業者の自主的な取り組みの促進、公的機関によるファクトチェック機能の強化、幅広い世代へのメディアリテラシー教育を推進します。
