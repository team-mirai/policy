...
みなさまから頂いたご意見を元に、以下のテーマについてマニフェストへの追加を検討しています。

*   **「年収の壁」問題の解消:** 意欲ある人が就労調整を意識せず働けるよう、「103万円の壁」に代表される制度上の課題解決を目指します。具体的には、壁の金額引き上げや、収入増に応じて負担がなだらかに増える仕組みの導入などを検討します。
