...
深刻化する高齢者単身世帯の増加と、介護施設の待機問題に対応するため、高齢者が住み慣れた自宅で安全に暮らし続けられるための支援策を講じます。

**自宅リフォーム助成制度の創設**

介護保険の認定を受けている高齢者や、そのご家族を対象に、自宅のバリアフリー化や安全対策のためのリフォーム費用を助成する制度を創設します。
...
*   **助成内容**
    *   要介護度や本人の所得・資産状況に応じて、助成額や助成率を段階的に設定します。
*   **介護者の負担軽減**
    *   高齢の親族を介護する家族の負担を軽減するため、助成金は介護を担う方に直接支給することも可能とします。
    *   申請手続きの透明性を確保し、不正受給を防止するため、工事の明細書や領収書の提出を義務付けます。
