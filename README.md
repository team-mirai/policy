...
　また、私たちは、特定のライフスタイル（例えば、結婚しているか、子どもがいるか、独身であるかなど）によって不当な不利益を被ることがないよう、公平な税制や社会制度の実現を目指します。子育て支援などの重要な政策を進める上でも、特定の立場の方々に負担を強いるのではなく、社会全体で支え合うという考え方を基本とします。
