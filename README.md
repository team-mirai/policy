...
本マニフェストの議論を進める中で、特に重要な政策の解釈について、以下の通り明確化します。

### 専守防衛の定義について

「[その他重要分野についての政策・ビジョン](50_国政のその他重要分野.md)」で掲げる専守防衛の原則について、その解釈を明確化します。

我々は、日本国憲法の平和主義に基づき専守防衛を堅持します。ここで言う専守防衛には、我が国への武力攻撃が発生した場合に国民の命と平和を守るため、必要最小限度の措置として、相手国のミサイル発射拠点等を攻撃するための、非核兵器による反撃能力を保有し、行使することを含みます。ただし、先制攻撃は一切認めません。
...
* **デジタル化の負の側面への配慮**：デジタル化を推進する際には、諸外国の事例にみられる学習意欲の低下など、負の側面にも十分配慮し、実証と対話を通じて慎重に進めます。
