...
チームみらいは、障害者福祉分野における政策立案において、当事者の声をより実効性の高い形で反映するため、以下のプロセスを導入します。

1.  各障害分野・団体から提出された要望書を収集し、データベース化します。
2.  AI技術を活用し、収集した要望内容の要点抽出、分類、重複整理を行います。
3.  AIによる整理・要約結果を、人間の目で確認し、必要に応じて修正や調整を加えます。これにより、元の要望のニュアンスや重要性が失われることを防ぎます。
4.  上記プロセスで整理・要約された内容を、マニフェスト（公約）のたたき台として公開します。その際、参考とした団体名を明示し、透明性を確保します。
5.  チームみらいのボランティア参加者による議論・意見交換の場を設け、広く意見を求めます。
6.  得られた意見や合意事項を反映し、最終的な障害者福祉政策・公約として明文化します。

このプロセスを通じて、既存のシステムや当事者の声を最大限に尊重し、実効性の高い障害者福祉政策を効率的に策定することを目指します。
