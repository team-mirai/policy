...
## 【匿名ユーザーからの提案】選択的複合姓（ダブルネーム）制度の導入

多様化する家族のあり方と個人の生き方を尊重するため、新たな選択肢として**選択的複合姓（ダブルネーム）制度**の導入を検討します。これは、夫婦別姓のメリットを取り入れつつ、家族の一体感を維持したいという声にも応える折衷案です。

*   **制度の骨子**:
    *   婚姻時に、夫婦が望めば、それぞれの姓を結合した「複合姓」を選択可能とします。
    *   その間に生まれた子は、成人するまで親の複合姓を名乗ります（日常的に使用する姓は夫婦で選択）。
    *   子は成人に達した際、自らの意思で、公式な姓を一つ選択します。

*   **目的**:
    個人のアイデンティティを尊重し、キャリアの継続を容易にすると同時に、世代間の価値観のギャップに配慮し、急進的ではない漸進的な制度改革を目指すものです。
