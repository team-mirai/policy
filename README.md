...
*   **妊婦健診の負担軽減:** 現状、公費でカバーされる妊婦健診の検査項目は限定的です。実際には、多くの施設で推奨されている超音波検査やノンストレステスト（NST）などが自己負担となり、家計の大きな負担となっています。安心して子どもを産み、育てられる社会を実現するために、これらの検査も公費負担の対象に加えるべきです。
