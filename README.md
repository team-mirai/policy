...
　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。特に、人命をはじめとする不可逆的な要素が絡む政策分野においては、安易なトライアンドエラー方式は採用せず、慎重な検討プロセスを経ることとします。また、政策の具体化にあたっては、現場で担当している主任・係長級の方々への聞き取りを重視し、適切な科学的・論理的根拠を持つ専門家にも情報の確認を行います。
...
* **政策検討の透明性と内部告発者の保護**：政策検討の過程で得られた情報は、個人情報など対象者の保全に配慮した上で、たとえチームみらいの方針にそぐわない内容であったとしても、これを隠蔽することなく公開します。万が一、情報の隠蔽などが疑われる事態が発生した場合には、内部からの告発を歓迎し、その告発を行った者に対するいかなる不利益な取り扱いも禁止します。
