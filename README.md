...
ここでは、チームみらいが重要と認識しつつも、まずはマニフェストver.0.1で提示したステップ１～３の実現に注力する課題について触れます。これらの課題についても、皆様からのご意見を頂きながら、今後のバージョンで具体的な政策として検討を進めてまいります。
