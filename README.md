...
マーク自体には、登録開始年数と、貢献度を示す等級を記載します。貢献度は、国内材料の使用、障害者の雇用、被災地や公的機関への寄付などを評価します。これにより、長年の実績と継続的な品質・社会貢献への努力が可視化されます。一度認定が取り消された場合、再認定された際には最も低い等級から再スタートすることとし、継続的な品質保持へのインセンティブとします。
