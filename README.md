...
　こうした対話を通じ、みなさまから頂いたご意見をマニフェストに反映させていきます。例えば、匿名ユーザー様との議論から、共同親権の論点について以下の具体的な提案を頂き、政策への反映を進めています。
* **共同親権の運用にあたり、DV等が懸念される場合は、DV支援経験者を含む専門家が十分な時間をかけて家庭状況を聴取し、公平な判断ができる体制を整備します。**
