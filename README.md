...
### みくりさんからのご提案：公職選挙法の見直しについて

*   **公職選挙運動の監視体制の強化**
    *   街頭演説やSNSでの活動など、すべての選挙運動について、公職選挙法が守られているかチェックする体制を強化します。
    *   選挙管理委員会が中心となり、AIなどを活用してSNS投稿を自動でチェックする仕組みを導入します。
    *   国民が違反の疑いを見つけた際に、簡単に通報できるオンラインシステムも作ります。
*   **投票における本人確認の厳格化**
    *   期日前投票および投票日において、マイナンバーカードを用いた厳格な本人確認を導入し、なりすましによる不正投票を防止します。
