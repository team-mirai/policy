...
### 発達障害児を含む、すべての子供たちへの支援拡充

*   **放課後等デイサービスの利用機会確保と負担軽減:** 希望するすべての家庭が利用できるよう、サービスの供給量を増やすとともに、利用料補助を拡充し、家計への負担を軽減します。
*   **障がい児支援に関する所得制限の緩和:** 障害児福祉手当などの各種支援について、所得制限を緩和または撤廃し、必要な支援が必要な家庭に届くようにします。
