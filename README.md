...
小中高生にデバイスを配り、AIとの対話を通じて思考力を育む教育を推進します。答えに至るプロセスを重視し、生徒の探求心を育てます。この取り組みは、不登校の子供たちにとっても、個々のペースで学べる最適なツールとなり得ます。また、AI活用で教師の負担を軽減し、部活動の指導など、生徒と向き合う時間をより確保できる環境を整え、教育の質の向上を目指します。
