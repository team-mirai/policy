...
多様な在り方が尊重される社会を目指すと同時に、女性をはじめとするすべての人が、あらゆる場面で安心・安全を実感できる環境づくりを重視します。
...
政策内容の変更以外のPR（例：タイポ修正、フォーマット調整、ドキュメント更新など）でX通知を避けたい場合は、PRに `skip-notification` ラベルを付けることで通知をスキLskip-notification` ラベルを選択して追加
