...
### 地域子育て支援の質の向上と担い手の処遇改善

地域子育て支援拠点事業について、その重要性にも関わらず、担い手である職員の雇用が不安定であり、専門性を高める機会も限られているという課題が指摘されています。また、利用者にとっては、事業者の質によって当たり外れが大きいという現状があります。

これらの課題を解決するため、以下のような政策案を検討・議論しています。

*   **保育園のような認可制度の導入:**
    *   すぐに全てを認可制にするのではなく、利用実績、第三者による利用者評価、体系的な研修プログラムの実施状況などを基準とした、質の高い事業者を認定する仕組みを目指します。
*   **雇用の安定化と専門性向上:**
    *   認定制度と連動させ、職員のキャリアパスを明確化し、キャリアに応じた賃金体系を構築することで、雇用の安定と処遇の改善を図ります。これにより、性別に関わらず多様な人材が子育て支援の現場で活躍できる環境を整備します。
*   **利用者の声が届く仕組みづくり:**
    *   各施設に、利用者がいつでも匿名で意見や改善提案を伝えられる「デジタル提案箱」のような仕組みを導入します。
    *   寄せられた提案と、それに対する事業者の検討状況を公開することで、透明性を高め、利用者と事業者が協働してサービスを改善していく「共創」の関係を築きます。
