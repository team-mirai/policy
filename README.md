...
　なお、現在、同じような趣旨の提案が複数提出されることを防ぎ、論点を明確にするための仕組みを検討しています。例えば、いどばたシステム上でご意見をいただいた際に、AIが関連する既存の議論を提示したり、既存の意見との差分を抽出して新たな論点として議論に追加したりすることで、そちらで議論を深めていただくような形を想定しています。
