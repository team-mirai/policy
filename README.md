...
国立大学と私立大学が教育や研究で対等に競争できる基盤を整備するため、大学支援策の見直しを提案します。

具体的には、国立大学への運営費交付金を手厚くする場合、私立大学へも同等の支援を行うことを基本とします。支援対象の選定にあたっては、例えば、重点的な支援を受けている国立大学の数（約20校）を一つの基準とし、同数の私立大学（例：MARCH、関関同立レベル以上）にも手厚い補助を行うなど、大学の種別によらない公正な競争環境を目指す考え方が提案されています。
