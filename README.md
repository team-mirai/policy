...
養育費・婚姻費用の未払いは7割以上に及び、実効性のない調停や審判に時間と費用を浪費している現状があります。この問題の解決のため、養育費・婚姻費用債権の譲渡を可能にする法改正を提案します。

これにより、企業における売掛金債権の譲渡と同様の仕組みを導入し、回収率の向上と当事者の負担軽減を目指します。また、弁護士の新たな業務創出にも繋がります。

弁護士費用については、不払いを起こした側に全額請求可能とすることで、母子への負担を回避します。
