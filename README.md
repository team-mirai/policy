...
- 将来的には、ご自身のマニフェストを投稿・編集できる機能や、SNSのような追記・コメント機能、マニフェストの対応実績の公開機能を追加することを目指します。
- また、SNSいじめ、デマを防ぐため、ご自身のマニフェストの投稿・編集や、他者の意見へのコメントや実績評価など一部の機能には、マイナンバーや電話番号による本人確認の導入を検討し、誰もが安心して参加できる環境を整備します。
