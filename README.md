...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。同時に、個人の能力や努力が最大限評価される、自由な競争環境も重視します。複雑な税制度を抜本的に見直し、個人の挑戦と企業の成長を最大化する、シンプルで公正な仕組みを追求します。
