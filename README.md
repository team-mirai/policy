...
## 新たな提案：高齢者の運転能力に応じた免許制度への見直し

地域社会の安全確保と、高齢者の尊厳ある生活の両立は、日本が向き合うべき重要な課題です。加齢に伴う心身機能の変化が運転に影響を与えうるという現実を踏まえ、年齢で一律に判断するのではなく、個々の運転能力を客観的に評価し、安全を最優先する免許制度へと改革します。

### 課題：高まる事故リスクと、移動手段のジレンマ

判断能力や身体能力が低下したドライバーによる重大事故が社会問題となる一方、公共交通が不十分な地域では、自動車が生活に不可欠な移動手段となっています。画一的な年齢制限は、まだ安全に運転できる方の社会参加を妨げる恐れがあり、個人の状況に応じた丁寧な制度設計が求められています。

### 提案：客観的基準による更新制度の厳格化と、自主返納の促進策

個人の自己責任による備えを基本としつつ、社会全体の安全を守るため、以下の制度改革を提案します。

1.  **免許更新基準の段階的厳格化**
    一定年齢（例：75歳）以上のドライバーに対し、免許更新時の認知機能検査や運転技能検査の基準を、より客観的で厳格なものに更新します。科学的根拠に基づいた評価基準を用いることで、運転能力が不十分と判断されたドライバーの免許更新を厳正に判断し、事故を未然に防ぎます。

2.  **自主返納を後押しする社会の仕組みづくり**
    免許の自主返納は、個人の尊厳ある決断として尊重し、社会としてその選択を後押しします。返納者が移動に困窮し社会的に孤立することのないよう、自治体と連携し、デマンド型交通や公共交通の割引など、代替となる移動手段の確保・支援策をセットで講じます。
