...
　また、私たちはデジタル技術の活用を推進する一方で、デジタルに不慣れな方々が取り残されることのないよう、最大限の配慮を行います。このマニフェストについて議論するこの場所においても、専門用語を避け、誰もが理解できる言葉で対話を進めることを心がけます。デジタルの恩恵を、一部の人だけでなく、社会の隅々まで届けることこそが、私たちの目指す未来です。
