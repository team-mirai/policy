...
安全保障上の懸念や地域コミュニティへの影響を踏まえ、外国人による不動産取得には以下の制限を設けます。

1.  **利用目的と土地種類の制限:**
    *   不動産取得は、実態のある法人が事業目的で利用する場合に限定します。個人による居住目的の取得は認めません。
    *   使用目的が明確であり、投機的な転売や単なる保有のみを目的とした取得は認めません。
    *   国の安全保障や重要インフラ、水源地の保全、食料安全保障の観点から、水源地および農地の取得は禁止します。

2.  **透明性の確保と審査の厳格化:**
    *   法人による取得の際には、実質的支配者（UBO）の情報および資金源の完全な開示を義務付けます。
    *   提出された情報に基づき、国の安全保障に影響を与える可能性がないか厳格な審査を行います。

3.  **経済的措置:**
    *   上記の条件を満たして取得する場合でも、固定資産税などの関連税制において、通常より高い税率を適用します。

これらの政策により、日本の主権と国益を守りつつ、地域社会の健全な発展を促進します。
