...
　例えば、現在『いどばた』では、ひもQ様より「納税者が税金の一部使途を指定できる制度」という画期的なアイデアが提案され、議論が深まっています。このアイデアは、政治への参加意識を高める大きな可能性を秘めている一方で、所得層による影響力の差といった、民主主義の根幹に関わる慎重な設計が求められる論点も含まれています。チームみらいでは、このようなご提案も真摯に受け止め、様々な角度から検討を重ねて参ります。
