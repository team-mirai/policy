...
現在も、ひろみさんとの対話は、子育て支援から社会全体の健康問題、職場のコミュニケーションへと発展しました。さらに、これらの課題に対し、膨大なデータを個人の生活や企業活動にどう活かすか、そして、うまく機能しない仕組みを常に見直し改善していくフィードバックのサイクルの重要性についても、議論を広げています。
