...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * [４．産業](14_ステップ１産業.md)  
    * **林業政策の強化**: 持続可能な木材利用を推進するため、クリーンウッド法の実効性を高めます。
      * **監視体制の強化とコンプライアンス支援**: 国内外の監視を強化し、事業者が法令を遵守するための支援を充実させます。
      * **普及啓発と国産材の利用促進**: 合法で環境に配慮した木材の価値を国民に広く伝え、公共建築物等での利用を促進します。
      * **経済的インセンティブの導入**: ルールを守る事業者が報われるよう、補助金や税制優遇といった経済的な支援策を講じます。
