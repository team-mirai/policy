...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェトの政策を推進しています。そのために、国が一人一台のデジタル端末を提供することや、郵便局などを活用した無料相談窓口を設置することで、デジタルが苦手な方でも安心してテクノロジーを活用できる社会を目指します。
