...
### 高校「情報」科目の改革（石田智識さんより提案）
- **概要**: 高校の「情報」科目を「理論」と「実践」に分割し、実践の授業では生成AIなどの最新技術を扱います。
- **具体的な方法**:
  - 専門家によるオンライン・オンデマンド授業を活用し、教員と生徒が共に学習機会を得られるようにします。
  - 授業時間確保のため、現在の高校の「情報」の理論的な内容は、段階的に中学校の義務教育課程へ移行させます。
- **補足**: 移行期間や方法の詳細は、今後専門家を交えて慎重に検討する必要があります。
