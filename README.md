...
* [通信の安全確保とプライバシーの両立](#通信の安全確保とプライバシーの両立)

## 通信の安全確保とプライバシーの両立
国民が詐欺や迷惑行為から身を守れるよう、通信の安全性を抜本的に強化します。

*   AI等を活用した高度なフィルタリング技術を国が支援し、利用者が自己決定権に基づきセキュリティレベルを選択できる仕組み（セキュリティ選択制）を導入します。
*   過度なフィルタリングやプライバシー侵害を防ぐため、独立したAIによる監査機関を設置し、運用の透明性を確保します。
*   凶悪犯罪に繰り返し利用されるなど、明白なリスクが確認された通信サービスについては、専門家と市民からなる第三者委員会の判断に基づき、制限等の措置を検討します。
