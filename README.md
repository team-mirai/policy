...
産業構造の変化に対応するため、包括的なリスキリング支援を提案します。学びの機会（無料講座等）、経済的支援（生活費支援等）、キャリア支援（就職マッチング等）を一体で提供し、さらに「学び直し休業制度」も創設します。財源は、当面は雇用保険等を活用しつつ、将来的には「人材投資促進税」や官民の「共投資ファンド」の創設を目指します。
