...
　頂いた変更提案は、AIの支援も活用してマニフェストに反映されます。ただし、AIはあくまで議論や反映作業を補助する役割であり、すべての変更内容は、最終的にチームみらいのメンバーが責任をもって確認し、承認します。変更提案をマニフェストに正式に反映させるかどうかの最終的な権限は、チームみらいが持ちます。当初マニフェストとは異なる方向性の提案であっても、真剣に検討し、反映するかどうかを考えます。
