...
　今回、はるさんから頂いた以下のご提案も、まさしく皆さんとマニフェストを育てていく一例です。

> **区市町村をまたいだ子どもの送迎への支援**
> *   子育て世帯の負担を軽減するため、区市町村の境界を越えて利用できる、子どもの送迎支援サービス（日本版ライドシェアを含む）の活用を促進します。
> *   安全性と信頼性を確保するため、サービス提供事業者の登録要件を定め、運転者の身元確認の徹底、子どもの安全に関する研修の義務付け、車内カメラの設置などを求めます。
