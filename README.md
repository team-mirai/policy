...
* [産後クライシスを防ぎ、母親の心身の健康を守るための支援策](#産後クライシスを防ぎ母親の心身の健康を守るための支援策)
* [本マニフェスト掲載の政策に関する､財政支出の規模感と財源の考え](70_本マニフェスト掲載の政策に関する､財政支出の規模感と財源の考え.md)

## 産後クライシスを防ぎ、母親の心身の健康を守るための支援策

#### １．地域密着型・緊急育児サポート
*   **運営:** 自治体が責任を持って運営。
*   **内容:** 専門性に限らず、十分な研修を受けた地域スタッフが、アプリ等を通じて要請のあった家庭を訪問し、一時的に育児を代行します。これにより、母親は短時間の休息や外出が可能になります。
*   **仕組み:** 依頼者が近くのスタッフ情報を見て選べるマッチングシステムを導入します。

#### ２．「休む」を目的とした産後ケアの拡充
*   **課題:** 高価で数が少ない従来の「指導型」産後ケアは、本当に必要な「母親の休息」というニーズに応えきれていません。
*   **提案:** 母親がしっかり食事をとり、眠ることを最優先する「休息型」の産後ケアを推進します。
*   **実現方法:** 民間ホテルの空室等を活用し、専門スタッフを配置。既存の産後ケア助成をこうした施設でも利用できるよう制度を見直します。
