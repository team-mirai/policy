...
* **デジタル・インフラの利用に関する基本原則**：政府が利用する基幹的なデジタル・インフラは、特定の国や企業への過度な依存を避け、デジタル主権を確保する観点から、以下の原則に基づき選定・構築・運用します。
  1. **国産技術の育成と採用**: 基幹システムは可能な限り国内で開発・運用できる技術の育成を最優先します。
  2. **オープンソースの最大限の活用**: 透明性と安全性を確保するため、特定の企業に縛られないオープンソース・ソフトウェアを最大限活用します。
