...
## 多様な家族のあり方と法整備について
チームみらいは、選択的夫婦別姓などの家族制度に関する議論を進める際には、国民的な不安や懸念に丁寧に対応することを大前提とします。
特に、日本の社会基盤である**戸籍システムが制度変更によって混乱しないよう、整合性の確保と安定的な運用に万全を期す**とともに、**外国籍の方による制度の悪用などを防ぐための厳格な法的措置**を講じます。
