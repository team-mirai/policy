...
## 【ご提案】市民としての法的思考力を育む、主体的な法教育の推進

『昔話法廷』モデルの導入を通じて、子どもたちが受け身ではなく、自ら考える力を養う「主体的な法教育」を推進します。

*   **実例構成**
    1.  **物語選定：**『桃太郎』を題材に、鬼退治を“犯罪”と“正当防衛”の両面から検証。
    2.  **ロールプレイ：**児童が役割（検察・弁護・裁判官等）を担い、法廷形式で議論。
    3.  **問いかけ：**「罰するだけでなく、どう更生を支えるか？」といった問いで、刑罰の意義を学ぶ。
*   **教育的狙い**
    *   物語を通じて、法概念を体験的に理解する。
    *   既知のテーマから「再犯防止と更生のバランス」等の深い思考を促す。
