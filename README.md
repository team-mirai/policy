...
マニフェストは[こちら](https://policy.team-mir.ai/view/README.md)のページから見ることをおすすめします。いどばたシステムという熟議プラットフォームを活用しており、画面右下のチャットアイコンから、あなたの疑問に答えたり、変更提案を受け付けることも可能です。
...
### くらしと行政の改善
* **分野横断型の専門家チームによる総合相談窓口の設置:** いじめ、人権侵害、各種ハラスメント、育児ノイローゼやネグレクトといった複雑な課題に対し、ワンストップで対応します。法的・心理的専門知識を持つチームが強力な権限を持って迅速に対応する「総合相談窓口」を設置することにより、行政対応の遅延や「たらい回し」をなくし、一貫性のある専門的な支援を実現します。
...
* [こちら](https://policy.team-mir.ai/view/README.md)のページから、画面右下のチャットアイコンを使って政策要望を提出する  
