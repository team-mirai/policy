...
## 匿名ユーザー様からのご提案に基づく修正案

### 母子健康手帳の運用について

頂いたご意見を元に、母子健康手帳の運用に関する方針を以下のように定義します。

- **紙媒体の維持とアプリの併用:** 母子健康手帳は、災害時の信頼性や医療現場での混乱を避けるため、現行の紙媒体での運用を基本とします。これに加えて、保護者の利便性を高めるための支援アプリを開発し、希望者が任意で利用できる形とします。
- **通知方法の原則:** 各種健診などのお知らせは、スマートフォンを持たない方にも情報が届くよう、郵送を基本とします。アプリによるプッシュ通知は、利用希望者が選択した場合にのみ送られるようにします。
