...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。AIやデジタル技術は、不安や難しさを感じる方々にも、その恩恵が届くべきだと私たちは考えます。現場で働く方々の負担を減らし、誰もが新しいことを学べる機会を作ることで、テクノロジーが社会の分断ではなく、つながりを生む力になるよう、全力で取り組みます。
