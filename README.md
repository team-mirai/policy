...
---
## 【提案中の政策】ネット上の誹謗中傷対策を抜本的に強化します（匿名ユーザーさんからの提案）

SNSでの心ない言葉によって傷つく人をなくすため、デジタル技術を活用した誹謗中傷対策を早急に進めます。誰もが安心してインターネットを使える社会を目指し、以下の3つの柱で取り組みます。

### １．泣き寝入りさせない！迅速な加害者特定
現在の制度では、誹謗中傷の加害者を特定する手続きが複雑で時間がかかりすぎます。被害者が諦めてしまうことのないよう、手続きを大幅に簡素化し、スピードアップします。

- **ワンストップ電子申請システムの構築**: 裁判所やSNS事業者などをつなぐオンラインの仕組みを作り、情報開示の手続きをすべてオンラインで完結できるようにします。
- **手続きの標準化**: SNS事業者ごとに異なる対応を統一し、手続きがスムーズに進むようにします。
- **AIによる申請サポート**: 申請書類の作成などをAIが支援し、被害者や弁護士の負担を減らします。

### ２．弁護士にもっと気軽に相談できる社会へ
弁護士への相談は、費用や心理的な面でハードルが高いのが現状です。特に若い世代が一人で悩みを抱え込まないよう、支援を強化します。

- **弁護士マッチングプラットフォームの公的支援**: 誹謗中傷問題に詳しい弁護士と被害者をLINEなどで手軽につなぐサービスを、国が支援します。
- **費用補助制度の創設**: 経済的な理由で法的手段を諦めることがないよう、一定の所得以下の被害者に対し、国が弁護士費用の初期費用（例：10万円まで）を補助します。
- **SNS事業者による和解仲介制度**: SNS事業者が間に入ることで、当事者間の話し合いによる迅速な解決を促します。

### ３．社会全体で被害者を支える体制づくり
被害者の心のケアや、その後の生活再建まで、社会全体で支える仕組みが必要です。

- **被害者支援窓口の常設化**: 自治体単位で、心のケアから法的手続きの案内まで一括して相談できる窓口を設置します。
- **プラットフォームへの規制強化**: SNS事業者に対応義務を課し、より安全なプラットフォーム運営を促します。
- **対策技術の開発支援**: AIなどを活用した誹謗中傷の自動検知ツールの開発を、国が支援します。

*(この内容は現在議論中のものであり、今後「ステップ１ くらしと行政」の項目に統合される予定です。)*