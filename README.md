...
現在、匿名ユーザー様より、教育分野に関する以下のご提案をいただき、議論を進めています。
*   国外在住の子どもたちが、AIを活用して日本語や日本文化を学べる機会を作ります。
*   国内の多様な言語背景を持つ子どもたちのために、AI等で継承語や外国語の学習を支援します。また、その言語能力を大学受験などで評価する仕組みを作り、学習意欲と多文化への誇りを育みます。
