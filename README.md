...
けんけんさんより、「若手研究者や少額の研究プロジェクトに対し、予算を重点的に配分し、研究活動の継続を支援すること。また、物価上昇が研究費を圧迫することを防ぐため、インフレ指数に基づいた研究費の調整メカニズム導入を検討すること」とのご意見をいただきました。チームみらいとして、この貴重なご意見を参考に、マニフェストの改善を進めてまいります。
