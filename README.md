...
選択的夫婦別姓の導入に関して、以下のような慎重な意見が寄せられています。

*   導入を希望する人の具体的な数や、旧姓利用の拡大では不十分な理由が不明確
*   子供の姓をめぐる新たな対立の可能性や、帰化した方のルーツが見えにくくなる等のデメリット
*   「多様性」という言葉への不安と、デメリットを上回るメリットの証明の必要性

これらの貴重なご意見を踏まえ、今後このマニフェストで選択的夫婦別姓を議論する際は、データに基づき、これらの論点を一つ一つ丁寧に分析し、慎重に検討を進めていくことをここに明記します。
