...
　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。例えば、皆さんから寄せられた以下のようなご意見も、マニフェストの改善に活かしていきます。

*   **教育**: 社会で生きる上での最低限の知識として、税金、社会保険、労働基準法などを学校の一般教養科目として教える
*   **行政**: 税務署と労働局が連携し、事業主の労働保険加入を徹底する
