...
希望者に対しては、行政からの通知や民間の各種明細書（クレジット、光熱費など）を手軽に確認できる安価な機器（デジタル郵便受け）を配布または貸与します。この機器は、HDMI出力でテレビに接続して閲覧し、USB端子に接続したプリンタで印刷できる仕様とします。官民が連携し、誰もがデジタル化の恩恵を受けられるプラットフォームの構築を推進し、郵便物の削減と利便性の向上を目指します。
