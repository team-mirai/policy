...
　チームみらいは全てを決めた後にマニフェストを発表するのではなく、よりオープンにみなさんと一緒にマニフェストを育てていきたいと考えております。具体的には、AI熟議システムの『いどばた』や全国で開催するオフラインミーティング、独自に行う専門家へのインタビューなどを通じて、どんどん知恵を集めたいと思います。特に、デジタル技術の進展によって生まれている3DCGフィギュア制作のような新たな成長分野については、現場で活動する個人や事業者の皆様へのヒアリングを広く、かつ密に行い、実態に即した支援策を検討します。
