...
---
***現在、このマニフェストは皆さんのご意見をいただきながら、改善を進めています。以下は、そこうさんからいただいたご提案を元に作成した改善案の例です。***

**人に優しいデジタルで、福祉の届き方を変える**

*   **困っている人に、情報がきちんと届く仕組みづくり:**
    福祉を必要とするご家庭に、行政から一人ひとりの状況に合った支援情報を、分かりやすい言葉で直接お届けします。デジタルツールを活用し、知りたい情報がすぐに見つかるようにします。

*   **スマホで完結、かんたん申請:**
    マイナンバーカードを使って、福祉サービスの申請がスマートフォンで全て完結するようにします。役所の窓口に行かなくても、時間や場所を気にせず手続きができます。

*   **自治体の負担を軽くする工夫:**
    情報発信が手軽にできるようなツールを導入し、専門知識がなくても使えるようにすることで、自治体の職員さんの負担を減らします。
---
