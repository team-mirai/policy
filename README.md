...
*   **保育の役割の明確化と保育士の負担軽減:** 保育士の過重な負担を軽減し、専門職としての役割が尊重される環境を整えます。特に『誰でも登園制度』のような新しい取り組みは、現場の人員や予算の体制が確保されて初めて成り立つものです。園の利用ルールの明確化や、保護者との円滑なコミュニケーションを促すことで、互いに協力しあえる関係づくりを進めます。さらに、国の補助金制度のあり方を見直し、各園が実情に応じて十分な職員を配置できるよう、安定した運営を支える財政基盤の強化を検討します。
