...
　頂いたご提案は、一つひとつに大切な想いが込められていると考えます。そのため、自動的な処理で少数意見を切り捨てることなく、すべての提案にチームみらいの担当者が直接目を通し、責任をもって誠実に検討することをお約束します。変更を反映するかどうかの最終的な判断はチームみらいが行いますが、どのようなご意見も真剣に受け止めます。
