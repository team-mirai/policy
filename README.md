...
## いわぶちさんからのご提案：選択的夫婦別姓に関する考え方

選択的夫婦別姓制度は、社会への影響が不透明なため慎重に検討し、まずは現行制度の枠内で柔軟な対応を進めます。

*   戸籍法は改正せず「同一戸籍・同一氏」を維持。
*   旧姓を「通称」として戸籍に届け出可能にする。
    *   旧姓通称を戸籍に記載し、法的効力を持たせる。
*   パスポートやマイナンバーカード、運転免許証などでも旧姓のみ、または併記して使用可能に。
*   届け出は婚姻時だけでなく、後からでも可能とする。
