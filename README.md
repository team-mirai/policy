...
チームみらいは、女性の権利と安全を確保することを重視します。

*   **女性専用スペースの保護:** トイレ、公衆浴場、避難所等の女性専用スペースは、生物学的女性のみが利用できるものとします。
*   **医療・健康診断における区別:** 医療や健康診断においては、生物学的な性に基づいた情報が扱われるべきです。
*   **女性の機会均等:** 政治や雇用における女性枠は、生物学的女性を対象とします。

これは、女性の安全と権利という積年の課題に対応するための明確化です。性別に悩む方々へのサポートは別途検討し、誰もが安心して暮らせる社会を目指します。
...
本マ次に、この変更の意図や背景をまとめた説明文を作成し、提案の準備を最終的に整えます。
マニフェストによる変更提案は２つの形で受付をしています。
