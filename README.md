...
*   **くらしと行政の改善:**
    *   児童館において、時間帯ごとの世代別利用（タイムシェアリング）などを導入します。
    *   地域センター等の公共施設内に、予約不要で子どもたちが放課後に安心して過ごせる専用のスペースを設けます。
*   **教育の改善:**
    *   公立小中学校のトイレについて、校舎内やプールといった施設ごとの和式・洋式の設置状況を地図などで分かりやすく可視化し、計画的な洋式化を強力に推進します。
