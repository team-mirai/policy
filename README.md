...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。私たちは、選択的夫婦別姓の実現をはじめ、個人の多様な生き方や選択を尊重します。また、人々が自身の属する立場や背景から一度離れて思考したとしても、誰もが「これなら受け入れられる」と合意できるような、公正な社会のルール作りを追求します。
