...
　実際にこの場で頂いたご意見を元に、このマニフェストは改善されています。例えば、子育て支援について「現金給付（ベーシックインカム）は使途が限定されない懸念があるため、本当に必要なオムツやミルク、医療、教育などを現物支給やサービスとして提供する『ベーシックサービス』に切り替えるべき。その財源は、こども家庭庁の歳出見直しや、法人税増税と消費税減税をセットで行い社会情勢に応じて5年ごとに見直す仕組みを導入、所得税や金融所得への累進課税強化、超富裕層への課税上限撤廃などで確保してはどうか」といった具体的なご提案をいただき、議論を深めています。
