...
## 新しい家族の形：苗字の多様性を守る文化の醸成

選択的夫婦別姓の導入は、子の姓をめぐる新たな対立を生む可能性があります。そのため、家族の姓は一つに統一することが望ましいと考えます。しかし、現行制度では改姓の負担が女性に偏りがちで、不平等感の一因となっています。

私たちはこの問題を男女間の対立と捉えるのではなく、日本の豊かな文化を守り育てる視点から解決することを提案します。結婚時に、より珍しい姓を家族の姓として選択することを推奨し、そうした決断を社会全体で応援する文化を醸成します。

これにより、失われつつある苗字を守り、文化の多様性を未来へ継承することを目指します。
