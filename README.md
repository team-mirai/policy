...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。特に、障害のある子どもたちとそのご家庭への支援を重視し、誰もが安心して暮らせる社会を目指します。現在、aoaoさんとの議論を踏まえ、具体的な政策として「所得制限によらず、すべての子どもが平等に療育を受けられる環境の整備」を検討しています。
