...
技能実習生など、日本で働く外国人が劣悪な環境で働くことがないよう、受け入れ企業の監査体制を強化し、法令遵守を徹底します。また、日本で育った子どもたちが、その能力を社会で発揮できるよう、在留資格の運用を現実的なものに見直します。同時に、日本に滞在する外国人にも法令遵守を求め、そのための支援として、AI等を活用した通翻訳、情報提供、相談支援サービスを当事者がアクセスしやすい形で提供します。
