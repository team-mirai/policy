...
　例えば、国民的な関心事である年金問題について、ユーザーのsyake122さんから「現行の賦課方式に積立方式を組み合わせたハイブリッド式へ20年かけて徐々に移行させ、その間は年間10兆円規模の国債を計画的に発行することで、移行期に不利になる人をなくすべき」という具体的なご意見をいただきました。チームみらいでは、このような建設的なご意見も真摯に受け止め、議論を深めるきっかけとしてまいります。
