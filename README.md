...
　「考えがまだまとまっていないではないか」とご批判を受けるリスクを積極的に取りながら、未熟なバージョンであっても公開に踏み切ります。なぜそうするかといえば、批判の目をたくさん入れ、意見を取り入れてゆくことが最も良い政策を作るやり方だと思うからです。私たちは、感情論や一部の意見に流されるポピュリズムに陥ることなく、客観的なデータや科学的根拠に基づいた政策立案によって、国民が安心して信頼できるデータを提示して議論を深めていくことを重視します。また、これはシンプルな多数決のように「意見が多いものを取り入れる」ということではありません。意見は聞きますし、プロセスの透明化も行いますが、あくまで意思決定は既存政党と同様にチームみらいの人が行います。これは、責任を取れる『人』が主体となって判断をすることが重要であるという価値観に基づくものです。

　なお今後も議論の結果、これらのマニフェストの内容がまだ変わる可能性がある点はご理解いただけますと幸いです。

## チームみらいについて

チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェDストの政策を推進しています。
...
---
## 【あおいとりさんによる政策提案】
### ステップ１：産業【デジタル窓口の標準化で、国民の時間を取り戻し、経済を前に進める】

企業のウェブサイトやアプリでの問い合わせ・手続きが複雑で多くの方が道筋を見失う「デジタル迷子」問題は、個人の自由時間を奪うだけでなく、本来生まれるはずだった経済活動を停滞させる、社会全体の大きな課題です。

国が主導して、業種ごとの「標準案内モデル」を開発・提供します。

これにより、国民はどのサービスでも直感的に操作できるようになり、企業側も開発コストを削減できます。失われた時間と経済活動の機会を取り戻し、社会全体の生産性向上を目指します。
