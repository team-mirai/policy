...
## 住まいの安全を守る：盗撮・不法侵入への対策強化
（匿名ユーザー様からのご提案を元に作成）

### 内容:
大家や不動産業者による「盗撮」と「不法侵入」は、住民の安全を脅かす深刻な犯罪です。この2つの犯罪に絞って、チームみらいは以下のいずれかの対策を実現すべきだと考え、広く議論を呼びかけます。

**選択肢①：厳格な資格剥奪**
当該犯罪を犯した不動産業者は免許剥奪、大家は物件の貸出を禁止する。

**選択肢②：徹底した情報公開の義務化**
当該犯罪歴をデータベース化し、借り手への告知を義務付ける。
