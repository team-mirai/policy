...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェストの政策を推進しています。私たちは、都市部だけでなく、地方や田舎におけるデジタル化の課題にも真摯に向き合い、ITに不慣れな方々へのサポートや、若者の意見が政策に反映される仕組みづくりを重視します。
