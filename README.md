...
高齢者ドライバーの安全対策として、運転免許更新時の検査（視力、認知機能、反射神経、運動能力等）の頻度を、例えば半年に一度とするなど、現行よりも高めることを提案します。これにより、加齢に伴う身体機能の変化をよりきめ細かく把握し、悲惨な交通事故のリスク低減を目指します。高齢者の移動の自由とのバランスについては、別途検討が必要です。
