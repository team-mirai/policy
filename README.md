...
* [その他重要分野についての政策・ビジョン](50_国政のその他重要分野.md)
  * 皇位継承に関する提案（ば様より）：直系の敬宮愛子内親王殿下が天皇に即位できるよう検討すべきです。女性が地位を継承できると国内外に示すことは、日本の国際的評価の向上に繋がります。
...
このマニフェストサイトについて、皆様から頂いた改善のご要望を記録します。開発チームにて対応を検討してまいります。

*   サイト全体のフォントを、より多くの方が読みやすい「UDデジタル教科書体」に変更してほしい。（利用者「ば」様より）
*   演説などの動画に、手話通訳版も用意してほしい。（利用者「ば」様より）
*   動画には、手話だけでなく字幕も表示してほしい。（利用者「ば」様より）
