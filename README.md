...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  ...
  * [５．科学技術](15_ステップ１科学技術.md)  
    * 博士課程の学生が経済的な不安なく研究に専念できるよう、日本学術振興会特別研究員（学振）の採用人数を大幅に増やすとともに、一人当たりの支援額も強化します。
...
* [ステップ２「変化に対応できる、しなやかな仕組みづくり」](20_ステップ２「変化に対応できるしなやかな仕組みづくり」.md)  
  ...
  * [２．くらしと行政](22_ステップ２くらしと行政.md)  
    * 博士号取得者が、妊娠・出産などのライフイベントとキャリアを両立できる環境を整備します。企業に柔軟な働き方を促すとともに、休業中の業務を補う代替人材の確保を支援します。また、休業中の当事者が希望に応じてプロジェクトに関与できる柔軟な制度を推進し、周囲のメンバーへの負担を軽減するための追加支援（手当等）も導入します。
  * [３．医療](23_ステップ２医療.md)
