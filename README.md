...
---
### （匿名ユーザーからの改善提案）ステップ２医療
医師が保険診療から美容医療などの自由診療へ流れる現状をふまえ、国民皆保険制度を持続可能なものにするための制度見直しを検討します。特に、担い手不足が深刻化している外科や麻酔科など、必要不可欠な医療を支える医師の待遇改善を集中的に行い、安心して働き続けられる労働環境を整備します。
