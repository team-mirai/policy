...
* **SNS等における誹謗中傷への対応**：本プロジェクトの外部（SNS等）で行われる、チームみらい及び関係者への悪質な誹謗中傷についても、断固として反対します。AI技術を活用して不適切な投稿を検知・記録しますが、これはあくまで補助的な手段です。投稿が誹謗中傷にあたるかどうかの最終的な判断は、必ずチームみらいの複数人のメンバーによって慎重に行われます。悪質であると判断した場合には、法的措置を含めた然るべき対応を検討します。
