...
チームみらいは、表現の自由と知的財産の保護を、デジタル社会の重要な基盤であると考えます。特に生成AI技術の発展に伴い、クリエイターが安心して創作活動を続けられる環境を整備することが急務です。

具体的には、AIの学習データセットに関する透明性を高めるとともに、クリエイターが自身の作品をAIの学習対象から除外できる「オプトアウト」の仕組み作りを国に働きかけていきます。これにより、クリエイターの権利が不当に害されることのない、健全な創作サイクルの実現を目指します。
