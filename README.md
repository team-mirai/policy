...
マニフェストは、[こちらのページ](https://policy.team-mir.ai/view/README.md)でご覧いただくのがおすすめです。このページは「いどばたシステム」という仕組みを使っており、政策について双方向に議論を進めることができます。各政策のページで、疑問点を質問したり、具体的な改善案を提案したりすることが可能です。
