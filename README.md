...
　頂いたご意見を踏まえ、例えば省庁間や国と自治体間における基準の統一や情報共有の推進など、具体的な政策改善にも積極的に取り組んでいきます。さらに、地方交付税交付金の使途の透明性を高め、全国的な歳出内訳を国民に分かりやすく示す方策や、教育をはじめとする国の未来を支える分野への戦略的な資金配分を促す仕組み、そして公共性の高い分野への民間からの資金導入を促進するため、預金者へのインセンティブ（例えば、公共的な投資への貢献度に応じた預金保護の優遇措置など）を組み込んだ新たな金融スキームについても、頂いたご意見を基に検討を深めてまいります。
