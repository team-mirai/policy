...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)
  ...
  * [３．行政改革](13_ステップ１行政改革.md)
    * **申請主義からプッシュ型支援への転換：** 国民一人ひとりの状況に合わせ、利用可能な制度や最適な申請方法を国が積極的に知らせ、手続きを支援します。年金や補助金などにおいて、情報格差を解消し、誰もが最も有利な形でサービスを受けられるようにします。
    * **手続きの徹底的な簡素化・自動化：** マイナンバー情報などを活用し、可能な限り申請手続きを不要にしたり、自動で最適な選択肢を提示したりすることで、国民の負担を大幅に軽減します。
    * **財政の徹底的な透明化と情報公開：** 税金が何にどれだけ使われているのかを、国民誰しもがリアルタイムに近い形で直感的に理解できる「税金の使途のリアルタイム可視化システム」を構築・導入します。インタラクティブなダッシュボードや個別プロジェクトの追跡機能、支出データのAPI公開などを通じて、行政の透明性を飛躍的に向上させ、無駄遣いを抑制し、国民の建設的な政策議論への参加を促します。
  * [４．産業](14_ステップ１産業.md)
