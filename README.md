...
* [ステップ１「デジタル時代の当たり前をやりきる」](10_ステップ１「デジタル時代の当たり前をやりきる」.md)  
  * [１．教育](11_ステップ１教育.md)  
    **多様な専門性を持つ人材の活用**
    教員不足に対応し、教育の質を向上させるため、民間企業等で実績のある社会人や、休眠状態の教員免許を持つ方々が教壇に立ちやすい環境を整えます。特に、AIやデジタル技術に精通した専門家に対しては、特別免許状の付与を促進します。これにより、情報教育の充実や、教員向けの研修を強化し、学校全体のデジタル対応力を引き上げます。
    **教育現場で使えるデジタルツールの開発・提供**
    子どもや教員が直感的に使えることを重視し、以下のデジタルツールを国の事業として開発し、全国の学校へ無償で提供します。
    *   **デジタルホワイトボードアプリ**: Canvaのように、共同編集が容易で表現力豊かな授業をサポートします。
    *   **宿題・課題管理アプリ**: 宿題の配布、回収、自動採点、記録を一元管理し、教員の採点業務の負担を大幅に削減します。
    *   **授業準備支援AI**: 良質な学習指導案や板書のアイデアをAIが提案し、授業準備の時間を短縮します。
    *   **個別最適化学習AI**: 子ども一人ひとりの学習進度や理解度に合わせて、安全性の高い生成AIが最適な学びを提供します。
...
* [ステップ２「変化に対応できる、しなやかな仕組みづくり」](20_ステップ２「変化に対応できるしなやかな仕組みづくり」.md)  
  * [１．教育](21_ステップ２教育.md)  
    **校務DXの推進による働き方改革**
    教員の働き方改革を加速させるため、全国共通で利用可能な校務DX（デジタルトランスフォーメーション）システムを整備します。各学校や教育委員会にDX推進を担う専門人材を配置し、現場の負担を軽減しながら、円滑なデジタル化を支援します。これにより、教員が授業準備や児童生徒との対話など、本来の業務に集中できる時間を確保します。
    **日本版DBSの創設による、子どもの安全確保**
    子どもたちを性被害から守るため、教育や保育など、子どもと接する職に就く際に性犯罪歴の証明を義務付ける「日本版DBS」制度を速やかに創設します。性加害者が子どもと関わる職に就くことを防ぐ仕組みを確立し、すべての子どもたちが安心して過ごせる環境を実現します。
...
* [ステップ３「長期の成長に大胆に投資する」](30_ステップ３「長期の成長に大胆に投資する」.md)  
  ...
  * [２．教育](32_ステップ３教育.md)  
    **未来への投資としての、教員サポート体制の抜本的強化**
    教員が授業準備や研修、児童生徒との対話といった本質的な業務に集中できる時間を創出するため、事務作業、不登校・特別支援対応、IT活用支援などを担う専門スタッフを大幅に増員し、各学校への配置を進めます。また、新任教員の早期離-職を防ぎ、長期的な視点で育成するため、採用後すぐにはクラス担任を持たず、まずは副担任として実践的なOJTを受けられる制度を導入します。これにより、教員が専門性を高めながら、心身ともに健康に働き続けられる環境を構築し、教育の質そのものを向上させていきます。
