...
また、チームみらいは、現行憲法、特に9条の平和主義の理念を尊重し、その改正は行いません。実態に合わないという理由で憲法を改正するべきとの意見もありますが、私たちは実態こそが平和の理想である憲法に合致するよう努力すべきだと考えます。さらに、自衛隊の存在を憲法に追記することは、「戦力不保持」を掲げる現行9条の理念を事実上、無効化してしまう深刻なリスクを伴います。私たちは、平和の理想を掲げる現行憲法の理念を断固として守り続けます。
