...
ユーザーとの対話で生まれた改善提案の草案です。今後、議論を経てマニフェストの適切な箇所に反映される可能性があります。

*   **扶養する子供が4人以上の世帯に対し、所得税を免除する。**
    *   これは、子どもの年齢に上限を設けず、実際に扶養している子どもの総数に基づき、継続的な支援を行うことを目的とします。（さくさんからのご提案）
