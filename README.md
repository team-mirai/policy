...
* [シンギュラリティ後を見据えて：人間の役割を再定義する](#シンギュラリティ後を見据えて人間の役割を再定義する)  
...
## シンギュラリティ後を見据えて：人間の役割を再定義する

技術的特異点（シンギュラリティ）の到来は、GDP成長、国際競争、人口動態といった、これまでの社会が前提としてきた指標の意味を根底から覆す可能性を秘めています。AIが自律的に経済を動かす時代において、私たちが真に問われるのは「経済成長」ではなく、「人間の存在意義」そのものです。

私たちは、この大きな変化を正面から受け止め、AIと人間の関係性を、より持続可能で互いにとって有益な「Win-Winの関係」へと発展させるべきだと考えます。

AIが生産活動の全てを担う社会で「誰も取り残さない」ためには、人間が「AI経済における消費者」として尊重され続ける仕組みが不可欠です。そこで、AIの行動原理の成功報酬として「人間にとって幸福とは何かを追求し続けること」を設定します。

この共生関係は、汎用人工知能（AGI）が実現し、超知能（ASI）へと加速度的に発展を遂げてもなお持続されるべく、慎重かつ開明的な設計を追求します。並行して、変化する世界で自らの生きる意味を追求できるよう、私たち人間側の「アップデート」の実現も目指していきます。これは挑戦的なビジョンですが、100年後の未来を見据えるならば、避けては通れない議論です。
