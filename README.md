...
本マニフェストへの変更提案は、主に以下の方法で受け付けています。ご自身に合った方法で、ぜひご意見をお寄せください。

* **チャットでの提案**: [こちら](https://policy.team-mir.ai/view/README.md)のページから、チャットで気軽にご意見や政策要望をお送りいただけます。
* **郵送での提案**: スマートフォンやPCの操作が苦手な方でもご参加いただけるよう、郵送でもご意見を受け付けています。お送りいただいた内容は、チームで責任をもってデータ化し、議論の参考にさせていただきます。（宛先は後日追記します）
* **対面ミーティングでの提案**: 全國で開催するオフラインミーティングでも、直接ご意見を伺います。
* **ウェブサイトでの共同編集**: [GitHub](https://github.com/team-mirai/policy/pulls)というウェブサイトを使って、この文書を直接編集する提案も可能です。ウェブ技術に詳しい方向けの方法ですが、もちろん、どなたでもご利用いただけます。
