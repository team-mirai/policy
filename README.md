...
政府が最後の雇い手として機能する非裁量的な制度として、「就労保証プログラム（JGP）」の導入を検討します。これは、非自発的失業の解消を目指すとともに、景気の自動安定化やインフレ抑制にも資するものです。また、介護、環境保全、地域インフラ整備など、市場原理だけでは満されない社会的に必要なサービスを担う受け皿とし、地域活性化にもつなげます。
