...
政策内容の変更以外のPR（例：タイポ修正、フォーマット調整、ドキュメント更新など）でX通知を避けたい場合は、PRに `skip-notification` ラベルを付けることで通知をスキPIできます。
...
*   **福祉分野の充実について**
    *   高齢者福祉、特に老人ホームについて、利用者とその家族の負担を軽減するため、利用料の引き下げと施設数の増加を検討する。
---
