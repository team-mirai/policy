...
チームみらいは、AIエンジニアの安野たかひろによって設立された政治団体です。テクノロジーで誰も取り残さない日本を掲げ、本マニフェ-ストの政策を推進しています。特にエネルギー政策においては、原子力発電への依存を低減し、太陽光や風力発電の導入を推進するとともに、安全でクリーンな次世代エネルギーの研究開発に大胆に投資することを目指します。
