...
*   **仕組み**:
    *   **信頼性の確保**: 責任ある言論空間を醸成するため、コメント投稿にはマイナンバーカードによる本人確認を必須とします。一方、「いいね！」やスタンプなどの気軽な意思表示は、電話番号登録のみで可能とします。また、マイナンバーカードを登録した相互フォロワーはメッセージのやり取りができます。電話番号だけの登録者もマイページを持っており、「いいね！」した動画を公開範囲を設定した上で表示できます。
    *   **クリエイター支援**: クリエイターが高い意欲を持って活動できるよう、広告や投げ銭の収益率を既存のプラットフォームより高く設定します。また、独自のデジタルコンテンツ（スタンプ等）を販売できる機能も設けます。
    *   **産業活性化**: 企業によるクリエイターへの投げ銭（技術や文化の継承への貢献）は、税制上の優遇措置の対象とすることを検討します。
