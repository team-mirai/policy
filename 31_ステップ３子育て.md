...
* 多様なパートナーシップの尊重と法的整備
  * 同性婚の法制化を実現し、事実婚を選択するカップルへの法的保護を拡充するなど、すべての人が愛する人と法的に家族になることを選択できる社会を目指します。税制、社会保障、相続、共同親権等において、法律婚と同等の保護が受けられるよう法制度の整備を進めます。
  * 結婚による苗字変更によってキャリア形成等で生じる不利益を解消するため、選択的夫婦別姓制度の導入を、国民的議論を深めながら速やかに実現することを目指します。
  * 子どもを望む全ての人が公平に医療へアクセスできるよう、現行の生殖補助医療制度を見直します。特に、非配偶者間人工授精（AID）について、現在は利用が困難な同性カップルや事実婚カップルも国内で利用できるよう、法整備とガイドライン策定を推進します。
  * また、生殖補助医療により生まれた子どもの「出自を知る権利」を法的に保障します。プライバシーに配慮しつつ、自身のルーツに関する情報にアクセスできる仕組みを構築し、健全なアイデンティティ形成を支えます。
