...
* 行政デジタルツールの開発/運用  
  * オンライン熟議の場  
    * 市民がオンラインで意見を出し合うツール（例：いどばたシステム）については、デジタル民主主義2030など既存のオープンソースプロジェクトに貢献する形で開発します  
  * 国民の声を効率的に集めるツール  
    * パブリックコメント等の大量の意見投稿を効率的に処理できるシステム（例：広聴AI）については、デジタル民主主義2030など既存のオープンソースプロジェクトに貢献する形で開発し、意見の集約をスムーズにします  
* 政治資金の流れの公開  
